...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}(a,e,t)}return i}_compileMaterial(e){const t=new vt(this._lodPlanes[0],e);this._renderer.compile(t,Ta)}_sceneToCubeUV(e,t,n,i){const a=new ft(90,1,t,n),s=[1,-1,1,1,1,1],o=[1,1,1,-1,-1,-1],c=this._renderer,l=c.autoClear,h=c.toneMapping;c.getClearColor(ao),c.toneMapping=Mn,c.autoClear=!1;const u=new xn({name:"PMREM.Background",side:xt,depthWrite:!1,depthTest:!1}),d=new vt(new Yi,u);let p=!1;const m=e.background;m?m.isColor&&(u.color.copy(m),e.background=null,p=!0):(u.color.copy(ao),p=!0);for(let v=0;v<6;v++){const _=v%3;_===0?(a.up.set(0,s[v],0),a.lookAt(o[v],0,0)):_===1?(a.up.set(0,0,s[v]),a.lookAt(0,o[v],0)):(a.up.set(0,s[v],0),a.lookAt(0,0,o[v]));const f=this._cubeSize;yr(i,_*f,v>2?f:0,f,f),c.setRenderTarget(i),p&&c.render(d,a),c.render(e,a)}d.geometry.dispose(),d.material.dispose(),c.toneMapping=h,c.autoClear=l,e.background=m}_textureToCubeUV(e,t){const n=this._renderer,i=e.mapping===_i||e.mapping===vi;i?(this._cubemapMaterial===null&&(this._cubemapMaterial=ho()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=co());const a=i?this._cubemapMaterial:this._equirectMaterial,s=new vt(this._lodPlanes[0],a);a.uniforms.envMap.value=e;const o=this._cubeSize;yr(t,0,0,3*o,2*o),n.setRenderTarget(t),n.render(s,Ta)}_applyPMREM(e){const t=this._renderer,n=t.autoClear;t.autoClear=!1;for(let i=1;i<this._lodPlanes.length;i++){const a=Math.sqrt(this._sigmas[i]*this._sigmas[i]-this._sigmas[i-1]*this._sigmas[i-1]),s=so[(i-1)%so.length];this._blur(e,i-1,i,a,s)}t.autoClear=n}_blur(e,t,n,i,a){const s=this._pingPongRenderTarget;this._halfBlur(e,s,t,n,i,"latitudinal",a),this._halfBlur(s,e,n,n,i,"longitudinal",a)}_halfBlur(e,t,n,i,a,s,o){const c=this._renderer,l=this._blurMaterial,h=new vt(this._lodPlanes[i],l),u=l.uniforms,d=this._sizeLods[n]-1,p=isFinite(a)?Math.PI/(2*d):2*Math.PI/39,m=a/p,v=isFinite(a)?1+Math.floor(3*m):xr,_=[];let f=0;for(let y=0;y<xr;++y){const C=y/m,w=Math.exp(-C*C/2);_.push(w),y===0?f+=w:y<v&&(f+=2*w)}for(let y=0;y<_.length;y++)_[y]=_[y]/f;u.envMap.value=e.texture,u.samples.value=v,u.weights.value=_,u.latitudinal.value=s==="latitudinal",o&&(u.poleAxis.value=o);const{_lodMax:x}=this;u.dTheta.value=p,u.mipInt.value=x-n;const g=this._sizeLods[i];yr(t,3*g*(i>x-4?i-x+4:0),4*(this._cubeSize-g),3*g,2*g),c.setRenderTarget(t),c.render(h,Ta)}}function lo(r,e,t){const n=new Xn(r,e,t);return n.texture.mapping=Vr,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function yr(r,e,t,n,i){r.viewport.set(e,t,n,i),r.scissor.set(e,t,n,i)}function co(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ls(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ho(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ls(),fragmentShader:`
	...
	`}function Fc(r){let e=new WeakMap,t=null;function n(i){const a=i.target;a.removeEventListener("dispose",n);const s=e.get(a);s!==void 0&&(e.delete(a),s.dispose())}return{get:function(i){if(i&&i.isTexture){const a=i.mapping,s=a===Nr||a===304,o=a===_i||a===vi;if(s||o){if(i.isRenderTargetTexture&&i.needsPMREMUpdate===!0){i.needsPMREMUpdate=!1;let c=e.get(i);return t===null&&(t=new oo(r)),c=s?t.fromEquirectangular(i,c):t.fromCubemap(i,c),e.set(i,c),c.texture}if(e.has(i))return e.get(i).texture;{const c=i.image;if(s&&c&&c.height>0||o&&c&&function(l){let h=0;const u=6;for(let d=0;d<u;d++)l[d]!==void 0&&h++;return h===u}(c)){t===null&&(t=new oo(r));const l=s?t.fromEquirectangular(i):t.fromCubemap(i);return e.set(i,l),i.addEventListener("dispose",n),l.texture}return null}}}return i},dispose:function(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}}}function Bc(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){return t(n)}}}function zc(r,e,t,n){const i={},a=new WeakMap;function s(c){const l=c.target;l.index!==null&&e.remove(l.index);for(const u in l.attributes)e.remove(l.attributes[u]);for(const u in l.morphAttributes){const d=l.morphAttributes[u];for(let p=0,m=d.length;p<m;p++)e.remove(d[p])}l.removeEventListener("dispose",s),delete i[l.id];const h=a.get(l);h&&(e.remove(h),a.delete(l)),n.releaseStatesOfGeometry(l),l.isInstancedBufferGeometry===!0&&delete l._maxInstanceCount,t.memory.geometries--}function o(c){const l=[],h=c.index,u=c.attributes.position;let d=0;if(h!==null){const v=h.array;d=h.version;for(let _=0,f=v.length;_<f;_+=3){const x=v[_+0],g=v[_+1],y=v[_+2];l.push(x,g,g,y,y,x)}}else{if(u===void 0)return;{const v=u.array;d=u.version;for(let _=0,f=v.length/3-1;_<f;_+=3){const x=_+0,g=_+1,y=_+2;l.push(x,g,g,y,y,x)}}}const p=new(ul(l)?vl:_l)(l,1);p.version=d;const m=a.get(c);m&&e.remove(m),a.set(c,p)}return{get:function(c,l){return i[l.id]===!0||(l.addEventListener("dispose",s),i[l.id]=!0,t.memory.geometries++),l},update:function(c){const l=c.attributes;for(const u in l)e.update(l[u],r.ARRAY_BUFFER);const h=c.morphAttributes;for(const u in h){const d=h[u];for(let p=0,m=d.length;p<m;p++)e.update(d[p],r.ARRAY_BUFFER)}},getWireframeAttribute:function(c){const l=a.get(c);if(l){const h=c.index;h!==null&&l.version<h.version&&o(c)}else o(c);return a.get(c)}}}function Hc(r,e,t,n){const i=n.isWebGL2;let a,s,o;this.setMode=function(c){a=c},this.setIndex=function(c){s=c.type,o=c.bytesPerElement},this.render=function(c,l){r.drawElements(a,l,s,c*o),t.update(l,a,1)},this.renderInstances=function(c,l,h){if(h===0)return;let u,d;if(i)u=r,d="drawElementsInstanced";else if(u=e.get("ANGLE_instanced_arrays"),d="drawElementsInstancedANGLE",u===null)return;u[d](a,l,s,c*o,h),t.update(l,a,h)},this.renderMultiDraw=function(c,l,h){if(h===0)return;const u=e.get("WEBGL_multi_draw");if(u===null)for(let d=0;d<h;d++)this.render(c[d]/o,l[d]);else{u.multiDrawElementsWEBGL(a,l,0,s,c,0,h);let d=0;for(let p=0;p<h;p++)d+=l[p];t.update(d,a,1)}}}function Vc(r){const e={frame:0,calls:0,triangles:0,points:0,lines:0};return{memory:{geometries:0,textures:0},render:e,programs:null,autoReset:!0,reset:function(){e.calls=0,e.triangles=0,e.points=0,e.lines=0},update:function(t,n,i){switch(e.calls++,n){case r.TRIANGLES:e.triangles+=i*(t/3);break;case r.LINES:e.lines+=i*(t/2);break;case r.LINE_STRIP:e.lines+=i*(t-1);break;case r.LINE_LOOP:e.lines+=i*t;break;case r.POINTS:e.points+=i*t}}}}function kc(r,e){return r[0]-e[0]}function Gc(r,e){return Math.abs(e[1])-Math.abs(r[1])}function Wc(r,e,t){const n={},i=new Float32Array(8),a=new WeakMap,s=new Ve,o=[];for(let c=0;c<8;c++)o[c]=[c,0];return{update:function(c,l,h){const u=c.morphTargetInfluences;if(e.isWebGL2===!0){const p=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,m=p!==void 0?p.length:0;let v=a.get(l);if(v===void 0||v.count!==m){let A=function(){B.dispose(),a.delete(l),l.removeEventListener("dispose",A)};var d=A;v!==void 0&&v.texture.dispose();const _=l.morphAttributes.position!==void 0,f=l.morphAttributes.normal!==void 0,x=l.morphAttributes.color!==void 0,g=l.morphAttributes.position||[],y=l.morphAttributes.normal||[],C=l.morphAttributes.color||[];let w=0;_===!0&&(w=1),f===!0&&(w=2),x===!0&&(w=3);let T=l.attributes.position.count*w,U=1;T>e.maxTextureSize&&(U=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const L=new Float32Array(T*U*4*m),B=new ml(L,T,U,m);B.type=Et,B.needsUpdate=!0;const re=4*w;for(let k=0;k<m;k++){const Z=g[k],se=y[k],pe=C[k],K=T*U*4*k;for(let j=0;j<Z.count;j++){const Y=j*re;_===!0&&(s.fromBufferAttribute(Z,j),L[K+Y+0]=s.x,L[K+Y+1]=s.y,L[K+Y+2]=s.z,L[K+Y+3]=0),f===!0&&(s.fromBufferAttribute(se,j),L[K+Y+4]=s.x,L[K+Y+5]=s.y,L[K+Y+6]=s.z,L[K+Y+7]=0),x===!0&&(s.fromBufferAttribute(pe,j),L[K+Y+8]=s.x,L[K+Y+9]=s.y,L[K+Y+10]=s.z,L[K+Y+11]=pe.itemSize===4?s.w:1)}}v={count:m,texture:B,size:new ve(T,U)},a.set(l,v),l.addEventListener("dispose",A)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)h.getUniforms().setValue(r,"morphTexture",c.morphTexture,t);else{let _=0;for(let x=0;x<u.length;x++)_+=u[x];const f=l.morphTargetsRelative?1:1-_;h.getUniforms().setValue(r,"morphTargetBaseInfluence",f),h.getUniforms().setValue(r,"morphTargetInfluences",u)}h.getUniforms().setValue(r,"morphTargetsTexture",v.texture,t),h.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}else{const p=u===void 0?0:u.length;let m=n[l.id];if(m===void 0||m.length!==p){m=[];for(let g=0;g<p;g++)m[g]=[g,0];n[l.id]=m}for(let g=0;g<p;g++){const y=m[g];y[0]=g,y[1]=u[g]}m.sort(Gc);for(let g=0;g<8;g++)g<p&&m[g][1]?(o[g][0]=m[g][0],o[g][1]=m[g][1]):(o[g][0]=Number.MAX_SAFE_INTEGER,o[g][1]=0);o.sort(kc);const v=l.morphAttributes.position,_=l.morphAttributes.normal;let f=0;for(let g=0;g<8;g++){const y=o[g],C=y[0],w=y[1];C!==Number.MAX_SAFE_INTEGER&&w?(v&&l.getAttribute("morphTarget"+g)!==v[C]&&l.setAttribute("morphTarget"+g,v[C]),_&&l.getAttribute("morphNormal"+g)!==_[C]&&l.setAttribute("morphNormal"+g,_[C]),i[g]=w,f+=w):(v&&l.hasAttribute("morphTarget"+g)===!0&&l.deleteAttribute("morphTarget"+g),_&&l.hasAttribute("morphNormal"+g)===!0&&l.deleteAttribute("morphNormal"+g),i[g]=0)}const x=l.morphTargetsRelative?1:1-f;h.getUniforms().setValue(r,"morphTargetBaseInfluence",x),h.getUniforms().setValue(r,"morphTargetInfluences",i)}}}}function Xc(r,e,t,n){let i=new WeakMap;function a(s){const o=s.target;o.removeEventListener("dispose",a),t.remove(o.instanceMatrix),o.instanceColor!==null&&t.remove(o.instanceColor)}return{update:function(s){const o=n.render.frame,c=s.geometry,l=e.get(s,c);if(i.get(l)!==o&&(e.update(l),i.set(l,o)),s.isInstancedMesh&&(s.hasEventListener("dispose",a)===!1&&s.addEventListener("dispose",a),i.get(s)!==o&&(t.update(s.instanceMatrix,r.ARRAY_BUFFER),s.instanceColor!==null&&t.update(s.instanceColor,r.ARRAY_BUFFER),i.set(s,o))),s.isSkinnedMesh){const h=s.skeleton;i.get(h)!==o&&(h.update(),i.set(h,o))}return l},dispose:function(){i=new WeakMap}}}class El extends it{constructor(e,t,n,i,a,s,o,c,l,h){if((h=h!==void 0?h:Gn)!==Gn&&h!==yi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Gn&&(n=vn),n===void 0&&h===yi&&(n=kn),super(null,i,a,s,o,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:ht,this.minFilter=c!==void 0?c:ht,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Tl=new it,bl=new El(1,1);bl.compareFunction=515;const Al=new ml,wl=new dc,Rl=new Ml,uo=[],po=[],fo=new Float32Array(16),mo=new Float32Array(9),go=new Float32Array(4);function Ci(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let a=uo[i];if(a===void 0&&(a=new Float32Array(i),uo[i]=a),e!==0){n.toArray(a,0);for(let s=1,o=0;s!==e;++s)o+=t,r[s].toArray(a,o)}return a}function $e(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function Qe(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function Wr(r,e){let t=po[e];t===void 0&&(t=new Int32Array(e),po[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function jc(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function Yc(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y||(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if($e(t,e))return;r.uniform2fv(this.addr,e),Qe(t,e)}}function qc(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z||(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)t[0]===e.r&&t[1]===e.g&&t[2]===e.b||(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if($e(t,e))return;r.uniform3fv(this.addr,e),Qe(t,e)}}function Kc(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z&&t[3]===e.w||(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if($e(t,e))return;r.uniform4fv(this.addr,e),Qe(t,e)}}function Zc(r,e){const t=this.cache,n=e.elements;if(n===void 0){if($e(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),Qe(t,e)}else{if($e(t,n))return;go.set(n),r.uniformMatrix2fv(this.addr,!1,go),Qe(t,n)}}function Jc(r,e){const t=this.cache,n=e.elements;if(n===void 0){if($e(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),Qe(t,e)}else{if($e(t,n))return;mo.set(n),r.uniformMatrix3fv(this.addr,!1,mo),Qe(t,n)}}function $c(r,e){const t=this.cache,n=e.elements;if(n===void 0){if($e(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),Qe(t,e)}else{if($e(t,n))return;fo.set(n),r.uniformMatrix4fv(this.addr,!1,fo),Qe(t,n)}}function Qc(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function eh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y||(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if($e(t,e))return;r.uniform2iv(this.addr,e),Qe(t,e)}}function th(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z||(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if($e(t,e))return;r.uniform3iv(this.addr,e),Qe(t,e)}}function nh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z&&t[3]===e.w||(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if($e(t,e))return;r.uniform4iv(this.addr,e),Qe(t,e)}}function ih(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function rh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y||(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if($e(t,e))return;r.uniform2uiv(this.addr,e),Qe(t,e)}}function ah(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z||(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if($e(t,e))return;r.uniform3uiv(this.addr,e),Qe(t,e)}}function sh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z&&t[3]===e.w||(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if($e(t,e))return;r.uniform4uiv(this.addr,e),Qe(t,e)}}function oh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);const a=this.type===r.SAMPLER_2D_SHADOW?bl:Tl;t.setTexture2D(e||a,i)}function lh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||wl,i)}function ch(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Rl,i)}function hh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Al,i)}function uh(r,e){r.uniform1fv(this.addr,e)}function dh(r,e){const t=Ci(e,this.size,2);r.uniform2fv(this.addr,t)}function ph(r,e){const t=Ci(e,this.size,3);r.uniform3fv(this.addr,t)}function fh(r,e){const t=Ci(e,this.size,4);r.uniform4fv(this.addr,t)}function mh(r,e){const t=Ci(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function gh(r,e){const t=Ci(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function _h(r,e){const t=Ci(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function vh(r,e){r.uniform1iv(this.addr,e)}function xh(r,e){r.uniform2iv(this.addr,e)}function yh(r,e){r.uniform3iv(this.addr,e)}function Mh(r,e){r.uniform4iv(this.addr,e)}function Sh(r,e){r.uniform1uiv(this.addr,e)}function Eh(r,e){r.uniform2uiv(this.addr,e)}function Th(r,e){r.uniform3uiv(this.addr,e)}function bh(r,e){r.uniform4uiv(this.addr,e)}function Ah(r,e,t){const n=this.cache,i=e.length,a=Wr(t,i);$e(n,a)||(r.uniform1iv(this.addr,a),Qe(n,a));for(let s=0;s!==i;++s)t.setTexture2D(e[s]||Tl,a[s])}function wh(r,e,t){const n=this.cache,i=e.length,a=Wr(t,i);$e(n,a)||(r.uniform1iv(this.addr,a),Qe(n,a));for(let s=0;s!==i;++s)t.setTexture3D(e[s]||wl,a[s])}function Rh(r,e,t){const n=this.cache,i=e.length,a=Wr(t,i);$e(n,a)||(r.uniform1iv(this.addr,a),Qe(n,a));for(let s=0;s!==i;++s)t.setTextureCube(e[s]||Rl,a[s])}function Ch(r,e,t){const n=this.cache,i=e.length,a=Wr(t,i);$e(n,a)||(r.uniform1iv(this.addr,a),Qe(n,a));for(let s=0;s!==i;++s)t.setTexture2DArray(e[s]||Al,a[s])}class Ph{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=function(i){switch(i){case 5126:return jc;case 35664:return Yc;case 35665:return qc;case 35666:return Kc;case 35674:return Zc;case 35675:return Jc;case 35676:return $c;case 5124:case 35670:return Qc;case 35667:case 35671:return eh;case 35668:case 35672:return th;case 35669:case 35673:return nh;case 5125:return ih;case 36294:return rh;case 36295:return ah;case 36296:return sh;case 35678:case 36198:case 36298:case 36306:case 35682:return oh;case 35679:case 36299:case 36307:return lh;case 35680:case 36300:case 36308:case 36293:return ch;case 36289:case 36303:case 36311:case 36292:return hh}}(t.type)}}class Lh{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=function(i){switch(i){case 5126:return uh;case 35664:return dh;case 35665:return ph;case 35666:return fh;case 35674:return mh;case 35675:return gh;case 35676:return _h;case 5124:case 35670:return vh;case 35667:case 35671:return xh;case 35668:case 35672:return yh;case 35669:case 35673:return Mh;case 5125:return Sh;case 36294:return Eh;case 36295:return Th;case 36296:return bh;case 35678:case 36198:case 36298:case 36306:case 35682:return Ah;case 35679:case 36299:case 36307:return wh;case 35680:case 36300:case 36308:case 36293:return Rh;case 36289:case 36303:case 36311:case 36292:return Ch}}(t.type)}}class Ih{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let a=0,s=i.length;a!==s;++a){const o=i[a];o.setValue(e,t[o.id],n)}}}const Ra=/(\w+)(\])?(\[|\.)?/g;function _o(r,e){r.seq.push(e),r.map[e.id]=e}function Nh(r,e,t){const n=r.name,i=n.length;for(Ra.lastIndex=0;;){const a=Ra.exec(n),s=Ra.lastIndex;let o=a[1];const c=a[2]==="]",l=a[3];if(c&&(o|=0),l===void 0||l==="["&&s+2===i){_o(t,l===void 0?new Ph(o,r,e):new Lh(o,r,e));break}{let h=t.map[o];h===void 0&&(h=new Ih(o),_o(t,h)),t=h}}}class Ir{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const a=e.getActiveUniform(t,i);Nh(a,e.getUniformLocation(t,a.name),this)}}setValue(e,t,n,i){const a=this.map[t];a!==void 0&&a.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let a=0,s=t.length;a!==s;++a){const o=t[a],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,a=e.length;i!==a;++i){const s=e[i];s.id in t&&n.push(s)}return n}}function vo(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const Uh=37297;let Dh=0;function xo(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const a=/ERROR: 0:(\d+)/.exec(i);if(a){const s=parseInt(a[1]);return t.toUpperCase()+`
...
`)}(r.getShaderSource(e),s)}return i}function Oh(r,e){const t=function(n){const i=He.getPrimaries(He.workingColorSpace),a=He.getPrimaries(n);let s;switch(i===a?s="":i===Fr&&a===Or?s="LinearDisplayP3ToLinearSRGB":i===Or&&a===Fr&&(s="LinearSRGBToLinearDisplayP3"),n){case at:case kr:return[s,"LinearTransferOETF"];case pt:case rs:return[s,"sRGBTransferOETF"];default:return[s,"LinearTransferOETF"]}}(e);return`vec4 ${r}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Fh(r,e){let t;switch(e){case ec:t="Linear";break;case tc:t="Reinhard";break;case nc:t="OptimizedCineon";break;case ic:t="ACESFilmic";break;case ac:t="AgX";break;case sc:t="Neutral";break;case rc:t="Custom";break;default:t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function li(r){return r!==""}function yo(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Mo(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Bh=/^[ \t]*#include +<([\w\d./]+)>/gm;function qa(r){return r.replace(Bh,Hh)}const zh=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Hh(r,e){let t=be[e];if(t===void 0){const n=zh.get(e);if(n===void 0)throw new Error("Can not resolve #include <"+e+">");t=be[n]}return qa(t)}const Vh=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function So(r){return r.replace(Vh,kh)}function kh(r,e,t,n){let i="";for(let a=parseInt(e);a<parseInt(t);a++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return i}function Eo(r){let e=`precision ${r.precision} float;

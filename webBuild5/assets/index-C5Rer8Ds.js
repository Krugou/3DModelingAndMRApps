...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}(a,e,t)}return i}_compileMaterial(e){const t=new gt(this._lodPlanes[0],e);this._renderer.compile(t,Pa)}_sceneToCubeUV(e,t,n,i){const a=new mt(90,1,t,n),s=[1,-1,1,1,1,1],o=[1,1,1,-1,-1,-1],c=this._renderer,l=c.autoClear,h=c.toneMapping;c.getClearColor(po),c.toneMapping=An,c.autoClear=!1;const u=new hn({name:"PMREM.Background",side:yt,depthWrite:!1,depthTest:!1}),d=new gt(new $i,u);let p=!1;const m=e.background;m?m.isColor&&(u.color.copy(m),e.background=null,p=!0):(u.color.copy(po),p=!0);for(let v=0;v<6;v++){const _=v%3;_===0?(a.up.set(0,s[v],0),a.lookAt(o[v],0,0)):_===1?(a.up.set(0,0,s[v]),a.lookAt(0,o[v],0)):(a.up.set(0,s[v],0),a.lookAt(0,0,o[v]));const f=this._cubeSize;br(i,_*f,v>2?f:0,f,f),c.setRenderTarget(i),p&&c.render(d,a),c.render(e,a)}d.geometry.dispose(),d.material.dispose(),c.toneMapping=h,c.autoClear=l,e.background=m}_textureToCubeUV(e,t){const n=this._renderer,i=e.mapping===Mi||e.mapping===Si;i?(this._cubemapMaterial===null&&(this._cubemapMaterial=vo()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=_o());const a=i?this._cubemapMaterial:this._equirectMaterial,s=new gt(this._lodPlanes[0],a);a.uniforms.envMap.value=e;const o=this._cubeSize;br(t,0,0,3*o,2*o),n.setRenderTarget(t),n.render(s,Pa)}_applyPMREM(e){const t=this._renderer,n=t.autoClear;t.autoClear=!1;for(let i=1;i<this._lodPlanes.length;i++){const a=Math.sqrt(this._sigmas[i]*this._sigmas[i]-this._sigmas[i-1]*this._sigmas[i-1]),s=fo[(i-1)%fo.length];this._blur(e,i-1,i,a,s)}t.autoClear=n}_blur(e,t,n,i,a){const s=this._pingPongRenderTarget;this._halfBlur(e,s,t,n,i,"latitudinal",a),this._halfBlur(s,e,n,n,i,"longitudinal",a)}_halfBlur(e,t,n,i,a,s,o){const c=this._renderer,l=this._blurMaterial,h=new gt(this._lodPlanes[i],l),u=l.uniforms,d=this._sizeLods[n]-1,p=isFinite(a)?Math.PI/(2*d):2*Math.PI/39,m=a/p,v=isFinite(a)?1+Math.floor(3*m):Tr,_=[];let f=0;for(let y=0;y<Tr;++y){const C=y/m,w=Math.exp(-C*C/2);_.push(w),y===0?f+=w:y<v&&(f+=2*w)}for(let y=0;y<_.length;y++)_[y]=_[y]/f;u.envMap.value=e.texture,u.samples.value=v,u.weights.value=_,u.latitudinal.value=s==="latitudinal",o&&(u.poleAxis.value=o);const{_lodMax:x}=this;u.dTheta.value=p,u.mipInt.value=x-n;const g=this._sizeLods[i];br(t,3*g*(i>x-4?i-x+4:0),4*(this._cubeSize-g),3*g,2*g),c.setRenderTarget(t),c.render(h,Pa)}}function go(r,e,t){const n=new Kn(r,e,t);return n.texture.mapping=qr,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function br(r,e,t,n,i){r.viewport.set(e,t,n,i),r.scissor.set(e,t,n,i)}function _o(){return new Rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(){return new Rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fs(),fragmentShader:`
	...
	`}function Yc(r){let e=new WeakMap,t=null;function n(i){const a=i.target;a.removeEventListener("dispose",n);const s=e.get(a);s!==void 0&&(e.delete(a),s.dispose())}return{get:function(i){if(i&&i.isTexture){const a=i.mapping,s=a===zr||a===304,o=a===Mi||a===Si;if(s||o){if(i.isRenderTargetTexture&&i.needsPMREMUpdate===!0){i.needsPMREMUpdate=!1;let c=e.get(i);return t===null&&(t=new mo(r)),c=s?t.fromEquirectangular(i,c):t.fromCubemap(i,c),e.set(i,c),c.texture}if(e.has(i))return e.get(i).texture;{const c=i.image;if(s&&c&&c.height>0||o&&c&&function(l){let h=0;const u=6;for(let d=0;d<u;d++)l[d]!==void 0&&h++;return h===u}(c)){t===null&&(t=new mo(r));const l=s?t.fromEquirectangular(i):t.fromCubemap(i);return e.set(i,l),i.addEventListener("dispose",n),l.texture}return null}}}return i},dispose:function(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}}}function Kc(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){return t(n)}}}function Zc(r,e,t,n){const i={},a=new WeakMap;function s(c){const l=c.target;l.index!==null&&e.remove(l.index);for(const u in l.attributes)e.remove(l.attributes[u]);for(const u in l.morphAttributes){const d=l.morphAttributes[u];for(let p=0,m=d.length;p<m;p++)e.remove(d[p])}l.removeEventListener("dispose",s),delete i[l.id];const h=a.get(l);h&&(e.remove(h),a.delete(l)),n.releaseStatesOfGeometry(l),l.isInstancedBufferGeometry===!0&&delete l._maxInstanceCount,t.memory.geometries--}function o(c){const l=[],h=c.index,u=c.attributes.position;let d=0;if(h!==null){const v=h.array;d=h.version;for(let _=0,f=v.length;_<f;_+=3){const x=v[_+0],g=v[_+1],y=v[_+2];l.push(x,g,g,y,y,x)}}else{if(u===void 0)return;{const v=u.array;d=u.version;for(let _=0,f=v.length/3-1;_<f;_+=3){const x=_+0,g=_+1,y=_+2;l.push(x,g,g,y,y,x)}}}const p=new(Ml(l)?Rl:wl)(l,1);p.version=d;const m=a.get(c);m&&e.remove(m),a.set(c,p)}return{get:function(c,l){return i[l.id]===!0||(l.addEventListener("dispose",s),i[l.id]=!0,t.memory.geometries++),l},update:function(c){const l=c.attributes;for(const u in l)e.update(l[u],r.ARRAY_BUFFER);const h=c.morphAttributes;for(const u in h){const d=h[u];for(let p=0,m=d.length;p<m;p++)e.update(d[p],r.ARRAY_BUFFER)}},getWireframeAttribute:function(c){const l=a.get(c);if(l){const h=c.index;h!==null&&l.version<h.version&&o(c)}else o(c);return a.get(c)}}}function Jc(r,e,t,n){const i=n.isWebGL2;let a,s,o;this.setMode=function(c){a=c},this.setIndex=function(c){s=c.type,o=c.bytesPerElement},this.render=function(c,l){r.drawElements(a,l,s,c*o),t.update(l,a,1)},this.renderInstances=function(c,l,h){if(h===0)return;let u,d;if(i)u=r,d="drawElementsInstanced";else if(u=e.get("ANGLE_instanced_arrays"),d="drawElementsInstancedANGLE",u===null)return;u[d](a,l,s,c*o,h),t.update(l,a,h)},this.renderMultiDraw=function(c,l,h){if(h===0)return;const u=e.get("WEBGL_multi_draw");if(u===null)for(let d=0;d<h;d++)this.render(c[d]/o,l[d]);else{u.multiDrawElementsWEBGL(a,l,0,s,c,0,h);let d=0;for(let p=0;p<h;p++)d+=l[p];t.update(d,a,1)}}}function $c(r){const e={frame:0,calls:0,triangles:0,points:0,lines:0};return{memory:{geometries:0,textures:0},render:e,programs:null,autoReset:!0,reset:function(){e.calls=0,e.triangles=0,e.points=0,e.lines=0},update:function(t,n,i){switch(e.calls++,n){case r.TRIANGLES:e.triangles+=i*(t/3);break;case r.LINES:e.lines+=i*(t/2);break;case r.LINE_STRIP:e.lines+=i*(t-1);break;case r.LINE_LOOP:e.lines+=i*t;break;case r.POINTS:e.points+=i*t}}}}function Qc(r,e){return r[0]-e[0]}function eh(r,e){return Math.abs(e[1])-Math.abs(r[1])}function th(r,e,t){const n={},i=new Float32Array(8),a=new WeakMap,s=new Ve,o=[];for(let c=0;c<8;c++)o[c]=[c,0];return{update:function(c,l,h){const u=c.morphTargetInfluences;if(e.isWebGL2===!0){const p=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,m=p!==void 0?p.length:0;let v=a.get(l);if(v===void 0||v.count!==m){let A=function(){B.dispose(),a.delete(l),l.removeEventListener("dispose",A)};var d=A;v!==void 0&&v.texture.dispose();const _=l.morphAttributes.position!==void 0,f=l.morphAttributes.normal!==void 0,x=l.morphAttributes.color!==void 0,g=l.morphAttributes.position||[],y=l.morphAttributes.normal||[],C=l.morphAttributes.color||[];let w=0;_===!0&&(w=1),f===!0&&(w=2),x===!0&&(w=3);let T=l.attributes.position.count*w,U=1;T>e.maxTextureSize&&(U=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const L=new Float32Array(T*U*4*m),B=new bl(L,T,U,m);B.type=Tt,B.needsUpdate=!0;const re=4*w;for(let k=0;k<m;k++){const Z=g[k],se=y[k],pe=C[k],K=T*U*4*k;for(let j=0;j<Z.count;j++){const q=j*re;_===!0&&(s.fromBufferAttribute(Z,j),L[K+q+0]=s.x,L[K+q+1]=s.y,L[K+q+2]=s.z,L[K+q+3]=0),f===!0&&(s.fromBufferAttribute(se,j),L[K+q+4]=s.x,L[K+q+5]=s.y,L[K+q+6]=s.z,L[K+q+7]=0),x===!0&&(s.fromBufferAttribute(pe,j),L[K+q+8]=s.x,L[K+q+9]=s.y,L[K+q+10]=s.z,L[K+q+11]=pe.itemSize===4?s.w:1)}}v={count:m,texture:B,size:new _e(T,U)},a.set(l,v),l.addEventListener("dispose",A)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)h.getUniforms().setValue(r,"morphTexture",c.morphTexture,t);else{let _=0;for(let x=0;x<u.length;x++)_+=u[x];const f=l.morphTargetsRelative?1:1-_;h.getUniforms().setValue(r,"morphTargetBaseInfluence",f),h.getUniforms().setValue(r,"morphTargetInfluences",u)}h.getUniforms().setValue(r,"morphTargetsTexture",v.texture,t),h.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}else{const p=u===void 0?0:u.length;let m=n[l.id];if(m===void 0||m.length!==p){m=[];for(let g=0;g<p;g++)m[g]=[g,0];n[l.id]=m}for(let g=0;g<p;g++){const y=m[g];y[0]=g,y[1]=u[g]}m.sort(eh);for(let g=0;g<8;g++)g<p&&m[g][1]?(o[g][0]=m[g][0],o[g][1]=m[g][1]):(o[g][0]=Number.MAX_SAFE_INTEGER,o[g][1]=0);o.sort(Qc);const v=l.morphAttributes.position,_=l.morphAttributes.normal;let f=0;for(let g=0;g<8;g++){const y=o[g],C=y[0],w=y[1];C!==Number.MAX_SAFE_INTEGER&&w?(v&&l.getAttribute("morphTarget"+g)!==v[C]&&l.setAttribute("morphTarget"+g,v[C]),_&&l.getAttribute("morphNormal"+g)!==_[C]&&l.setAttribute("morphNormal"+g,_[C]),i[g]=w,f+=w):(v&&l.hasAttribute("morphTarget"+g)===!0&&l.deleteAttribute("morphTarget"+g),_&&l.hasAttribute("morphNormal"+g)===!0&&l.deleteAttribute("morphNormal"+g),i[g]=0)}const x=l.morphTargetsRelative?1:1-f;h.getUniforms().setValue(r,"morphTargetBaseInfluence",x),h.getUniforms().setValue(r,"morphTargetInfluences",i)}}}}function nh(r,e,t,n){let i=new WeakMap;function a(s){const o=s.target;o.removeEventListener("dispose",a),t.remove(o.instanceMatrix),o.instanceColor!==null&&t.remove(o.instanceColor)}return{update:function(s){const o=n.render.frame,c=s.geometry,l=e.get(s,c);if(i.get(l)!==o&&(e.update(l),i.set(l,o)),s.isInstancedMesh&&(s.hasEventListener("dispose",a)===!1&&s.addEventListener("dispose",a),i.get(s)!==o&&(t.update(s.instanceMatrix,r.ARRAY_BUFFER),s.instanceColor!==null&&t.update(s.instanceColor,r.ARRAY_BUFFER),i.set(s,o))),s.isSkinnedMesh){const h=s.skeleton;i.get(h)!==o&&(h.update(),i.set(h,o))}return l},dispose:function(){i=new WeakMap}}}class Nl extends it{constructor(e,t,n,i,a,s,o,c,l,h){if((h=h!==void 0?h:qn)!==qn&&h!==Ti)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===qn&&(n=Tn),n===void 0&&h===Ti&&(n=jn),super(null,i,a,s,o,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:ut,this.minFilter=c!==void 0?c:ut,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Ul=new it,Dl=new Nl(1,1);Dl.compareFunction=515;const Ol=new bl,Fl=new Ec,Bl=new Ll,xo=[],yo=[],Mo=new Float32Array(16),So=new Float32Array(9),Eo=new Float32Array(4);function Ni(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let a=xo[i];if(a===void 0&&(a=new Float32Array(i),xo[i]=a),e!==0){n.toArray(a,0);for(let s=1,o=0;s!==e;++s)o+=t,r[s].toArray(a,o)}return a}function Qe(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function et(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function Zr(r,e){let t=yo[e];t===void 0&&(t=new Int32Array(e),yo[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function ih(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function rh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y||(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Qe(t,e))return;r.uniform2fv(this.addr,e),et(t,e)}}function ah(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z||(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)t[0]===e.r&&t[1]===e.g&&t[2]===e.b||(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Qe(t,e))return;r.uniform3fv(this.addr,e),et(t,e)}}function sh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z&&t[3]===e.w||(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Qe(t,e))return;r.uniform4fv(this.addr,e),et(t,e)}}function oh(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(Qe(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),et(t,e)}else{if(Qe(t,n))return;Eo.set(n),r.uniformMatrix2fv(this.addr,!1,Eo),et(t,n)}}function lh(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(Qe(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),et(t,e)}else{if(Qe(t,n))return;So.set(n),r.uniformMatrix3fv(this.addr,!1,So),et(t,n)}}function ch(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(Qe(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),et(t,e)}else{if(Qe(t,n))return;Mo.set(n),r.uniformMatrix4fv(this.addr,!1,Mo),et(t,n)}}function hh(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function uh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y||(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Qe(t,e))return;r.uniform2iv(this.addr,e),et(t,e)}}function dh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z||(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Qe(t,e))return;r.uniform3iv(this.addr,e),et(t,e)}}function ph(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z&&t[3]===e.w||(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Qe(t,e))return;r.uniform4iv(this.addr,e),et(t,e)}}function fh(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function mh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y||(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Qe(t,e))return;r.uniform2uiv(this.addr,e),et(t,e)}}function gh(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z||(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Qe(t,e))return;r.uniform3uiv(this.addr,e),et(t,e)}}function _h(r,e){const t=this.cache;if(e.x!==void 0)t[0]===e.x&&t[1]===e.y&&t[2]===e.z&&t[3]===e.w||(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Qe(t,e))return;r.uniform4uiv(this.addr,e),et(t,e)}}function vh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);const a=this.type===r.SAMPLER_2D_SHADOW?Dl:Ul;t.setTexture2D(e||a,i)}function xh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Fl,i)}function yh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Bl,i)}function Mh(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Ol,i)}function Sh(r,e){r.uniform1fv(this.addr,e)}function Eh(r,e){const t=Ni(e,this.size,2);r.uniform2fv(this.addr,t)}function Th(r,e){const t=Ni(e,this.size,3);r.uniform3fv(this.addr,t)}function bh(r,e){const t=Ni(e,this.size,4);r.uniform4fv(this.addr,t)}function Ah(r,e){const t=Ni(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function wh(r,e){const t=Ni(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function Rh(r,e){const t=Ni(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function Ch(r,e){r.uniform1iv(this.addr,e)}function Ph(r,e){r.uniform2iv(this.addr,e)}function Lh(r,e){r.uniform3iv(this.addr,e)}function Ih(r,e){r.uniform4iv(this.addr,e)}function Nh(r,e){r.uniform1uiv(this.addr,e)}function Uh(r,e){r.uniform2uiv(this.addr,e)}function Dh(r,e){r.uniform3uiv(this.addr,e)}function Oh(r,e){r.uniform4uiv(this.addr,e)}function Fh(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);Qe(n,a)||(r.uniform1iv(this.addr,a),et(n,a));for(let s=0;s!==i;++s)t.setTexture2D(e[s]||Ul,a[s])}function Bh(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);Qe(n,a)||(r.uniform1iv(this.addr,a),et(n,a));for(let s=0;s!==i;++s)t.setTexture3D(e[s]||Fl,a[s])}function zh(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);Qe(n,a)||(r.uniform1iv(this.addr,a),et(n,a));for(let s=0;s!==i;++s)t.setTextureCube(e[s]||Bl,a[s])}function Hh(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);Qe(n,a)||(r.uniform1iv(this.addr,a),et(n,a));for(let s=0;s!==i;++s)t.setTexture2DArray(e[s]||Ol,a[s])}class Vh{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=function(i){switch(i){case 5126:return ih;case 35664:return rh;case 35665:return ah;case 35666:return sh;case 35674:return oh;case 35675:return lh;case 35676:return ch;case 5124:case 35670:return hh;case 35667:case 35671:return uh;case 35668:case 35672:return dh;case 35669:case 35673:return ph;case 5125:return fh;case 36294:return mh;case 36295:return gh;case 36296:return _h;case 35678:case 36198:case 36298:case 36306:case 35682:return vh;case 35679:case 36299:case 36307:return xh;case 35680:case 36300:case 36308:case 36293:return yh;case 36289:case 36303:case 36311:case 36292:return Mh}}(t.type)}}class kh{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=function(i){switch(i){case 5126:return Sh;case 35664:return Eh;case 35665:return Th;case 35666:return bh;case 35674:return Ah;case 35675:return wh;case 35676:return Rh;case 5124:case 35670:return Ch;case 35667:case 35671:return Ph;case 35668:case 35672:return Lh;case 35669:case 35673:return Ih;case 5125:return Nh;case 36294:return Uh;case 36295:return Dh;case 36296:return Oh;case 35678:case 36198:case 36298:case 36306:case 35682:return Fh;case 35679:case 36299:case 36307:return Bh;case 35680:case 36300:case 36308:case 36293:return zh;case 36289:case 36303:case 36311:case 36292:return Hh}}(t.type)}}class Gh{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let a=0,s=i.length;a!==s;++a){const o=i[a];o.setValue(e,t[o.id],n)}}}const Ua=/(\w+)(\])?(\[|\.)?/g;function To(r,e){r.seq.push(e),r.map[e.id]=e}function Wh(r,e,t){const n=r.name,i=n.length;for(Ua.lastIndex=0;;){const a=Ua.exec(n),s=Ua.lastIndex;let o=a[1];const c=a[2]==="]",l=a[3];if(c&&(o|=0),l===void 0||l==="["&&s+2===i){To(t,l===void 0?new Vh(o,r,e):new kh(o,r,e));break}{let h=t.map[o];h===void 0&&(h=new Gh(o),To(t,h)),t=h}}}class Fr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const a=e.getActiveUniform(t,i);Wh(a,e.getUniformLocation(t,a.name),this)}}setValue(e,t,n,i){const a=this.map[t];a!==void 0&&a.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let a=0,s=t.length;a!==s;++a){const o=t[a],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,a=e.length;i!==a;++i){const s=e[i];s.id in t&&n.push(s)}return n}}function bo(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const Xh=37297;let jh=0;function Ao(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const a=/ERROR: 0:(\d+)/.exec(i);if(a){const s=parseInt(a[1]);return t.toUpperCase()+`
...
`)}(r.getShaderSource(e),s)}return i}function qh(r,e){const t=function(n){const i=He.getPrimaries(He.workingColorSpace),a=He.getPrimaries(n);let s;switch(i===a?s="":i===Gr&&a===kr?s="LinearDisplayP3ToLinearSRGB":i===kr&&a===Gr&&(s="LinearSRGBToLinearDisplayP3"),n){case st:case Yr:return[s,"LinearTransferOETF"];case ft:case hs:return[s,"sRGBTransferOETF"];default:return[s,"LinearTransferOETF"]}}(e);return`vec4 ${r}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Yh(r,e){let t;switch(e){case uc:t="Linear";break;case dc:t="Reinhard";break;case pc:t="OptimizedCineon";break;case fc:t="ACESFilmic";break;case gc:t="AgX";break;case _c:t="Neutral";break;case mc:t="Custom";break;default:t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function di(r){return r!==""}function wo(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ro(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Kh=/^[ \t]*#include +<([\w\d./]+)>/gm;function es(r){return r.replace(Kh,Jh)}const Zh=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Jh(r,e){let t=be[e];if(t===void 0){const n=Zh.get(e);if(n===void 0)throw new Error("Can not resolve #include <"+e+">");t=be[n]}return es(t)}const $h=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Co(r){return r.replace($h,Qh)}function Qh(r,e,t,n){let i="";for(let a=parseInt(e);a<parseInt(t);a++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return i}function Po(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}function eu(r,e,t,n){const i=r.getContext(),a=t.defines;let s=t.vertexShader,o=t.fragmentShader;const c=function(A){let k="SHADOWMAP_TYPE_BASIC";return A.shadowMapType===vl?k="SHADOWMAP_TYPE_PCF":A.shadowMapType===lc?k="SHADOWMAP_TYPE_PCF_SOFT":A.shadowMapType===on&&(k="SHADOWMAP_TYPE_VSM"),k}(t),l=function(A){let k="ENVMAP_TYPE_CUBE";if(A.envMap)switch(A.envMapMode){case Mi:case Si:k="ENVMAP_TYPE_CUBE";break;case qr:k="ENVMAP_TYPE_CUBE_UV"}return k}(t),h=function(A){let k="ENVMAP_MODE_REFLECTION";return A.envMap&&A.envMapMode===Si&&(k="ENVMAP_MODE_REFRACTION"),k}(t),u=function(A){let k="ENVMAP_BLENDING_NONE";if(A.envMap)switch(A.combine){case xl:k="ENVMAP_BLENDING_MULTIPLY";break;case cc:k="ENVMAP_BLENDING_MIX";break;case hc:k="ENVMAP_BLENDING_ADD"}return k}(t),d=function(A){const k=A.envMapCubeUVHeight;if(k===null)return null;const Z=Math.log2(k)-2,se=1/k;return{texelWidth:1/(3*Math.max(Math.pow(2,Z),112)),texelHeight:se,maxMip:Z}}(t),p=t.isWebGL2?"":function(A){return[A.extensionDerivatives||A.envMapCubeUVHeight||A.bumpMap||A.normalMapTangentSpace||A.clearcoatNormalMap||A.flatShading||A.alphaToCoverage||A.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(A.extensionFragDepth||A.logarithmicDepthBuffer)&&A.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",A.extensionDrawBuffers&&A.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(A.extensionShaderTextureLOD||A.envMap||A.transmission)&&A.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(di).join(`
`)}(t),m=function(A){return[A.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",A.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(di).join(`
...
}`,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new gt(new Kr(20,20),i)}e.render(this.mesh,t)}}reset(){this.texture=null,this.mesh=null}}class Su extends Zn{constructor(e,t){super();const n=this;let i=null,a=1,s=null,o="local-floor",c=1,l=null,h=null,u=null,d=null,p=null,m=null;const v=new Mu,_=t.getContextAttributes();let f=null,x=null;const g=[],y=[],C=new _e;let w=null;const T=new mt;T.layers.enable(1),T.viewport=new Ve;const U=new mt;U.layers.enable(2),U.viewport=new Ve;const L=[T,U],B=new xu;B.layers.enable(1),B.layers.enable(2);let re=null,A=null;function k(X){const J=y.indexOf(X.inputSource);if(J===-1)return;const me=g[J];me!==void 0&&(me.update(X.inputSource,X.frame,l||s),me.dispatchEvent({type:X.type,data:X.inputSource}))}function Z(){i.removeEventListener("select",k),i.removeEventListener("selectstart",k),i.removeEventListener("selectend",k),i.removeEventListener("squeeze",k),i.removeEventListener("squeezestart",k),i.removeEventListener("squeezeend",k),i.removeEventListener("end",Z),i.removeEventListener("inputsourceschange",se);for(let X=0;X<g.length;X++){const J=y[X];J!==null&&(y[X]=null,g[X].disconnect(J))}re=null,A=null,v.reset(),e.setRenderTarget(f),p=null,d=null,u=null,i=null,x=null,ue.stop(),n.isPresenting=!1,e.setPixelRatio(w),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}function se(X){for(let J=0;J<X.removed.length;J++){const me=X.removed[J],le=y.indexOf(me);le>=0&&(y[le]=null,g[le].disconnect(me))}for(let J=0;J<X.added.length;J++){const me=X.added[J];let le=y.indexOf(me);if(le===-1){for(let M=0;M<g.length;M++){if(M>=y.length){y.push(me),le=M;break}if(y[M]===null){y[M]=me,le=M;break}}if(le===-1)break}const b=g[le];b&&b.connect(me)}}this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let J=g[X];return J===void 0&&(J=new Da,g[X]=J),J.getTargetRaySpace()},this.getControllerGrip=function(X){let J=g[X];return J===void 0&&(J=new Da,g[X]=J),J.getGripSpace()},this.getHand=function(X){let J=g[X];return J===void 0&&(J=new Da,g[X]=J),J.getHandSpace()},this.setFramebufferScaleFactor=function(X){a=X,n.isPresenting},this.setReferenceSpaceType=function(X){o=X,n.isPresenting},this.getReferenceSpace=function(){return l||s},this.setReferenceSpace=function(X){l=X},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u},this.getFrame=function(){return m},this.getSession=function(){return i},this.setSession=async function(X){if(i=X,i!==null){if(f=e.getRenderTarget(),i.addEventListener("select",k),i.addEventListener("selectstart",k),i.addEventListener("selectend",k),i.addEventListener("squeeze",k),i.addEventListener("squeezestart",k),i.addEventListener("squeezeend",k),i.addEventListener("end",Z),i.addEventListener("inputsourceschange",se),_.xrCompatible!==!0&&await t.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(C),i.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const J={antialias:i.renderState.layers!==void 0||_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:a};p=new XRWebGLLayer(i,t,J),i.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),x=new Kn(p.framebufferWidth,p.framebufferHeight,{format:qt,type:vi,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil})}else{let J=null,me=null,le=null;_.depth&&(le=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=_.stencil?Ti:qn,me=_.stencil?jn:Tn);const b={colorFormat:t.RGBA8,depthFormat:le,scaleFactor:a};u=new XRWebGLBinding(i,t),d=u.createProjectionLayer(b),i.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),x=new Kn(d.textureWidth,d.textureHeight,{format:qt,type:vi,depthTexture:new Nl(d.textureWidth,d.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0}),e.properties.get(x).__ignoreDepthValues=d.ignoreDepthValues}x.isXRRenderTarget=!0,this.setFoveation(c),l=null,s=await i.requestReferenceSpace(o),ue.setContext(i),ue.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode};const pe=new P,K=new P;function j(X,J){J===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(J.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(i===null)return;v.texture!==null&&(X.near=v.depthNear,X.far=v.depthFar),B.near=U.near=T.near=X.near,B.far=U.far=T.far=X.far,re===B.near&&A===B.far||(i.updateRenderState({depthNear:B.near,depthFar:B.far}),re=B.near,A=B.far,T.near=re,T.far=A,U.near=re,U.far=A,T.updateProjectionMatrix(),U.updateProjectionMatrix(),X.updateProjectionMatrix());const J=X.parent,me=B.cameras;j(B,J);for(let le=0;le<me.length;le++)j(me[le],J);me.length===2?function(le,b,M){pe.setFromMatrixPosition(b.matrixWorld),K.setFromMatrixPosition(M.matrixWorld);const F=pe.distanceTo(K),O=b.projectionMatrix.elements,N=M.projectionMatrix.elements,H=O[14]/(O[10]-1),ae=O[14]/(O[10]+1),ne=(O[9]+1)/O[5],Q=(O[9]-1)/O[5],E=(O[8]-1)/O[0],te=(N[8]+1)/N[0],D=H*E,oe=H*te,ee=F/(-E+te),R=ee*-E;b.matrixWorld.decompose(le.position,le.quaternion,le.scale),le.translateX(R),le.translateZ(ee),le.matrixWorld.compose(le.position,le.quaternion,le.scale),le.matrixWorldInverse.copy(le.matrixWorld).invert();const I=H+ee,G=ae+ee,ie=D-R,ce=oe+(F-R),xe=ne*ae/G*I,Se=Q*ae/G*I;le.projectionMatrix.makePerspective(ie,ce,xe,Se,I,G),le.projectionMatrixInverse.copy(le.projectionMatrix).invert()}(B,T,U):B.projectionMatrix.copy(T.projectionMatrix),function(le,b,M){M===null?le.matrix.copy(b.matrixWorld):(le.matrix.copy(M.matrixWorld),le.matrix.invert(),le.matrix.multiply(b.matrixWorld)),le.matrix.decompose(le.position,le.quaternion,le.scale),le.updateMatrixWorld(!0),le.projectionMatrix.copy(b.projectionMatrix),le.projectionMatrixInverse.copy(b.projectionMatrixInverse),le.isPerspectiveCamera&&(le.fov=2*wi*Math.atan(1/le.projectionMatrix.elements[5]),le.zoom=1)}(X,B,J)},this.getCamera=function(){return B},this.getFoveation=function(){if(d!==null||p!==null)return c},this.setFoveation=function(X){c=X,d!==null&&(d.fixedFoveation=X),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=X)},this.hasDepthSensing=function(){return v.texture!==null};let q=null;const ue=new Il;ue.setAnimationLoop(function(X,J){if(h=J.getViewerPose(l||s),m=J,h!==null){const me=h.views;p!==null&&(e.setRenderTargetFramebuffer(x,p.framebuffer),e.setRenderTarget(x));let le=!1;me.length!==B.cameras.length&&(B.cameras.length=0,le=!0);for(let M=0;M<me.length;M++){const F=me[M];let O=null;if(p!==null)O=p.getViewport(F);else{const H=u.getViewSubImage(d,F);O=H.viewport,M===0&&(e.setRenderTargetTextures(x,H.colorTexture,d.ignoreDepthValues?void 0:H.depthStencilTexture),e.setRenderTarget(x))}let N=L[M];N===void 0&&(N=new mt,N.layers.enable(M),N.viewport=new Ve,L[M]=N),N.matrix.fromArray(F.transform.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale),N.projectionMatrix.fromArray(F.projectionMatrix),N.projectionMatrixInverse.copy(N.projectionMatrix).invert(),N.viewport.set(O.x,O.y,O.width,O.height),M===0&&(B.matrix.copy(N.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),le===!0&&B.cameras.push(N)}const b=i.enabledFeatures;if(b&&b.includes("depth-sensing")){const M=u.getDepthInformation(me[0]);M&&M.isValid&&M.texture&&v.init(e,M,i.renderState)}}for(let me=0;me<g.length;me++){const le=y[me],b=g[me];le!==null&&b!==void 0&&b.update(le,J,l||s)}v.render(e,B),q&&q(X,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),m=null}),this.setAnimationLoop=function(X){q=X},this.dispose=function(){}}}const Hn=new Zt,Eu=new Te;function Tu(r,e){function t(i,a){i.matrixAutoUpdate===!0&&i.updateMatrix(),a.value.copy(i.matrix)}function n(i,a){i.opacity.value=a.opacity,a.color&&i.diffuse.value.copy(a.color),a.emissive&&i.emissive.value.copy(a.emissive).multiplyScalar(a.emissiveIntensity),a.map&&(i.map.value=a.map,t(a.map,i.mapTransform)),a.alphaMap&&(i.alphaMap.value=a.alphaMap,t(a.alphaMap,i.alphaMapTransform)),a.bumpMap&&(i.bumpMap.value=a.bumpMap,t(a.bumpMap,i.bumpMapTransform),i.bumpScale.value=a.bumpScale,a.side===yt&&(i.bumpScale.value*=-1)),a.normalMap&&(i.normalMap.value=a.normalMap,t(a.normalMap,i.normalMapTransform),i.normalScale.value.copy(a.normalScale),a.side===yt&&i.normalScale.value.negate()),a.displacementMap&&(i.displacementMap.value=a.displacementMap,t(a.displacementMap,i.displacementMapTransform),i.displacementScale.value=a.displacementScale,i.displacementBias.value=a.displacementBias),a.emissiveMap&&(i.emissiveMap.value=a.emissiveMap,t(a.emissiveMap,i.emissiveMapTransform)),a.specularMap&&(i.specularMap.value=a.specularMap,t(a.specularMap,i.specularMapTransform)),a.alphaTest>0&&(i.alphaTest.value=a.alphaTest);const s=e.get(a),o=s.envMap,c=s.envMapRotation;if(o&&(i.envMap.value=o,Hn.copy(c),Hn.x*=-1,Hn.y*=-1,Hn.z*=-1,o.isCubeTexture&&o.isRenderTargetTexture===!1&&(Hn.y*=-1,Hn.z*=-1),i.envMapRotation.value.setFromMatrix4(Eu.makeRotationFromEuler(Hn)),i.flipEnvMap.value=o.isCubeTexture&&o.isRenderTargetTexture===!1?-1:1,i.reflectivity.value=a.reflectivity,i.ior.value=a.ior,i.refractionRatio.value=a.refractionRatio),a.lightMap){i.lightMap.value=a.lightMap;const l=r._useLegacyLights===!0?Math.PI:1;i.lightMapIntensity.value=a.lightMapIntensity*l,t(a.lightMap,i.lightMapTransform)}a.aoMap&&(i.aoMap.value=a.aoMap,i.aoMapIntensity.value=a.aoMapIntensity,t(a.aoMap,i.aoMapTransform))}return{refreshFogUniforms:function(i,a){a.color.getRGB(i.fogColor.value,Cl(r)),a.isFog?(i.fogNear.value=a.near,i.fogFar.value=a.far):a.isFogExp2&&(i.fogDensity.value=a.density)},refreshMaterialUniforms:function(i,a,s,o,c){a.isMeshBasicMaterial||a.isMeshLambertMaterial?n(i,a):a.isMeshToonMaterial?(n(i,a),function(l,h){h.gradientMap&&(l.gradientMap.value=h.gradientMap)}(i,a)):a.isMeshPhongMaterial?(n(i,a),function(l,h){l.specular.value.copy(h.specular),l.shininess.value=Math.max(h.shininess,1e-4)}(i,a)):a.isMeshStandardMaterial?(n(i,a),function(l,h){l.metalness.value=h.metalness,h.metalnessMap&&(l.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,l.metalnessMapTransform)),l.roughness.value=h.roughness,h.roughnessMap&&(l.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,l.roughnessMapTransform)),e.get(h).envMap&&(l.envMapIntensity.value=h.envMapIntensity)}(i,a),a.isMeshPhysicalMaterial&&function(l,h,u){l.ior.value=h.ior,h.sheen>0&&(l.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),l.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(l.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,l.sheenColorMapTransform)),h.sheenRoughnessMap&&(l.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,l.sheenRoughnessMapTransform))),h.clearcoat>0&&(l.clearcoat.value=h.clearcoat,l.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(l.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,l.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(l.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,l.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(l.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,l.clearcoatNormalMapTransform),l.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===yt&&l.clearcoatNormalScale.value.negate())),h.iridescence>0&&(l.iridescence.value=h.iridescence,l.iridescenceIOR.value=h.iridescenceIOR,l.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],l.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(l.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,l.iridescenceMapTransform)),h.iridescenceThicknessMap&&(l.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,l.iridescenceThicknessMapTransform))),h.transmission>0&&(l.transmission.value=h.transmission,l.transmissionSamplerMap.value=u.texture,l.transmissionSamplerSize.value.set(u.width,u.height),h.transmissionMap&&(l.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,l.transmissionMapTransform)),l.thickness.value=h.thickness,h.thicknessMap&&(l.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,l.thicknessMapTransform)),l.attenuationDistance.value=h.attenuationDistance,l.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(l.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(l.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,l.anisotropyMapTransform))),l.specularIntensity.value=h.specularIntensity,l.specularColor.value.copy(h.specularColor),h.specularColorMap&&(l.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,l.specularColorMapTransform)),h.specularIntensityMap&&(l.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,l.specularIntensityMapTransform))}(i,a,c)):a.isMeshMatcapMaterial?(n(i,a),function(l,h){h.matcap&&(l.matcap.value=h.matcap)}(i,a)):a.isMeshDepthMaterial?n(i,a):a.isMeshDistanceMaterial?(n(i,a),function(l,h){const u=e.get(h).light;l.referencePosition.value.setFromMatrixPosition(u.matrixWorld),l.nearDistance.value=u.shadow.camera.near,l.farDistance.value=u.shadow.camera.far}(i,a)):a.isMeshNormalMaterial?n(i,a):a.isLineBasicMaterial?(function(l,h){l.diffuse.value.copy(h.color),l.opacity.value=h.opacity,h.map&&(l.map.value=h.map,t(h.map,l.mapTransform))}(i,a),a.isLineDashedMaterial&&function(l,h){l.dashSize.value=h.dashSize,l.totalSize.value=h.dashSize+h.gapSize,l.scale.value=h.scale}(i,a)):a.isPointsMaterial?function(l,h,u,d){l.diffuse.value.copy(h.color),l.opacity.value=h.opacity,l.size.value=h.size*u,l.scale.value=.5*d,h.map&&(l.map.value=h.map,t(h.map,l.uvTransform)),h.alphaMap&&(l.alphaMap.value=h.alphaMap,t(h.alphaMap,l.alphaMapTransform)),h.alphaTest>0&&(l.alphaTest.value=h.alphaTest)}(i,a,s,o):a.isSpriteMaterial?function(l,h){l.diffuse.value.copy(h.color),l.opacity.value=h.opacity,l.rotation.value=h.rotation,h.map&&(l.map.value=h.map,t(h.map,l.mapTransform)),h.alphaMap&&(l.alphaMap.value=h.alphaMap,t(h.alphaMap,l.alphaMapTransform)),h.alphaTest>0&&(l.alphaTest.value=h.alphaTest)}(i,a):a.isShadowMaterial?(i.color.value.copy(a.color),i.opacity.value=a.opacity):a.isShaderMaterial&&(a.uniformsNeedUpdate=!1)}}}function bu(r,e,t,n){let i={},a={},s=[];const o=t.isWebGL2?r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS):0;function c(u,d,p,m){const v=u.value,_=d+"_"+p;if(m[_]===void 0)return m[_]=typeof v=="number"||typeof v=="boolean"?v:v.clone(),!0;{const f=m[_];if(typeof v=="number"||typeof v=="boolean"){if(f!==v)return m[_]=v,!0}else if(f.equals(v)===!1)return f.copy(v),!0}return!1}function l(u){const d={boundary:0,storage:0};return typeof u=="number"||typeof u=="boolean"?(d.boundary=4,d.storage=4):u.isVector2?(d.boundary=8,d.storage=8):u.isVector3||u.isColor?(d.boundary=16,d.storage=12):u.isVector4?(d.boundary=16,d.storage=16):u.isMatrix3?(d.boundary=48,d.storage=48):u.isMatrix4?(d.boundary=64,d.storage=64):u.isTexture,d}function h(u){const d=u.target;d.removeEventListener("dispose",h);const p=s.indexOf(d.__bindingPointIndex);s.splice(p,1),r.deleteBuffer(i[d.id]),delete i[d.id],delete a[d.id]}return{bind:function(u,d){const p=d.program;n.uniformBlockBinding(u,p)},update:function(u,d){let p=i[u.id];p===void 0&&(function(_){const f=_.uniforms;let x=0;const g=16;for(let C=0,w=f.length;C<w;C++){const T=Array.isArray(f[C])?f[C]:[f[C]];for(let U=0,L=T.length;U<L;U++){const B=T[U],re=Array.isArray(B.value)?B.value:[B.value];for(let A=0,k=re.length;A<k;A++){const Z=l(re[A]),se=x%g;se!==0&&g-se<Z.boundary&&(x+=g-se),B.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=x,x+=Z.storage}}}const y=x%g;y>0&&(x+=g-y),_.__size=x,_.__cache={}}(u),p=function(_){const f=function(){for(let C=0;C<o;C++)if(s.indexOf(C)===-1)return s.push(C),C;return 0}();_.__bindingPointIndex=f;const x=r.createBuffer(),g=_.__size,y=_.usage;return r.bindBuffer(r.UNIFORM_BUFFER,x),r.bufferData(r.UNIFORM_BUFFER,g,y),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,f,x),x}(u),i[u.id]=p,u.addEventListener("dispose",h));const m=d.program;n.updateUBOMapping(u,m);const v=e.render.frame;a[u.id]!==v&&(function(_){const f=i[_.id],x=_.uniforms,g=_.__cache;r.bindBuffer(r.UNIFORM_BUFFER,f);for(let y=0,C=x.length;y<C;y++){const w=Array.isArray(x[y])?x[y]:[x[y]];for(let T=0,U=w.length;T<U;T++){const L=w[T];if(c(L,y,T,g)===!0){const B=L.__offset,re=Array.isArray(L.value)?L.value:[L.value];let A=0;for(let k=0;k<re.length;k++){const Z=re[k],se=l(Z);typeof Z=="number"||typeof Z=="boolean"?(L.__data[0]=Z,r.bufferSubData(r.UNIFORM_BUFFER,B+A,L.__data)):Z.isMatrix3?(L.__data[0]=Z.elements[0],L.__data[1]=Z.elements[1],L.__data[2]=Z.elements[2],L.__data[3]=0,L.__data[4]=Z.elements[3],L.__data[5]=Z.elements[4],L.__data[6]=Z.elements[5],L.__data[7]=0,L.__data[8]=Z.elements[6],L.__data[9]=Z.elements[7],L.__data[10]=Z.elements[8],L.__data[11]=0):(Z.toArray(L.__data,A),A+=se.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,B,L.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}(u),a[u.id]=v)},dispose:function(){for(const u in i)r.deleteBuffer(i[u]);s=[],i={},a={}}}}class zl{constructor(e={}){const{canvas:t=vc(),context:n=null,depth:i=!0,stencil:a=!0,alpha:s=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=e;let d;this.isWebGLRenderer=!0,d=n!==null?n.getContextAttributes().alpha:s;const p=new Uint32Array(4),m=new Int32Array(4);let v=null,_=null;const f=[],x=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ft,this._useLegacyLights=!1,this.toneMapping=An,this.toneMappingExposure=1;const g=this;let y=!1,C=0,w=0,T=null,U=-1,L=null;const B=new Ve,re=new Ve;let A=null;const k=new Ee(0);let Z=0,se=t.width,pe=t.height,K=1,j=null,q=null;const ue=new Ve(0,0,se,pe),X=new Ve(0,0,se,pe);let J=!1;const me=new ds;let le=!1,b=!1,M=null;const F=new Te,O=new _e,N=new P,H={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function ae(){return T===null?K:1}let ne,Q,E,te,D,oe,ee,R,I,G,ie,ce,xe,Se,We,fe,ye,Fe,ge,Ce,Ne,rt,bt,Lt,V=n;function Pn(S,z){for(let W=0;W<S.length;W++){const $=S[W],Y=t.getContext($,z);if(Y!==null)return Y}return null}try{const S={alpha:!0,depth:i,stencil:a,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ya}`),t.addEventListener("webglcontextlost",Es,!1),t.addEventListener("webglcontextrestored",Ts,!1),t.addEventListener("webglcontextcreationerror",bs,!1),V===null){const z=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&z.shift(),V=Pn(z,S),V===null)throw Pn(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u",V.getShaderPrecisionFormat===void 0&&(V.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw S}function Ui(){ne=new Kc(V),Q=new Xc(V,ne,e),ne.init(Q),rt=new vu(V,ne,Q),E=new gu(V,ne,Q),te=new $c(V),D=new au,oe=new _u(V,ne,E,D,Q,rt,te),ee=new qc(g),R=new Yc(g),I=new Hc(V,Q),bt=new Gc(V,ne,I,Q),G=new Zc(V,I,te,bt),ie=new nh(V,G,I,te),ge=new th(V,Q,oe),fe=new jc(D),ce=new ru(g,ee,R,ne,Q,bt,fe),xe=new Tu(g,D),Se=new ou,We=new du(ne,Q),Fe=new kc(g,ee,R,E,ie,d,c),ye=new mu(g,ie,Q),Lt=new bu(V,te,Q,E),Ce=new Wc(V,ne,te,Q),Ne=new Jc(V,ne,te,Q),te.programs=ce.programs,g.capabilities=Q,g.extensions=ne,g.properties=D,g.renderLists=Se,g.shadowMap=ye,g.state=E,g.info=te}Ui();const ot=new Su(g,V);function Es(S){S.preventDefault(),y=!0}function Ts(){y=!1;const S=te.autoReset,z=ye.enabled,W=ye.autoUpdate,$=ye.needsUpdate,Y=ye.type;Ui(),te.autoReset=S,ye.enabled=z,ye.autoUpdate=W,ye.needsUpdate=$,ye.type=Y}function bs(S){}function As(S){const z=S.target;z.removeEventListener("dispose",As),function(W){(function($){const Y=D.get($).programs;Y!==void 0&&(Y.forEach(function(de){ce.releaseProgram(de)}),$.isShaderMaterial&&ce.releaseShaderCache($))})(W),D.remove(W)}(z)}function ws(S,z,W){S.transparent===!0&&S.side===2&&S.forceSinglePass===!1?(S.side=yt,S.needsUpdate=!0,tr(S,z,W),S.side=dn,S.needsUpdate=!0,tr(S,z,W),S.side=2):tr(S,z,W)}this.xr=ot,this.getContext=function(){return V},this.getContextAttributes=function(){return V.getContextAttributes()},this.forceContextLoss=function(){const S=ne.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=ne.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return K},this.setPixelRatio=function(S){S!==void 0&&(K=S,this.setSize(se,pe,!1))},this.getSize=function(S){return S.set(se,pe)},this.setSize=function(S,z,W=!0){ot.isPresenting||(se=S,pe=z,t.width=Math.floor(S*K),t.height=Math.floor(z*K),W===!0&&(t.style.width=S+"px",t.style.height=z+"px"),this.setViewport(0,0,S,z))},this.getDrawingBufferSize=function(S){return S.set(se*K,pe*K).floor()},this.setDrawingBufferSize=function(S,z,W){se=S,pe=z,K=W,t.width=Math.floor(S*W),t.height=Math.floor(z*W),this.setViewport(0,0,S,z)},this.getCurrentViewport=function(S){return S.copy(B)},this.getViewport=function(S){return S.copy(ue)},this.setViewport=function(S,z,W,$){S.isVector4?ue.set(S.x,S.y,S.z,S.w):ue.set(S,z,W,$),E.viewport(B.copy(ue).multiplyScalar(K).round())},this.getScissor=function(S){return S.copy(X)},this.setScissor=function(S,z,W,$){S.isVector4?X.set(S.x,S.y,S.z,S.w):X.set(S,z,W,$),E.scissor(re.copy(X).multiplyScalar(K).round())},this.getScissorTest=function(){return J},this.setScissorTest=function(S){E.setScissorTest(J=S)},this.setOpaqueSort=function(S){j=S},this.setTransparentSort=function(S){q=S},this.getClearColor=function(S){return S.copy(Fe.getClearColor())},this.setClearColor=function(){Fe.setClearColor.apply(Fe,arguments)},this.getClearAlpha=function(){return Fe.getClearAlpha()},this.setClearAlpha=function(){Fe.setClearAlpha.apply(Fe,arguments)},this.clear=function(S=!0,z=!0,W=!0){let $=0;if(S){let Y=!1;if(T!==null){const de=T.texture.format;Y=de===1033||de===1031||de===1029}if(Y){const de=T.texture.type,ve=de===vi||de===Tn||de===cs||de===jn||de===1017||de===1018,Me=Fe.getClearColor(),we=Fe.getClearAlpha(),Pe=Me.r,Le=Me.g,Ue=Me.b;ve?(p[0]=Pe,p[1]=Le,p[2]=Ue,p[3]=we,V.clearBufferuiv(V.COLOR,0,p)):(m[0]=Pe,m[1]=Le,m[2]=Ue,m[3]=we,V.clearBufferiv(V.COLOR,0,m))}else $|=V.COLOR_BUFFER_BIT}z&&($|=V.DEPTH_BUFFER_BIT),W&&($|=V.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Es,!1),t.removeEventListener("webglcontextrestored",Ts,!1),t.removeEventListener("webglcontextcreationerror",bs,!1),Se.dispose(),We.dispose(),D.dispose(),ee.dispose(),R.dispose(),ie.dispose(),bt.dispose(),Lt.dispose(),ce.dispose(),ot.dispose(),ot.removeEventListener("sessionstart",Rs),ot.removeEventListener("sessionend",Cs),M&&(M.dispose(),M=null),Ln.stop()},this.renderBufferDirect=function(S,z,W,$,Y,de){z===null&&(z=H);const ve=Y.isMesh&&Y.matrixWorld.determinant()<0,Me=function(Je,At,vt,De,Re){At.isScene!==!0&&(At=H),oe.resetTextureUnits();const Di=At.fog,ta=De.isMeshStandardMaterial?At.environment:null,Jl=T===null?g.outputColorSpace:T.isXRRenderTarget===!0?T.texture.colorSpace:st,nr=(De.isMeshStandardMaterial?R:ee).get(De.envMap||ta),$l=De.vertexColors===!0&&!!vt.attributes.color&&vt.attributes.color.itemSize===4,Ql=!!vt.attributes.tangent&&(!!De.normalMap||De.anisotropy>0),ec=!!vt.morphAttributes.position,tc=!!vt.morphAttributes.normal,nc=!!vt.morphAttributes.color;let Ds=An;De.toneMapped&&(T!==null&&T.isXRRenderTarget!==!0||(Ds=g.toneMapping));const Os=vt.morphAttributes.position||vt.morphAttributes.normal||vt.morphAttributes.color,ic=Os!==void 0?Os.length:0,Oe=D.get(De),rc=_.state.lights;if(le===!0&&(b===!0||Je!==L)){const wt=Je===L&&De.id===U;fe.setState(De,Je,wt)}let Nt=!1;De.version===Oe.__version?Oe.needsLights&&Oe.lightsStateVersion!==rc.state.version||Oe.outputColorSpace!==Jl||Re.isBatchedMesh&&Oe.batching===!1?Nt=!0:Re.isBatchedMesh||Oe.batching!==!0?Re.isInstancedMesh&&Oe.instancing===!1?Nt=!0:Re.isInstancedMesh||Oe.instancing!==!0?Re.isSkinnedMesh&&Oe.skinning===!1?Nt=!0:Re.isSkinnedMesh||Oe.skinning!==!0?Re.isInstancedMesh&&Oe.instancingColor===!0&&Re.instanceColor===null||Re.isInstancedMesh&&Oe.instancingColor===!1&&Re.instanceColor!==null||Re.isInstancedMesh&&Oe.instancingMorph===!0&&Re.morphTexture===null||Re.isInstancedMesh&&Oe.instancingMorph===!1&&Re.morphTexture!==null||Oe.envMap!==nr||De.fog===!0&&Oe.fog!==Di?Nt=!0:Oe.numClippingPlanes===void 0||Oe.numClippingPlanes===fe.numPlanes&&Oe.numIntersection===fe.numIntersection?(Oe.vertexAlphas!==$l||Oe.vertexTangents!==Ql||Oe.morphTargets!==ec||Oe.morphNormals!==tc||Oe.morphColors!==nc||Oe.toneMapping!==Ds||Q.isWebGL2===!0&&Oe.morphTargetsCount!==ic)&&(Nt=!0):Nt=!0:Nt=!0:Nt=!0:Nt=!0:(Nt=!0,Oe.__version=De.version);let Nn=Oe.currentProgram;Nt===!0&&(Nn=tr(De,At,Re));let Fs=!1,Oi=!1,na=!1;const lt=Nn.getUniforms(),Un=Oe.uniforms;if(E.useProgram(Nn.program)&&(Fs=!0,Oi=!0,na=!0),De.id!==U&&(U=De.id,Oi=!0),Fs||L!==Je){lt.setValue(V,"projectionMatrix",Je.projectionMatrix),lt.setValue(V,"viewMatrix",Je.matrixWorldInverse);const wt=lt.map.cameraPosition;wt!==void 0&&wt.setValue(V,N.setFromMatrixPosition(Je.matrixWorld)),Q.logarithmicDepthBuffer&&lt.setValue(V,"logDepthBufFC",2/(Math.log(Je.far+1)/Math.LN2)),(De.isMeshPhongMaterial||De.isMeshToonMaterial||De.isMeshLambertMaterial||De.isMeshBasicMaterial||De.isMeshStandardMaterial||De.isShaderMaterial)&&lt.setValue(V,"isOrthographic",Je.isOrthographicCamera===!0),L!==Je&&(L=Je,Oi=!0,na=!0)}if(Re.isSkinnedMesh){lt.setOptional(V,Re,"bindMatrix"),lt.setOptional(V,Re,"bindMatrixInverse");const wt=Re.skeleton;wt&&Q.floatVertexTextures&&(wt.boneTexture===null&&wt.computeBoneTexture(),lt.setValue(V,"boneTexture",wt.boneTexture,oe))}Re.isBatchedMesh&&(lt.setOptional(V,Re,"batchingTexture"),lt.setValue(V,"batchingTexture",Re._matricesTexture,oe));const ia=vt.morphAttributes;(ia.position!==void 0||ia.normal!==void 0||ia.color!==void 0&&Q.isWebGL2===!0)&&ge.update(Re,vt,Nn),(Oi||Oe.receiveShadow!==Re.receiveShadow)&&(Oe.receiveShadow=Re.receiveShadow,lt.setValue(V,"receiveShadow",Re.receiveShadow)),De.isMeshGouraudMaterial&&De.envMap!==null&&(Un.envMap.value=nr,Un.flipEnvMap.value=nr.isCubeTexture&&nr.isRenderTargetTexture===!1?-1:1),Oi&&(lt.setValue(V,"toneMappingExposure",g.toneMappingExposure),Oe.needsLights&&(Ut=na,(Gt=Un).ambientLightColor.needsUpdate=Ut,Gt.lightProbe.needsUpdate=Ut,Gt.directionalLights.needsUpdate=Ut,Gt.directionalLightShadows.needsUpdate=Ut,Gt.pointLights.needsUpdate=Ut,Gt.pointLightShadows.needsUpdate=Ut,Gt.spotLights.needsUpdate=Ut,Gt.spotLightShadows.needsUpdate=Ut,Gt.rectAreaLights.needsUpdate=Ut,Gt.hemisphereLights.needsUpdate=Ut),Di&&De.fog===!0&&xe.refreshFogUniforms(Un,Di),xe.refreshMaterialUniforms(Un,De,K,pe,M),Fr.upload(V,Ns(Oe),Un,oe));var Gt,Ut;if(De.isShaderMaterial&&De.uniformsNeedUpdate===!0&&(Fr.upload(V,Ns(Oe),Un,oe),De.uniformsNeedUpdate=!1),De.isSpriteMaterial&&lt.setValue(V,"center",Re.center),lt.setValue(V,"modelViewMatrix",Re.modelViewMatrix),lt.setValue(V,"normalMatrix",Re.normalMatrix),lt.setValue(V,"modelMatrix",Re.matrixWorld),De.isShaderMaterial||De.isRawShaderMaterial){const wt=De.uniformsGroups;for(let ra=0,ac=wt.length;ra<ac;ra++)if(Q.isWebGL2){const Bs=wt[ra];Lt.update(Bs,Nn),Lt.bind(Bs,Nn)}}return Nn}(S,z,W,$,Y);E.setMaterial($,ve);let we=W.index,Pe=1;if($.wireframe===!0){if(we=G.getWireframeAttribute(W),we===void 0)return;Pe=2}const Le=W.drawRange,Ue=W.attributes.position;let Xe=Le.start*Pe,It=(Le.start+Le.count)*Pe;de!==null&&(Xe=Math.max(Xe,de.start*Pe),It=Math.min(It,(de.start+de.count)*Pe)),we!==null?(Xe=Math.max(Xe,0),It=Math.min(It,we.count)):Ue!=null&&(Xe=Math.max(Xe,0),It=Math.min(It,Ue.count));const $t=It-Xe;if($t<0||$t===1/0)return;let In;bt.setup(Y,$,Me,W,we);let je=Ce;if(we!==null&&(In=I.get(we),je=Ne,je.setIndex(In)),Y.isMesh)$.wireframe===!0?(E.setLineWidth($.wireframeLinewidth*ae()),je.setMode(V.LINES)):je.setMode(V.TRIANGLES);else if(Y.isLine){let Je=$.linewidth;Je===void 0&&(Je=1),E.setLineWidth(Je*ae()),Y.isLineSegments?je.setMode(V.LINES):Y.isLineLoop?je.setMode(V.LINE_LOOP):je.setMode(V.LINE_STRIP)}else Y.isPoints?je.setMode(V.POINTS):Y.isSprite&&je.setMode(V.TRIANGLES);if(Y.isBatchedMesh)je.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else if(Y.isInstancedMesh)je.renderInstances(Xe,$t,Y.count);else if(W.isInstancedBufferGeometry){const Je=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,At=Math.min(W.instanceCount,Je);je.renderInstances(Xe,$t,At)}else je.render(Xe,$t)},this.compile=function(S,z,W=null){W===null&&(W=S),_=We.get(W),_.init(),x.push(_),W.traverseVisible(function(Y){Y.isLight&&Y.layers.test(z.layers)&&(_.pushLight(Y),Y.castShadow&&_.pushShadow(Y))}),S!==W&&S.traverseVisible(function(Y){Y.isLight&&Y.layers.test(z.layers)&&(_.pushLight(Y),Y.castShadow&&_.pushShadow(Y))}),_.setupLights(g._useLegacyLights);const $=new Set;return S.traverse(function(Y){const de=Y.material;if(de)if(Array.isArray(de))for(let ve=0;ve<de.length;ve++){const Me=de[ve];ws(Me,W,Y),$.add(Me)}else ws(de,W,Y),$.add(de)}),x.pop(),_=null,$},this.compileAsync=function(S,z,W=null){const $=this.compile(S,z,W);return new Promise(Y=>{function de(){$.forEach(function(ve){D.get(ve).currentProgram.isReady()&&$.delete(ve)}),$.size!==0?setTimeout(de,10):Y(S)}ne.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let ea=null;function Rs(){Ln.stop()}function Cs(){Ln.start()}const Ln=new Il;function Ps(S,z,W,$){if(S.visible===!1)return;if(S.layers.test(z.layers)){if(S.isGroup)W=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(z);else if(S.isLight)_.pushLight(S),S.castShadow&&_.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||me.intersectsSprite(S)){$&&N.setFromMatrixPosition(S.matrixWorld).applyMatrix4(F);const de=ie.update(S),ve=S.material;ve.visible&&v.push(S,de,ve,W,N.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||me.intersectsObject(S))){const de=ie.update(S),ve=S.material;if($&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),N.copy(S.boundingSphere.center)):(de.boundingSphere===null&&de.computeBoundingSphere(),N.copy(de.boundingSphere.center)),N.applyMatrix4(S.matrixWorld).applyMatrix4(F)),Array.isArray(ve)){const Me=de.groups;for(let we=0,Pe=Me.length;we<Pe;we++){const Le=Me[we],Ue=ve[Le.materialIndex];Ue&&Ue.visible&&v.push(S,de,Ue,W,N.z,Le)}}else ve.visible&&v.push(S,de,ve,W,N.z,null)}}const Y=S.children;for(let de=0,ve=Y.length;de<ve;de++)Ps(Y[de],z,W,$)}function Ls(S,z,W,$){const Y=S.opaque,de=S.transmissive,ve=S.transparent;_.setupLightsView(W),le===!0&&fe.setGlobalState(g.clippingPlanes,W),de.length>0&&function(Me,we,Pe,Le){if((Pe.isScene===!0?Pe.overrideMaterial:null)!==null)return;const Xe=Q.isWebGL2;M===null&&(M=new Kn(1,1,{generateMipmaps:!0,type:ne.has("EXT_color_buffer_half_float")?cn:vi,minFilter:wn,samples:Xe?4:0})),g.getDrawingBufferSize(O),Xe?M.setSize(O.x,O.y):M.setSize(Xr(O.x),Xr(O.y));const It=g.getRenderTarget();g.setRenderTarget(M),g.getClearColor(k),Z=g.getClearAlpha(),Z<1&&g.setClearColor(16777215,.5),g.clear();const $t=g.toneMapping;g.toneMapping=An,er(Me,Pe,Le),oe.updateMultisampleRenderTarget(M),oe.updateRenderTargetMipmap(M);let In=!1;for(let je=0,Je=we.length;je<Je;je++){const At=we[je],vt=At.object,De=At.geometry,Re=At.material,Di=At.group;if(Re.side===2&&vt.layers.test(Le.layers)){const ta=Re.side;Re.side=yt,Re.needsUpdate=!0,Is(vt,Pe,Le,De,Re,Di),Re.side=ta,Re.needsUpdate=!0,In=!0}}In===!0&&(oe.updateMultisampleRenderTarget(M),oe.updateRenderTargetMipmap(M)),g.setRenderTarget(It),g.setClearColor(k,Z),g.toneMapping=$t}(Y,de,z,W),$&&E.viewport(B.copy($)),Y.length>0&&er(Y,z,W),de.length>0&&er(de,z,W),ve.length>0&&er(ve,z,W),E.buffers.depth.setTest(!0),E.buffers.depth.setMask(!0),E.buffers.color.setMask(!0),E.setPolygonOffset(!1)}function er(S,z,W){const $=z.isScene===!0?z.overrideMaterial:null;for(let Y=0,de=S.length;Y<de;Y++){const ve=S[Y],Me=ve.object,we=ve.geometry,Pe=$===null?ve.material:$,Le=ve.group;Me.layers.test(W.layers)&&Is(Me,z,W,we,Pe,Le)}}function Is(S,z,W,$,Y,de){S.onBeforeRender(g,z,W,$,Y,de),S.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),Y.onBeforeRender(g,z,W,$,S,de),Y.transparent===!0&&Y.side===2&&Y.forceSinglePass===!1?(Y.side=yt,Y.needsUpdate=!0,g.renderBufferDirect(W,z,$,Y,S,de),Y.side=dn,Y.needsUpdate=!0,g.renderBufferDirect(W,z,$,Y,S,de),Y.side=2):g.renderBufferDirect(W,z,$,Y,S,de),S.onAfterRender(g,z,W,$,Y,de)}function tr(S,z,W){z.isScene!==!0&&(z=H);const $=D.get(S),Y=_.state.lights,de=_.state.shadowsArray,ve=Y.state.version,Me=ce.getParameters(S,Y.state,de,z,W),we=ce.getProgramCacheKey(Me);let Pe=$.programs;$.environment=S.isMeshStandardMaterial?z.environment:null,$.fog=z.fog,$.envMap=(S.isMeshStandardMaterial?R:ee).get(S.envMap||$.environment),$.envMapRotation=$.environment!==null&&S.envMap===null?z.environmentRotation:S.envMapRotation,Pe===void 0&&(S.addEventListener("dispose",As),Pe=new Map,$.programs=Pe);let Le=Pe.get(we);if(Le!==void 0){if($.currentProgram===Le&&$.lightsStateVersion===ve)return Us(S,Me),Le}else Me.uniforms=ce.getUniforms(S),S.onBuild(W,Me,g),S.onBeforeCompile(Me,g),Le=ce.acquireProgram(Me,we),Pe.set(we,Le),$.uniforms=Me.uniforms;const Ue=$.uniforms;return(S.isShaderMaterial||S.isRawShaderMaterial)&&S.clipping!==!0||(Ue.clippingPlanes=fe.uniform),Us(S,Me),$.needsLights=function(Xe){return Xe.isMeshLambertMaterial||Xe.isMeshToonMaterial||Xe.isMeshPhongMaterial||Xe.isMeshStandardMaterial||Xe.isShadowMaterial||Xe.isShaderMaterial&&Xe.lights===!0}(S),$.lightsStateVersion=ve,$.needsLights&&(Ue.ambientLightColor.value=Y.state.ambient,Ue.lightProbe.value=Y.state.probe,Ue.directionalLights.value=Y.state.directional,Ue.directionalLightShadows.value=Y.state.directionalShadow,Ue.spotLights.value=Y.state.spot,Ue.spotLightShadows.value=Y.state.spotShadow,Ue.rectAreaLights.value=Y.state.rectArea,Ue.ltc_1.value=Y.state.rectAreaLTC1,Ue.ltc_2.value=Y.state.rectAreaLTC2,Ue.pointLights.value=Y.state.point,Ue.pointLightShadows.value=Y.state.pointShadow,Ue.hemisphereLights.value=Y.state.hemi,Ue.directionalShadowMap.value=Y.state.directionalShadowMap,Ue.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,Ue.spotShadowMap.value=Y.state.spotShadowMap,Ue.spotLightMatrix.value=Y.state.spotLightMatrix,Ue.spotLightMap.value=Y.state.spotLightMap,Ue.pointShadowMap.value=Y.state.pointShadowMap,Ue.pointShadowMatrix.value=Y.state.pointShadowMatrix),$.currentProgram=Le,$.uniformsList=null,Le}function Ns(S){if(S.uniformsList===null){const z=S.currentProgram.getUniforms();S.uniformsList=Fr.seqWithValue(z.seq,S.uniforms)}return S.uniformsList}function Us(S,z){const W=D.get(S);W.outputColorSpace=z.outputColorSpace,W.batching=z.batching,W.instancing=z.instancing,W.instancingColor=z.instancingColor,W.instancingMorph=z.instancingMorph,W.skinning=z.skinning,W.morphTargets=z.morphTargets,W.morphNormals=z.morphNormals,W.morphColors=z.morphColors,W.morphTargetsCount=z.morphTargetsCount,W.numClippingPlanes=z.numClippingPlanes,W.numIntersection=z.numClipIntersection,W.vertexAlphas=z.vertexAlphas,W.vertexTangents=z.vertexTangents,W.toneMapping=z.toneMapping}Ln.setAnimationLoop(function(S){ea&&ea(S)}),typeof self<"u"&&Ln.setContext(self),this.setAnimationLoop=function(S){ea=S,ot.setAnimationLoop(S),S===null?Ln.stop():Ln.start()},ot.addEventListener("sessionstart",Rs),ot.addEventListener("sessionend",Cs),this.render=function(S,z){if(z!==void 0&&z.isCamera!==!0||y===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),ot.enabled===!0&&ot.isPresenting===!0&&(ot.cameraAutoUpdate===!0&&ot.updateCamera(z),z=ot.getCamera()),S.isScene===!0&&S.onBeforeRender(g,S,z,T),_=We.get(S,x.length),_.init(),x.push(_),F.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),me.setFromProjectionMatrix(F),b=this.localClippingEnabled,le=fe.init(this.clippingPlanes,b),v=Se.get(S,f.length),v.init(),f.push(v),Ps(S,z,0,g.sortObjects),v.finish(),g.sortObjects===!0&&v.sort(j,q),this.info.render.frame++,le===!0&&fe.beginShadows();const W=_.state.shadowsArray;if(ye.render(W,S,z),le===!0&&fe.endShadows(),this.info.autoReset===!0&&this.info.reset(),ot.enabled!==!1&&ot.isPresenting!==!1&&ot.hasDepthSensing()!==!1||Fe.render(v,S),_.setupLights(g._useLegacyLights),z.isArrayCamera){const $=z.cameras;for(let Y=0,de=$.length;Y<de;Y++){const ve=$[Y];Ls(v,S,ve,ve.viewport)}}else Ls(v,S,z);T!==null&&(oe.updateMultisampleRenderTarget(T),oe.updateRenderTargetMipmap(T)),S.isScene===!0&&S.onAfterRender(g,S,z),bt.resetDefaultState(),U=-1,L=null,x.pop(),_=x.length>0?x[x.length-1]:null,f.pop(),v=f.length>0?f[f.length-1]:null},this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return T},this.setRenderTargetTextures=function(S,z,W){D.get(S.texture).__webglTexture=z,D.get(S.depthTexture).__webglTexture=W;const $=D.get(S);$.__hasExternalTextures=!0,$.__autoAllocateDepthBuffer=W===void 0,$.__autoAllocateDepthBuffer||ne.has("WEBGL_multisampled_render_to_texture")===!0&&($.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(S,z){const W=D.get(S);W.__webglFramebuffer=z,W.__useDefaultFramebuffer=z===void 0},this.setRenderTarget=function(S,z=0,W=0){T=S,C=z,w=W;let $=!0,Y=null,de=!1,ve=!1;if(S){const Me=D.get(S);Me.__useDefaultFramebuffer!==void 0?(E.bindFramebuffer(V.FRAMEBUFFER,null),$=!1):Me.__webglFramebuffer===void 0?oe.setupRenderTarget(S):Me.__hasExternalTextures&&oe.rebindTextures(S,D.get(S.texture).__webglTexture,D.get(S.depthTexture).__webglTexture);const we=S.texture;(we.isData3DTexture||we.isDataArrayTexture||we.isCompressedArrayTexture)&&(ve=!0);const Pe=D.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Y=Array.isArray(Pe[z])?Pe[z][W]:Pe[z],de=!0):Y=Q.isWebGL2&&S.samples>0&&oe.useMultisampledRTT(S)===!1?D.get(S).__webglMultisampledFramebuffer:Array.isArray(Pe)?Pe[W]:Pe,B.copy(S.viewport),re.copy(S.scissor),A=S.scissorTest}else B.copy(ue).multiplyScalar(K).floor(),re.copy(X).multiplyScalar(K).floor(),A=J;if(E.bindFramebuffer(V.FRAMEBUFFER,Y)&&Q.drawBuffers&&$&&E.drawBuffers(S,Y),E.viewport(B),E.scissor(re),E.setScissorTest(A),de){const Me=D.get(S.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_CUBE_MAP_POSITIVE_X+z,Me.__webglTexture,W)}else if(ve){const Me=D.get(S.texture),we=z||0;V.framebufferTextureLayer(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,Me.__webglTexture,W||0,we)}U=-1},this.readRenderTargetPixels=function(S,z,W,$,Y,de,ve){if(!S||!S.isWebGLRenderTarget)return;let Me=D.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ve!==void 0&&(Me=Me[ve]),Me){E.bindFramebuffer(V.FRAMEBUFFER,Me);try{const we=S.texture,Pe=we.format,Le=we.type;if(Pe!==qt&&rt.convert(Pe)!==V.getParameter(V.IMPLEMENTATION_COLOR_READ_FORMAT))return;const Ue=Le===cn&&(ne.has("EXT_color_buffer_half_float")||Q.isWebGL2&&ne.has("EXT_color_buffer_float"));if(!(Le===vi||rt.convert(Le)===V.getParameter(V.IMPLEMENTATION_COLOR_READ_TYPE)||Le===Tt&&(Q.isWebGL2||ne.has("OES_texture_float")||ne.has("WEBGL_color_buffer_float"))||Ue))return;z>=0&&z<=S.width-$&&W>=0&&W<=S.height-Y&&V.readPixels(z,W,$,Y,rt.convert(Pe),rt.convert(Le),de)}finally{const we=T!==null?D.get(T).__webglFramebuffer:null;E.bindFramebuffer(V.FRAMEBUFFER,we)}}},this.copyFramebufferToTexture=function(S,z,W=0){const $=Math.pow(2,-W),Y=Math.floor(z.image.width*$),de=Math.floor(z.image.height*$);oe.setTexture2D(z,0),V.copyTexSubImage2D(V.TEXTURE_2D,W,0,0,S.x,S.y,Y,de),E.unbindTexture()},this.copyTextureToTexture=function(S,z,W,$=0){const Y=z.image.width,de=z.image.height,ve=rt.convert(W.format),Me=rt.convert(W.type);oe.setTexture2D(W,0),V.pixelStorei(V.UNPACK_FLIP_Y_WEBGL,W.flipY),V.pixelStorei(V.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),V.pixelStorei(V.UNPACK_ALIGNMENT,W.unpackAlignment),z.isDataTexture?V.texSubImage2D(V.TEXTURE_2D,$,S.x,S.y,Y,de,ve,Me,z.image.data):z.isCompressedTexture?V.compressedTexSubImage2D(V.TEXTURE_2D,$,S.x,S.y,z.mipmaps[0].width,z.mipmaps[0].height,ve,z.mipmaps[0].data):V.texSubImage2D(V.TEXTURE_2D,$,S.x,S.y,ve,Me,z.image),$===0&&W.generateMipmaps&&V.generateMipmap(V.TEXTURE_2D),E.unbindTexture()},this.copyTextureToTexture3D=function(S,z,W,$,Y=0){if(g.isWebGL1Renderer)return;const de=Math.round(S.max.x-S.min.x),ve=Math.round(S.max.y-S.min.y),Me=S.max.z-S.min.z+1,we=rt.convert($.format),Pe=rt.convert($.type);let Le;if($.isData3DTexture)oe.setTexture3D($,0),Le=V.TEXTURE_3D;else{if(!$.isDataArrayTexture&&!$.isCompressedArrayTexture)return;oe.setTexture2DArray($,0),Le=V.TEXTURE_2D_ARRAY}V.pixelStorei(V.UNPACK_FLIP_Y_WEBGL,$.flipY),V.pixelStorei(V.UNPACK_PREMULTIPLY_ALPHA_WEBGL,$.premultiplyAlpha),V.pixelStorei(V.UNPACK_ALIGNMENT,$.unpackAlignment);const Ue=V.getParameter(V.UNPACK_ROW_LENGTH),Xe=V.getParameter(V.UNPACK_IMAGE_HEIGHT),It=V.getParameter(V.UNPACK_SKIP_PIXELS),$t=V.getParameter(V.UNPACK_SKIP_ROWS),In=V.getParameter(V.UNPACK_SKIP_IMAGES),je=W.isCompressedTexture?W.mipmaps[Y]:W.image;V.pixelStorei(V.UNPACK_ROW_LENGTH,je.width),V.pixelStorei(V.UNPACK_IMAGE_HEIGHT,je.height),V.pixelStorei(V.UNPACK_SKIP_PIXELS,S.min.x),V.pixelStorei(V.UNPACK_SKIP_ROWS,S.min.y),V.pixelStorei(V.UNPACK_SKIP_IMAGES,S.min.z),W.isDataTexture||W.isData3DTexture?V.texSubImage3D(Le,Y,z.x,z.y,z.z,de,ve,Me,we,Pe,je.data):$.isCompressedArrayTexture?V.compressedTexSubImage3D(Le,Y,z.x,z.y,z.z,de,ve,Me,we,je.data):V.texSubImage3D(Le,Y,z.x,z.y,z.z,de,ve,Me,we,Pe,je),V.pixelStorei(V.UNPACK_ROW_LENGTH,Ue),V.pixelStorei(V.UNPACK_IMAGE_HEIGHT,Xe),V.pixelStorei(V.UNPACK_SKIP_PIXELS,It),V.pixelStorei(V.UNPACK_SKIP_ROWS,$t),V.pixelStorei(V.UNPACK_SKIP_IMAGES,In),Y===0&&$.generateMipmaps&&V.generateMipmap(Le),E.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?oe.setTextureCube(S,0):S.isData3DTexture?oe.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?oe.setTexture2DArray(S,0):oe.setTexture2D(S,0),E.unbindTexture()},this.resetState=function(){C=0,w=0,T=null,E.reset(),bt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ai}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===hs?"display-p3":"srgb",t.unpackColorSpace=He.workingColorSpace===Yr?"display-p3":"srgb"}get useLegacyLights(){return this._useLegacyLights}set useLegacyLights(e){this._useLegacyLights=e}}(class extends zl{}).prototype.isWebGL1Renderer=!0;class Au extends ke{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Zt,this.environmentRotation=new Zt,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class wu{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=Za,this._updateRange={offset:0,count:-1},this.updateRanges=[],this.version=0,this.uuid=kt()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}get updateRange(){return Sl("THREE.InterleavedBuffer: updateRange() is deprecated and will be removed in r169. Use addUpdateRange() instead."),this._updateRange}setUsage(e){return this.usage=e,this}addUpdateRange(e,t){this.updateRanges.push({start:e,count:t})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,n){e*=this.stride,n*=t.stride;for(let i=0,a=this.stride;i<a;i++)this.array[e+i]=t.array[n+i];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=kt()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),n=new this.constructor(t,this.stride);return n.setUsage(this.usage),n}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=kt()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const dt=new P;class ms{constructor(e,t,n,i=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=n,this.normalized=i}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,n=this.data.count;t<n;t++)dt.fromBufferAttribute(this,t),dt.applyMatrix4(e),this.setXYZ(t,dt.x,dt.y,dt.z);return this}applyNormalMatrix(e){for(let t=0,n=this.count;t<n;t++)dt.fromBufferAttribute(this,t),dt.applyNormalMatrix(e),this.setXYZ(t,dt.x,dt.y,dt.z);return this}transformDirection(e){for(let t=0,n=this.count;t<n;t++)dt.fromBufferAttribute(this,t),dt.transformDirection(e),this.setXYZ(t,dt.x,dt.y,dt.z);return this}getComponent(e,t){let n=this.array[e*this.data.stride+this.offset+t];return this.normalized&&(n=Ht(n,this.array)),n}setComponent(e,t,n){return this.normalized&&(n=ze(n,this.array)),this.data.array[e*this.data.stride+this.offset+t]=n,this}setX(e,t){return this.normalized&&(t=ze(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=ze(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=ze(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=ze(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=Ht(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=Ht(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=Ht(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=Ht(t,this.array)),t}setXY(e,t,n){return e=e*this.data.stride+this.offset,this.normalized&&(t=ze(t,this.array),n=ze(n,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=n,this}setXYZ(e,t,n,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=ze(t,this.array),n=ze(n,this.array),i=ze(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=n,this.data.array[e+2]=i,this}setXYZW(e,t,n,i,a){return e=e*this.data.stride+this.offset,this.normalized&&(t=ze(t,this.array),n=ze(n,this.array),i=ze(i,this.array),a=ze(a,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=n,this.data.array[e+2]=i,this.data.array[e+3]=a,this}clone(e){if(e===void 0){const t=[];for(let n=0;n<this.count;n++){const i=n*this.data.stride+this.offset;for(let a=0;a<this.itemSize;a++)t.push(this.data.array[i+a])}return new _t(new this.array.constructor(t),this.itemSize,this.normalized)}return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new ms(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){const t=[];for(let n=0;n<this.count;n++){const i=n*this.data.stride+this.offset;for(let a=0;a<this.itemSize;a++)t.push(this.data.array[i+a])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}const Uo=new P,Do=new Ve,Oo=new Ve,Ru=new P,Fo=new Te,Ar=new P,Oa=new Jt,Bo=new Te,Fa=new Ii;class Cu extends gt{constructor(e,t){super(e,t),this.isSkinnedMesh=!0,this.type="SkinnedMesh",this.bindMode=Ws,this.bindMatrix=new Te,this.bindMatrixInverse=new Te,this.boundingBox=null,this.boundingSphere=null}computeBoundingBox(){const e=this.geometry;this.boundingBox===null&&(this.boundingBox=new pn),this.boundingBox.makeEmpty();const t=e.getAttribute("position");for(let n=0;n<t.count;n++)this.getVertexPosition(n,Ar),this.boundingBox.expandByPoint(Ar)}computeBoundingSphere(){const e=this.geometry;this.boundingSphere===null&&(this.boundingSphere=new Jt),this.boundingSphere.makeEmpty();const t=e.getAttribute("position");for(let n=0;n<t.count;n++)this.getVertexPosition(n,Ar),this.boundingSphere.expandByPoint(Ar)}copy(e,t){return super.copy(e,t),this.bindMode=e.bindMode,this.bindMatrix.copy(e.bindMatrix),this.bindMatrixInverse.copy(e.bindMatrixInverse),this.skeleton=e.skeleton,e.boundingBox!==null&&(this.boundingBox=e.boundingBox.clone()),e.boundingSphere!==null&&(this.boundingSphere=e.boundingSphere.clone()),this}raycast(e,t){const n=this.material,i=this.matrixWorld;n!==void 0&&(this.boundingSphere===null&&this.computeBoundingSphere(),Oa.copy(this.boundingSphere),Oa.applyMatrix4(i),e.ray.intersectsSphere(Oa)!==!1&&(Bo.copy(i).invert(),Fa.copy(e.ray).applyMatrix4(Bo),this.boundingBox!==null&&Fa.intersectsBox(this.boundingBox)===!1||this._computeIntersections(e,t,Fa)))}getVertexPosition(e,t){return super.getVertexPosition(e,t),this.applyBoneTransform(e,t),t}bind(e,t){this.skeleton=e,t===void 0&&(this.updateMatrixWorld(!0),this.skeleton.calculateInverses(),t=this.matrixWorld),this.bindMatrix.copy(t),this.bindMatrixInverse.copy(t).invert()}pose(){this.skeleton.pose()}normalizeSkinWeights(){const e=new Ve,t=this.geometry.attributes.skinWeight;for(let n=0,i=t.count;n<i;n++){e.fromBufferAttribute(t,n);const a=1/e.manhattanLength();a!==1/0?e.multiplyScalar(a):e.set(1,0,0,0),t.setXYZW(n,e.x,e.y,e.z,e.w)}}updateMatrixWorld(e){super.updateMatrixWorld(e),this.bindMode===Ws?this.bindMatrixInverse.copy(this.matrixWorld).invert():this.bindMode==="detached"&&this.bindMatrixInverse.copy(this.bindMatrix).invert()}applyBoneTransform(e,t){const n=this.skeleton,i=this.geometry;Do.fromBufferAttribute(i.attributes.skinIndex,e),Oo.fromBufferAttribute(i.attributes.skinWeight,e),Uo.copy(t).applyMatrix4(this.bindMatrix),t.set(0,0,0);for(let a=0;a<4;a++){const s=Oo.getComponent(a);if(s!==0){const o=Do.getComponent(a);Fo.multiplyMatrices(n.bones[o].matrixWorld,n.boneInverses[o]),t.addScaledVector(Ru.copy(Uo).applyMatrix4(Fo),s)}}return t.applyMatrix4(this.bindMatrixInverse)}}class Hl extends ke{constructor(){super(),this.isBone=!0,this.type="Bone"}}class gs extends it{constructor(e=null,t=1,n=1,i,a,s,o,c,l=1003,h=1003,u,d){super(null,s,o,c,l,h,i,a,u,d),this.isDataTexture=!0,this.image={data:e,width:t,height:n},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}}const zo=new Te,Pu=new Te;class _s{constructor(e=[],t=[]){this.uuid=kt(),this.bones=e.slice(0),this.boneInverses=t,this.boneMatrices=null,this.boneTexture=null,this.init()}init(){const e=this.bones,t=this.boneInverses;if(this.boneMatrices=new Float32Array(16*e.length),t.length===0)this.calculateInverses();else if(e.length!==t.length){this.boneInverses=[];for(let n=0,i=this.bones.length;n<i;n++)this.boneInverses.push(new Te)}}calculateInverses(){this.boneInverses.length=0;for(let e=0,t=this.bones.length;e<t;e++){const n=new Te;this.bones[e]&&n.copy(this.bones[e].matrixWorld).invert(),this.boneInverses.push(n)}}pose(){for(let e=0,t=this.bones.length;e<t;e++){const n=this.bones[e];n&&n.matrixWorld.copy(this.boneInverses[e]).invert()}for(let e=0,t=this.bones.length;e<t;e++){const n=this.bones[e];n&&(n.parent&&n.parent.isBone?(n.matrix.copy(n.parent.matrixWorld).invert(),n.matrix.multiply(n.matrixWorld)):n.matrix.copy(n.matrixWorld),n.matrix.decompose(n.position,n.quaternion,n.scale))}}update(){const e=this.bones,t=this.boneInverses,n=this.boneMatrices,i=this.boneTexture;for(let a=0,s=e.length;a<s;a++){const o=e[a]?e[a].matrixWorld:Pu;zo.multiplyMatrices(o,t[a]),zo.toArray(n,16*a)}i!==null&&(i.needsUpdate=!0)}clone(){return new _s(this.bones,this.boneInverses)}computeBoneTexture(){let e=Math.sqrt(4*this.bones.length);e=4*Math.ceil(e/4),e=Math.max(e,4);const t=new Float32Array(e*e*4);t.set(this.boneMatrices);const n=new gs(t,e,e,qt,Tt);return n.needsUpdate=!0,this.boneMatrices=t,this.boneTexture=n,this}getBoneByName(e){for(let t=0,n=this.bones.length;t<n;t++){const i=this.bones[t];if(i.name===e)return i}}dispose(){this.boneTexture!==null&&(this.boneTexture.dispose(),this.boneTexture=null)}fromJSON(e,t){this.uuid=e.uuid;for(let n=0,i=e.bones.length;n<i;n++){let a=t[e.bones[n]];a===void 0&&(a=new Hl),this.bones.push(a),this.boneInverses.push(new Te().fromArray(e.boneInverses[n]))}return this.init(),this}toJSON(){const e={metadata:{version:4.6,type:"Skeleton",generator:"Skeleton.toJSON"},bones:[],boneInverses:[]};e.uuid=this.uuid;const t=this.bones,n=this.boneInverses;for(let i=0,a=t.length;i<a;i++){const s=t[i];e.bones.push(s.uuid);const o=n[i];e.boneInverses.push(o.toArray())}return e}}class ts extends _t{constructor(e,t,n,i=1){super(e,t,n),this.isInstancedBufferAttribute=!0,this.meshPerAttribute=i}copy(e){return super.copy(e),this.meshPerAttribute=e.meshPerAttribute,this}toJSON(){const e=super.toJSON();return e.meshPerAttribute=this.meshPerAttribute,e.isInstancedBufferAttribute=!0,e}}const pi=new Te,Ho=new Te,wr=[],Vo=new pn,Lu=new Te,Vi=new gt,ki=new Jt;class Iu extends gt{constructor(e,t,n){super(e,t),this.isInstancedMesh=!0,this.instanceMatrix=new ts(new Float32Array(16*n),16),this.instanceColor=null,this.morphTexture=null,this.count=n,this.boundingBox=null,this.boundingSphere=null;for(let i=0;i<n;i++)this.setMatrixAt(i,Lu)}computeBoundingBox(){const e=this.geometry,t=this.count;this.boundingBox===null&&(this.boundingBox=new pn),e.boundingBox===null&&e.computeBoundingBox(),this.boundingBox.makeEmpty();for(let n=0;n<t;n++)this.getMatrixAt(n,pi),Vo.copy(e.boundingBox).applyMatrix4(pi),this.boundingBox.union(Vo)}computeBoundingSphere(){const e=this.geometry,t=this.count;this.boundingSphere===null&&(this.boundingSphere=new Jt),e.boundingSphere===null&&e.computeBoundingSphere(),this.boundingSphere.makeEmpty();for(let n=0;n<t;n++)this.getMatrixAt(n,pi),ki.copy(e.boundingSphere).applyMatrix4(pi),this.boundingSphere.union(ki)}copy(e,t){return super.copy(e,t),this.instanceMatrix.copy(e.instanceMatrix),e.instanceColor!==null&&(this.instanceColor=e.instanceColor.clone()),this.count=e.count,e.boundingBox!==null&&(this.boundingBox=e.boundingBox.clone()),e.boundingSphere!==null&&(this.boundingSphere=e.boundingSphere.clone()),this}getColorAt(e,t){t.fromArray(this.instanceColor.array,3*e)}getMatrixAt(e,t){t.fromArray(this.instanceMatrix.array,16*e)}getMorphAt(e,t){const n=t.morphTargetInfluences,i=this.morphTexture.source.data.data,a=e*(n.length+1)+1;for(let s=0;s<n.length;s++)n[s]=i[a+s]}raycast(e,t){const n=this.matrixWorld,i=this.count;if(Vi.geometry=this.geometry,Vi.material=this.material,Vi.material!==void 0&&(this.boundingSphere===null&&this.computeBoundingSphere(),ki.copy(this.boundingSphere),ki.applyMatrix4(n),e.ray.intersectsSphere(ki)!==!1))for(let a=0;a<i;a++){this.getMatrixAt(a,pi),Ho.multiplyMatrices(n,pi),Vi.matrixWorld=Ho,Vi.raycast(e,wr);for(let s=0,o=wr.length;s<o;s++){const c=wr[s];c.instanceId=a,c.object=this,t.push(c)}wr.length=0}}setColorAt(e,t){this.instanceColor===null&&(this.instanceColor=new ts(new Float32Array(3*this.instanceMatrix.count),3)),t.toArray(this.instanceColor.array,3*e)}setMatrixAt(e,t){t.toArray(this.instanceMatrix.array,16*e)}setMorphAt(e,t){const n=t.morphTargetInfluences,i=n.length+1;this.morphTexture===null&&(this.morphTexture=new gs(new Float32Array(i*this.count),i,this.count,1028,Tt));const a=this.morphTexture.source.data.data;let s=0;for(let l=0;l<n.length;l++)s+=n[l];const o=this.geometry.morphTargetsRelative?1:1-s,c=i*e;a[c]=o,a.set(n,c+1)}updateMorphTargets(){}dispose(){this.dispatchEvent({type:"dispose"})}}class vs extends Yt{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Ee(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const ko=new P,Go=new P,Wo=new Te,Ba=new Ii,Rr=new Jt;class Jr extends ke{constructor(e=new Mt,t=new vs){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,n=[0];for(let i=1,a=t.count;i<a;i++)ko.fromBufferAttribute(t,i-1),Go.fromBufferAttribute(t,i),n[i]=n[i-1],n[i]+=ko.distanceTo(Go);e.setAttribute("lineDistance",new at(n,1))}return this}raycast(e,t){const n=this.geometry,i=this.matrixWorld,a=e.params.Line.threshold,s=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Rr.copy(n.boundingSphere),Rr.applyMatrix4(i),Rr.radius+=a,e.ray.intersectsSphere(Rr)===!1)return;Wo.copy(i).invert(),Ba.copy(e.ray).applyMatrix4(Wo);const o=a/((this.scale.x+this.scale.y+this.scale.z)/3),c=o*o,l=new P,h=new P,u=new P,d=new P,p=this.isLineSegments?2:1,m=n.index,v=n.attributes.position;if(m!==null)for(let _=Math.max(0,s.start),f=Math.min(m.count,s.start+s.count)-1;_<f;_+=p){const x=m.getX(_),g=m.getX(_+1);if(l.fromBufferAttribute(v,x),h.fromBufferAttribute(v,g),Ba.distanceSqToSegment(l,h,d,u)>c)continue;d.applyMatrix4(this.matrixWorld);const y=e.ray.origin.distanceTo(d);y<e.near||y>e.far||t.push({distance:y,point:u.clone().applyMatrix4(this.matrixWorld),index:_,face:null,faceIndex:null,object:this})}else for(let _=Math.max(0,s.start),f=Math.min(v.count,s.start+s.count)-1;_<f;_+=p){if(l.fromBufferAttribute(v,_),h.fromBufferAttribute(v,_+1),Ba.distanceSqToSegment(l,h,d,u)>c)continue;d.applyMatrix4(this.matrixWorld);const x=e.ray.origin.distanceTo(d);x<e.near||x>e.far||t.push({distance:x,point:u.clone().applyMatrix4(this.matrixWorld),index:_,face:null,faceIndex:null,object:this})}}updateMorphTargets(){const e=this.geometry.morphAttributes,t=Object.keys(e);if(t.length>0){const n=e[t[0]];if(n!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let i=0,a=n.length;i<a;i++){const s=n[i].name||String(i);this.morphTargetInfluences.push(0),this.morphTargetDictionary[s]=i}}}}}const Xo=new P,jo=new P;class Vl extends Jr{constructor(e,t){super(e,t),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,n=[];for(let i=0,a=t.count;i<a;i+=2)Xo.fromBufferAttribute(t,i),jo.fromBufferAttribute(t,i+1),n[i]=i===0?0:n[i-1],n[i+1]=n[i]+Xo.distanceTo(jo);e.setAttribute("lineDistance",new at(n,1))}return this}}class Nu extends Jr{constructor(e,t){super(e,t),this.isLineLoop=!0,this.type="LineLoop"}}class kl extends Yt{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ee(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const qo=new Te,ns=new Ii,Cr=new Jt,Pr=new P;class Uu extends ke{constructor(e=new Mt,t=new kl){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,t){const n=this.geometry,i=this.matrixWorld,a=e.params.Points.threshold,s=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Cr.copy(n.boundingSphere),Cr.applyMatrix4(i),Cr.radius+=a,e.ray.intersectsSphere(Cr)===!1)return;qo.copy(i).invert(),ns.copy(e.ray).applyMatrix4(qo);const o=a/((this.scale.x+this.scale.y+this.scale.z)/3),c=o*o,l=n.index,h=n.attributes.position;if(l!==null)for(let u=Math.max(0,s.start),d=Math.min(l.count,s.start+s.count);u<d;u++){const p=l.getX(u);Pr.fromBufferAttribute(h,p),Yo(Pr,p,c,i,e,t,this)}else for(let u=Math.max(0,s.start),d=Math.min(h.count,s.start+s.count);u<d;u++)Pr.fromBufferAttribute(h,u),Yo(Pr,u,c,i,e,t,this)}updateMorphTargets(){const e=this.geometry.morphAttributes,t=Object.keys(e);if(t.length>0){const n=e[t[0]];if(n!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let i=0,a=n.length;i<a;i++){const s=n[i].name||String(i);this.morphTargetInfluences.push(0),this.morphTargetDictionary[s]=i}}}}}function Yo(r,e,t,n,i,a,s){const o=ns.distanceSqToPoint(r);if(o<t){const c=new P;ns.closestPointToPoint(r,c),c.applyMatrix4(n);const l=i.ray.origin.distanceTo(c);if(l<i.near||l>i.far)return;a.push({distance:l,distanceToRay:Math.sqrt(o),point:c,index:e,face:null,object:s})}}class xs extends Mt{constructor(e=1,t=32,n=0,i=2*Math.PI){super(),this.type="CircleGeometry",this.parameters={radius:e,segments:t,thetaStart:n,thetaLength:i},t=Math.max(3,t);const a=[],s=[],o=[],c=[],l=new P,h=new _e;s.push(0,0,0),o.push(0,0,1),c.push(.5,.5);for(let u=0,d=3;u<=t;u++,d+=3){const p=n+u/t*i;l.x=e*Math.cos(p),l.y=e*Math.sin(p),s.push(l.x,l.y,l.z),o.push(0,0,1),h.x=(s[d]/e+1)/2,h.y=(s[d+1]/e+1)/2,c.push(h.x,h.y)}for(let u=1;u<=t;u++)a.push(u,u+1,0);this.setIndex(a),this.setAttribute("position",new at(s,3)),this.setAttribute("normal",new at(o,3)),this.setAttribute("uv",new at(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new xs(e.radius,e.segments,e.thetaStart,e.thetaLength)}}class ys extends Mt{constructor(e=1,t=32,n=16,i=0,a=2*Math.PI,s=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:n,phiStart:i,phiLength:a,thetaStart:s,thetaLength:o},t=Math.max(3,Math.floor(t)),n=Math.max(2,Math.floor(n));const c=Math.min(s+o,Math.PI);let l=0;const h=[],u=new P,d=new P,p=[],m=[],v=[],_=[];for(let f=0;f<=n;f++){const x=[],g=f/n;let y=0;f===0&&s===0?y=.5/t:f===n&&c===Math.PI&&(y=-.5/t);for(let C=0;C<=t;C++){const w=C/t;u.x=-e*Math.cos(i+w*a)*Math.sin(s+g*o),u.y=e*Math.cos(s+g*o),u.z=e*Math.sin(i+w*a)*Math.sin(s+g*o),m.push(u.x,u.y,u.z),d.copy(u).normalize(),v.push(d.x,d.y,d.z),_.push(w+y,1-g),x.push(l++)}h.push(x)}for(let f=0;f<n;f++)for(let x=0;x<t;x++){const g=h[f][x+1],y=h[f][x],C=h[f+1][x],w=h[f+1][x+1];(f!==0||s>0)&&p.push(g,y,w),(f!==n-1||c<Math.PI)&&p.push(y,C,w)}this.setIndex(p),this.setAttribute("position",new at(m,3)),this.setAttribute("normal",new at(v,3)),this.setAttribute("uv",new at(_,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ys(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class is extends Yt{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ee(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ee(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=0,this.normalScale=new _e(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Zt,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class fn extends is{constructor(e){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new _e(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return nt(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(t){this.ior=(1+.4*t)/(1-.4*t)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new Ee(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new Ee(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new Ee(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(e)}get anisotropy(){return this._anisotropy}set anisotropy(e){this._anisotropy>0!=e>0&&this.version++,this._anisotropy=e}get clearcoat(){return this._clearcoat}set clearcoat(e){this._clearcoat>0!=e>0&&this.version++,this._clearcoat=e}get iridescence(){return this._iridescence}set iridescence(e){this._iridescence>0!=e>0&&this.version++,this._iridescence=e}get sheen(){return this._sheen}set sheen(e){this._sheen>0!=e>0&&this.version++,this._sheen=e}get transmission(){return this._transmission}set transmission(e){this._transmission>0!=e>0&&this.version++,this._transmission=e}copy(e){return super.copy(e),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=e.anisotropy,this.anisotropyRotation=e.anisotropyRotation,this.anisotropyMap=e.anisotropyMap,this.clearcoat=e.clearcoat,this.clearcoatMap=e.clearcoatMap,this.clearcoatRoughness=e.clearcoatRoughness,this.clearcoatRoughnessMap=e.clearcoatRoughnessMap,this.clearcoatNormalMap=e.clearcoatNormalMap,this.clearcoatNormalScale.copy(e.clearcoatNormalScale),this.ior=e.ior,this.iridescence=e.iridescence,this.iridescenceMap=e.iridescenceMap,this.iridescenceIOR=e.iridescenceIOR,this.iridescenceThicknessRange=[...e.iridescenceThicknessRange],this.iridescenceThicknessMap=e.iridescenceThicknessMap,this.sheen=e.sheen,this.sheenColor.copy(e.sheenColor),this.sheenColorMap=e.sheenColorMap,this.sheenRoughness=e.sheenRoughness,this.sheenRoughnessMap=e.sheenRoughnessMap,this.transmission=e.transmission,this.transmissionMap=e.transmissionMap,this.thickness=e.thickness,this.thicknessMap=e.thicknessMap,this.attenuationDistance=e.attenuationDistance,this.attenuationColor.copy(e.attenuationColor),this.specularIntensity=e.specularIntensity,this.specularIntensityMap=e.specularIntensityMap,this.specularColor.copy(e.specularColor),this.specularColorMap=e.specularColorMap,this}}function Lr(r,e,t){return!r||!t&&r.constructor===e?r:typeof e.BYTES_PER_ELEMENT=="number"?new e(r):Array.prototype.slice.call(r)}function Du(r){const e=r.length,t=new Array(e);for(let n=0;n!==e;++n)t[n]=n;return t.sort(function(n,i){return r[n]-r[i]}),t}function Ko(r,e,t){const n=r.length,i=new r.constructor(n);for(let a=0,s=0;s!==n;++a){const o=t[a]*e;for(let c=0;c!==e;++c)i[s++]=r[o+c]}return i}function Gl(r,e,t,n){let i=1,a=r[0];for(;a!==void 0&&a[n]===void 0;)a=r[i++];if(a===void 0)return;let s=a[n];if(s!==void 0)if(Array.isArray(s))do s=a[n],s!==void 0&&(e.push(a.time),t.push.apply(t,s)),a=r[i++];while(a!==void 0);else if(s.toArray!==void 0)do s=a[n],s!==void 0&&(e.push(a.time),s.toArray(t,t.length)),a=r[i++];while(a!==void 0);else do s=a[n],s!==void 0&&(e.push(a.time),t.push(s)),a=r[i++];while(a!==void 0)}class Qi{constructor(e,t,n,i){this.parameterPositions=e,this._cachedIndex=0,this.resultBuffer=i!==void 0?i:new t.constructor(n),this.sampleValues=t,this.valueSize=n,this.settings=null,this.DefaultSettings_={}}evaluate(e){const t=this.parameterPositions;let n=this._cachedIndex,i=t[n],a=t[n-1];t:{e:{let s;n:{i:if(!(e<i)){for(let o=n+2;;){if(i===void 0){if(e<a)break i;return n=t.length,this._cachedIndex=n,this.copySampleValue_(n-1)}if(n===o)break;if(a=i,i=t[++n],e<i)break e}s=t.length;break n}if(e>=a)break t;{const o=t[1];e<o&&(n=2,a=o);for(let c=n-2;;){if(a===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(n===c)break;if(i=a,a=t[--n-1],e>=a)break e}s=n,n=0}}for(;n<s;){const o=n+s>>>1;e<t[o]?s=o:n=o+1}if(i=t[n],a=t[n-1],a===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(i===void 0)return n=t.length,this._cachedIndex=n,this.copySampleValue_(n-1)}this._cachedIndex=n,this.intervalChanged_(n,a,i)}return this.interpolate_(n,a,e,i)}getSettings_(){return this.settings||this.DefaultSettings_}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,a=e*i;for(let s=0;s!==i;++s)t[s]=n[a+s];return t}interpolate_(){throw new Error("call to abstract method")}intervalChanged_(){}}class Ou extends Qi{constructor(e,t,n,i){super(e,t,n,i),this._weightPrev=-0,this._offsetPrev=-0,this._weightNext=-0,this._offsetNext=-0,this.DefaultSettings_={endingStart:2400,endingEnd:2400}}intervalChanged_(e,t,n){const i=this.parameterPositions;let a=e-2,s=e+1,o=i[a],c=i[s];if(o===void 0)switch(this.getSettings_().endingStart){case 2401:a=e,o=2*t-n;break;case 2402:a=i.length-2,o=t+i[a]-i[a+1];break;default:a=e,o=n}if(c===void 0)switch(this.getSettings_().endingEnd){case 2401:s=e,c=2*n-t;break;case 2402:s=1,c=n+i[1]-i[0];break;default:s=e-1,c=t}const l=.5*(n-t),h=this.valueSize;this._weightPrev=l/(t-o),this._weightNext=l/(c-n),this._offsetPrev=a*h,this._offsetNext=s*h}interpolate_(e,t,n,i){const a=this.resultBuffer,s=this.sampleValues,o=this.valueSize,c=e*o,l=c-o,h=this._offsetPrev,u=this._offsetNext,d=this._weightPrev,p=this._weightNext,m=(n-t)/(i-t),v=m*m,_=v*m,f=-d*_+2*d*v-d*m,x=(1+d)*_+(-1.5-2*d)*v+(-.5+d)*m+1,g=(-1-p)*_+(1.5+p)*v+.5*m,y=p*_-p*v;for(let C=0;C!==o;++C)a[C]=f*s[h+C]+x*s[l+C]+g*s[c+C]+y*s[u+C];return a}}class Fu extends Qi{constructor(e,t,n,i){super(e,t,n,i)}interpolate_(e,t,n,i){const a=this.resultBuffer,s=this.sampleValues,o=this.valueSize,c=e*o,l=c-o,h=(n-t)/(i-t),u=1-h;for(let d=0;d!==o;++d)a[d]=s[l+d]*u+s[c+d]*h;return a}}class Bu extends Qi{constructor(e,t,n,i){super(e,t,n,i)}interpolate_(e){return this.copySampleValue_(e-1)}}class Kt{constructor(e,t,n,i){if(e===void 0)throw new Error("THREE.KeyframeTrack: track name is undefined");if(t===void 0||t.length===0)throw new Error("THREE.KeyframeTrack: no keyframes in track named "+e);this.name=e,this.times=Lr(t,this.TimeBufferType),this.values=Lr(n,this.ValueBufferType),this.setInterpolation(i||this.DefaultInterpolation)}static toJSON(e){const t=e.constructor;let n;if(t.toJSON!==this.toJSON)n=t.toJSON(e);else{n={name:e.name,times:Lr(e.times,Array),values:Lr(e.values,Array)};const i=e.getInterpolation();i!==e.DefaultInterpolation&&(n.interpolation=i)}return n.type=e.ValueTypeName,n}InterpolantFactoryMethodDiscrete(e){return new Bu(this.times,this.values,this.getValueSize(),e)}InterpolantFactoryMethodLinear(e){return new Fu(this.times,this.values,this.getValueSize(),e)}InterpolantFactoryMethodSmooth(e){return new Ou(this.times,this.values,this.getValueSize(),e)}setInterpolation(e){let t;switch(e){case Ki:t=this.InterpolantFactoryMethodDiscrete;break;case bi:t=this.InterpolantFactoryMethodLinear;break;case ha:t=this.InterpolantFactoryMethodSmooth}if(t===void 0){const n="unsupported interpolation for "+this.ValueTypeName+" keyframe track named "+this.name;if(this.createInterpolant===void 0){if(e===this.DefaultInterpolation)throw new Error(n);this.setInterpolation(this.DefaultInterpolation)}return this}return this.createInterpolant=t,this}getInterpolation(){switch(this.createInterpolant){case this.InterpolantFactoryMethodDiscrete:return Ki;case this.InterpolantFactoryMethodLinear:return bi;case this.InterpolantFactoryMethodSmooth:return ha}}getValueSize(){return this.values.length/this.times.length}shift(e){if(e!==0){const t=this.times;for(let n=0,i=t.length;n!==i;++n)t[n]+=e}return this}scale(e){if(e!==1){const t=this.times;for(let n=0,i=t.length;n!==i;++n)t[n]*=e}return this}trim(e,t){const n=this.times,i=n.length;let a=0,s=i-1;for(;a!==i&&n[a]<e;)++a;for(;s!==-1&&n[s]>t;)--s;if(++s,a!==0||s!==i){a>=s&&(s=Math.max(s,1),a=s-1);const o=this.getValueSize();this.times=n.slice(a,s),this.values=this.values.slice(a*o,s*o)}return this}validate(){let e=!0;const t=this.getValueSize();t-Math.floor(t)!=0&&(e=!1);const n=this.times,i=this.values,a=n.length;a===0&&(e=!1);let s=null;for(let c=0;c!==a;c++){const l=n[c];if(typeof l=="number"&&isNaN(l)){e=!1;break}if(s!==null&&s>l){e=!1;break}s=l}if(i!==void 0&&(o=i,ArrayBuffer.isView(o)&&!(o instanceof DataView)))for(let c=0,l=i.length;c!==l;++c){const h=i[c];if(isNaN(h)){e=!1;break}}var o;return e}optimize(){const e=this.times.slice(),t=this.values.slice(),n=this.getValueSize(),i=this.getInterpolation()===ha,a=e.length-1;let s=1;for(let o=1;o<a;++o){let c=!1;const l=e[o];if(l!==e[o+1]&&(o!==1||l!==e[0]))if(i)c=!0;else{const h=o*n,u=h-n,d=h+n;for(let p=0;p!==n;++p){const m=t[h+p];if(m!==t[u+p]||m!==t[d+p]){c=!0;break}}}if(c){if(o!==s){e[s]=e[o];const h=o*n,u=s*n;for(let d=0;d!==n;++d)t[u+d]=t[h+d]}++s}}if(a>0){e[s]=e[a];for(let o=a*n,c=s*n,l=0;l!==n;++l)t[c+l]=t[o+l];++s}return s!==e.length?(this.times=e.slice(0,s),this.values=t.slice(0,s*n)):(this.times=e,this.values=t),this}clone(){const e=this.times.slice(),t=this.values.slice(),n=new this.constructor(this.name,e,t);return n.createInterpolant=this.createInterpolant,n}}Kt.prototype.TimeBufferType=Float32Array,Kt.prototype.ValueBufferType=Float32Array,Kt.prototype.DefaultInterpolation=bi;class gi extends Kt{}gi.prototype.ValueTypeName="bool",gi.prototype.ValueBufferType=Array,gi.prototype.DefaultInterpolation=Ki,gi.prototype.InterpolantFactoryMethodLinear=void 0,gi.prototype.InterpolantFactoryMethodSmooth=void 0;class Wl extends Kt{}Wl.prototype.ValueTypeName="color";class Ci extends Kt{}Ci.prototype.ValueTypeName="number";class zu extends Qi{constructor(e,t,n,i){super(e,t,n,i)}interpolate_(e,t,n,i){const a=this.resultBuffer,s=this.sampleValues,o=this.valueSize,c=(n-t)/(i-t);let l=e*o;for(let h=l+o;l!==h;l+=4)Pt.slerpFlat(a,0,s,l-o,s,l,c);return a}}class Yn extends Kt{InterpolantFactoryMethodLinear(e){return new zu(this.times,this.values,this.getValueSize(),e)}}Yn.prototype.ValueTypeName="quaternion",Yn.prototype.DefaultInterpolation=bi,Yn.prototype.InterpolantFactoryMethodSmooth=void 0;class _i extends Kt{}_i.prototype.ValueTypeName="string",_i.prototype.ValueBufferType=Array,_i.prototype.DefaultInterpolation=Ki,_i.prototype.InterpolantFactoryMethodLinear=void 0,_i.prototype.InterpolantFactoryMethodSmooth=void 0;class Pi extends Kt{}Pi.prototype.ValueTypeName="vector";class Hu{constructor(e,t=-1,n,i=2500){this.name=e,this.tracks=n,this.duration=t,this.blendMode=i,this.uuid=kt(),this.duration<0&&this.resetDuration()}static parse(e){const t=[],n=e.tracks,i=1/(e.fps||1);for(let s=0,o=n.length;s!==o;++s)t.push(Vu(n[s]).scale(i));const a=new this(e.name,e.duration,t,e.blendMode);return a.uuid=e.uuid,a}static toJSON(e){const t=[],n=e.tracks,i={name:e.name,duration:e.duration,tracks:t,uuid:e.uuid,blendMode:e.blendMode};for(let a=0,s=n.length;a!==s;++a)t.push(Kt.toJSON(n[a]));return i}static CreateFromMorphTargetSequence(e,t,n,i){const a=t.length,s=[];for(let o=0;o<a;o++){let c=[],l=[];c.push((o+a-1)%a,o,(o+1)%a),l.push(0,1,0);const h=Du(c);c=Ko(c,1,h),l=Ko(l,1,h),i||c[0]!==0||(c.push(a),l.push(l[0])),s.push(new Ci(".morphTargetInfluences["+t[o].name+"]",c,l).scale(1/n))}return new this(e,-1,s)}static findByName(e,t){let n=e;if(!Array.isArray(e)){const i=e;n=i.geometry&&i.geometry.animations||i.animations}for(let i=0;i<n.length;i++)if(n[i].name===t)return n[i];return null}static CreateClipsFromMorphTargetSequences(e,t,n){const i={},a=/^([\w-]*?)([\d]+)$/;for(let o=0,c=e.length;o<c;o++){const l=e[o],h=l.name.match(a);if(h&&h.length>1){const u=h[1];let d=i[u];d||(i[u]=d=[]),d.push(l)}}const s=[];for(const o in i)s.push(this.CreateFromMorphTargetSequence(o,i[o],t,n));return s}static parseAnimation(e,t){if(!e)return null;const n=function(h,u,d,p,m){if(d.length!==0){const v=[],_=[];Gl(d,v,_,p),v.length!==0&&m.push(new h(u,v,_))}},i=[],a=e.name||"default",s=e.fps||30,o=e.blendMode;let c=e.length||-1;const l=e.hierarchy||[];for(let h=0;h<l.length;h++){const u=l[h].keys;if(u&&u.length!==0)if(u[0].morphTargets){const d={};let p;for(p=0;p<u.length;p++)if(u[p].morphTargets)for(let m=0;m<u[p].morphTargets.length;m++)d[u[p].morphTargets[m]]=-1;for(const m in d){const v=[],_=[];for(let f=0;f!==u[p].morphTargets.length;++f){const x=u[p];v.push(x.time),_.push(x.morphTarget===m?1:0)}i.push(new Ci(".morphTargetInfluence["+m+"]",v,_))}c=d.length*s}else{const d=".bones["+t[h].name+"]";n(Pi,d+".position",u,"pos",i),n(Yn,d+".quaternion",u,"rot",i),n(Pi,d+".scale",u,"scl",i)}}return i.length===0?null:new this(a,c,i,o)}resetDuration(){let e=0;for(let t=0,n=this.tracks.length;t!==n;++t){const i=this.tracks[t];e=Math.max(e,i.times[i.times.length-1])}return this.duration=e,this}trim(){for(let e=0;e<this.tracks.length;e++)this.tracks[e].trim(0,this.duration);return this}validate(){let e=!0;for(let t=0;t<this.tracks.length;t++)e=e&&this.tracks[t].validate();return e}optimize(){for(let e=0;e<this.tracks.length;e++)this.tracks[e].optimize();return this}clone(){const e=[];for(let t=0;t<this.tracks.length;t++)e.push(this.tracks[t].clone());return new this.constructor(this.name,this.duration,e,this.blendMode)}toJSON(){return this.constructor.toJSON(this)}}function Vu(r){if(r.type===void 0)throw new Error("THREE.KeyframeTrack: track type undefined, can not parse");const e=function(t){switch(t.toLowerCase()){case"scalar":case"double":case"float":case"number":case"integer":return Ci;case"vector":case"vector2":case"vector3":case"vector4":return Pi;case"color":return Wl;case"quaternion":return Yn;case"bool":case"boolean":return gi;case"string":return _i}throw new Error("THREE.KeyframeTrack: Unsupported typeName: "+t)}(r.type);if(r.times===void 0){const t=[],n=[];Gl(r.keys,t,n,"value"),r.times=t,r.values=n}return e.parse!==void 0?e.parse(r):new e(r.name,r.times,r.values,r.interpolation)}const bn={enabled:!1,files:{},add:function(r,e){this.enabled!==!1&&(this.files[r]=e)},get:function(r){if(this.enabled!==!1)return this.files[r]},remove:function(r){delete this.files[r]},clear:function(){this.files={}}};class ku{constructor(e,t,n){const i=this;let a,s=!1,o=0,c=0;const l=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=n,this.itemStart=function(h){c++,s===!1&&i.onStart!==void 0&&i.onStart(h,o,c),s=!0},this.itemEnd=function(h){o++,i.onProgress!==void 0&&i.onProgress(h,o,c),o===c&&(s=!1,i.onLoad!==void 0&&i.onLoad())},this.itemError=function(h){i.onError!==void 0&&i.onError(h)},this.resolveURL=function(h){return a?a(h):h},this.setURLModifier=function(h){return a=h,this},this.addHandler=function(h,u){return l.push(h,u),this},this.removeHandler=function(h){const u=l.indexOf(h);return u!==-1&&l.splice(u,2),this},this.getHandler=function(h){for(let u=0,d=l.length;u<d;u+=2){const p=l[u],m=l[u+1];if(p.global&&(p.lastIndex=0),p.test(h))return m}return null}}}const Gu=new ku;class Cn{constructor(e){this.manager=e!==void 0?e:Gu,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const n=this;return new Promise(function(i,a){n.load(e,i,t,a)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}Cn.DEFAULT_MATERIAL_NAME="__DEFAULT";const sn={};class Wu extends Error{constructor(e,t){super(e),this.response=t}}class $r extends Cn{constructor(e){super(e)}load(e,t,n,i){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const a=bn.get(e);if(a!==void 0)return this.manager.itemStart(e),setTimeout(()=>{t&&t(a),this.manager.itemEnd(e)},0),a;if(sn[e]!==void 0)return void sn[e].push({onLoad:t,onProgress:n,onError:i});sn[e]=[],sn[e].push({onLoad:t,onProgress:n,onError:i});const s=new Request(e,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),o=this.mimeType,c=this.responseType;fetch(s).then(l=>{if(l.status===200||l.status===0){if(l.status,typeof ReadableStream>"u"||l.body===void 0||l.body.getReader===void 0)return l;const h=sn[e],u=l.body.getReader(),d=l.headers.get("Content-Length")||l.headers.get("X-File-Size"),p=d?parseInt(d):0,m=p!==0;let v=0;const _=new ReadableStream({start(f){(function x(){u.read().then(({done:g,value:y})=>{if(g)f.close();else{v+=y.byteLength;const C=new ProgressEvent("progress",{lengthComputable:m,loaded:v,total:p});for(let w=0,T=h.length;w<T;w++){const U=h[w];U.onProgress&&U.onProgress(C)}f.enqueue(y),x()}})})()}});return new Response(_)}throw new Wu(`fetch for "${l.url}" responded with ${l.status}: ${l.statusText}`,l)}).then(l=>{switch(c){case"arraybuffer":return l.arrayBuffer();case"blob":return l.blob();case"document":return l.text().then(h=>new DOMParser().parseFromString(h,o));case"json":return l.json();default:if(o===void 0)return l.text();{const h=/charset="?([^;"\s]*)"?/i.exec(o),u=h&&h[1]?h[1].toLowerCase():void 0,d=new TextDecoder(u);return l.arrayBuffer().then(p=>d.decode(p))}}}).then(l=>{bn.add(e,l);const h=sn[e];delete sn[e];for(let u=0,d=h.length;u<d;u++){const p=h[u];p.onLoad&&p.onLoad(l)}}).catch(l=>{const h=sn[e];if(h===void 0)throw this.manager.itemError(e),l;delete sn[e];for(let u=0,d=h.length;u<d;u++){const p=h[u];p.onError&&p.onError(l)}this.manager.itemError(e)}).finally(()=>{this.manager.itemEnd(e)}),this.manager.itemStart(e)}setResponseType(e){return this.responseType=e,this}setMimeType(e){return this.mimeType=e,this}}class Xu extends Cn{constructor(e){super(e)}load(e,t,n,i){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const a=this,s=bn.get(e);if(s!==void 0)return a.manager.itemStart(e),setTimeout(function(){t&&t(s),a.manager.itemEnd(e)},0),s;const o=Zi("img");function c(){h(),bn.add(e,this),t&&t(this),a.manager.itemEnd(e)}function l(u){h(),i&&i(u),a.manager.itemError(e),a.manager.itemEnd(e)}function h(){o.removeEventListener("load",c,!1),o.removeEventListener("error",l,!1)}return o.addEventListener("load",c,!1),o.addEventListener("error",l,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(o.crossOrigin=this.crossOrigin),a.manager.itemStart(e),o.src=e,o}}class ju extends Cn{constructor(e){super(e)}load(e,t,n,i){const a=this,s=new gs,o=new $r(this.manager);return o.setResponseType("arraybuffer"),o.setRequestHeader(this.requestHeader),o.setPath(this.path),o.setWithCredentials(a.withCredentials),o.load(e,function(c){let l;try{l=a.parse(c)}catch(h){if(i===void 0)return;i(h)}l.image!==void 0?s.image=l.image:l.data!==void 0&&(s.image.width=l.width,s.image.height=l.height,s.image.data=l.data),s.wrapS=l.wrapS!==void 0?l.wrapS:Vt,s.wrapT=l.wrapT!==void 0?l.wrapT:Vt,s.magFilter=l.magFilter!==void 0?l.magFilter:$e,s.minFilter=l.minFilter!==void 0?l.minFilter:$e,s.anisotropy=l.anisotropy!==void 0?l.anisotropy:1,l.colorSpace!==void 0&&(s.colorSpace=l.colorSpace),l.flipY!==void 0&&(s.flipY=l.flipY),l.format!==void 0&&(s.format=l.format),l.type!==void 0&&(s.type=l.type),l.mipmaps!==void 0&&(s.mipmaps=l.mipmaps,s.minFilter=wn),l.mipmapCount===1&&(s.minFilter=$e),l.generateMipmaps!==void 0&&(s.generateMipmaps=l.generateMipmaps),s.needsUpdate=!0,t&&t(s,l)},n,i),s}}class qu extends Cn{constructor(e){super(e)}load(e,t,n,i){const a=new it,s=new Xu(this.manager);return s.setCrossOrigin(this.crossOrigin),s.setPath(this.path),s.load(e,function(o){a.image=o,a.needsUpdate=!0,t!==void 0&&t(a)},n,i),a}}class Qr extends ke{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ee(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}const za=new Te,Zo=new P,Jo=new P;class Ms{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new _e(512,512),this.map=null,this.mapPass=null,this.matrix=new Te,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new ds,this._frameExtents=new _e(1,1),this._viewportCount=1,this._viewports=[new Ve(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,n=this.matrix;Zo.setFromMatrixPosition(e.matrixWorld),t.position.copy(Zo),Jo.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Jo),t.updateMatrixWorld(),za.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(za),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(za)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),this.mapSize.x===512&&this.mapSize.y===512||(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Yu extends Ms{constructor(){super(new mt(50,1,.5,500)),this.isSpotLightShadow=!0,this.focus=1}updateMatrices(e){const t=this.camera,n=2*wi*e.angle*this.focus,i=this.mapSize.width/this.mapSize.height,a=e.distance||t.far;n===t.fov&&i===t.aspect&&a===t.far||(t.fov=n,t.aspect=i,t.far=a,t.updateProjectionMatrix()),super.updateMatrices(e)}copy(e){return super.copy(e),this.focus=e.focus,this}}class Ku extends Qr{constructor(e,t,n=0,i=Math.PI/3,a=0,s=2){super(e,t),this.isSpotLight=!0,this.type="SpotLight",this.position.copy(ke.DEFAULT_UP),this.updateMatrix(),this.target=new ke,this.distance=n,this.angle=i,this.penumbra=a,this.decay=s,this.map=null,this.shadow=new Yu}get power(){return this.intensity*Math.PI}set power(e){this.intensity=e/Math.PI}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.angle=e.angle,this.penumbra=e.penumbra,this.decay=e.decay,this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}const $o=new Te,Gi=new P,Ha=new P;class Zu extends Ms{constructor(){super(new mt(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new _e(4,2),this._viewportCount=6,this._viewports=[new Ve(2,1,1,1),new Ve(0,1,1,1),new Ve(3,1,1,1),new Ve(1,1,1,1),new Ve(3,0,1,1),new Ve(1,0,1,1)],this._cubeDirections=[new P(1,0,0),new P(-1,0,0),new P(0,0,1),new P(0,0,-1),new P(0,1,0),new P(0,-1,0)],this._cubeUps=[new P(0,1,0),new P(0,1,0),new P(0,1,0),new P(0,1,0),new P(0,0,1),new P(0,0,-1)]}updateMatrices(e,t=0){const n=this.camera,i=this.matrix,a=e.distance||n.far;a!==n.far&&(n.far=a,n.updateProjectionMatrix()),Gi.setFromMatrixPosition(e.matrixWorld),n.position.copy(Gi),Ha.copy(n.position),Ha.add(this._cubeDirections[t]),n.up.copy(this._cubeUps[t]),n.lookAt(Ha),n.updateMatrixWorld(),i.makeTranslation(-Gi.x,-Gi.y,-Gi.z),$o.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix($o)}}class Ju extends Qr{constructor(e,t,n=0,i=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=i,this.shadow=new Zu}get power(){return 4*this.intensity*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class $u extends Ms{constructor(){super(new ps(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Xl extends Qr{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(ke.DEFAULT_UP),this.updateMatrix(),this.target=new ke,this.shadow=new $u}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Qu extends Qr{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class Yi{static decodeText(e){if(typeof TextDecoder<"u")return new TextDecoder().decode(e);let t="";for(let n=0,i=e.length;n<i;n++)t+=String.fromCharCode(e[n]);try{return decodeURIComponent(escape(t))}catch{return t}}static extractUrlBase(e){const t=e.lastIndexOf("/");return t===-1?"./":e.slice(0,t+1)}static resolveURL(e,t){return typeof e!="string"||e===""?"":(/^https?:\/\//i.test(t)&&/^\//.test(e)&&(t=t.replace(/(^https?:\/\/[^\/]+).*/i,"$1")),/^(https?:)?\/\//i.test(e)||/^data:.*,.*$/i.test(e)||/^blob:.*$/i.test(e)?e:t+e)}}class ed extends Cn{constructor(e){super(e),this.isImageBitmapLoader=!0,this.options={premultiplyAlpha:"none"}}setOptions(e){return this.options=e,this}load(e,t,n,i){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const a=this,s=bn.get(e);if(s!==void 0)return a.manager.itemStart(e),s.then?void s.then(l=>{t&&t(l),a.manager.itemEnd(e)}).catch(l=>{i&&i(l)}):(setTimeout(function(){t&&t(s),a.manager.itemEnd(e)},0),s);const o={};o.credentials=this.crossOrigin==="anonymous"?"same-origin":"include",o.headers=this.requestHeader;const c=fetch(e,o).then(function(l){return l.blob()}).then(function(l){return createImageBitmap(l,Object.assign(a.options,{colorSpaceConversion:"none"}))}).then(function(l){return bn.add(e,l),t&&t(l),a.manager.itemEnd(e),l}).catch(function(l){i&&i(l),bn.remove(e),a.manager.itemError(e),a.manager.itemEnd(e)});bn.add(e,c),a.manager.itemStart(e)}}let Ir;class jl{static getContext(){return Ir===void 0&&(Ir=new(window.AudioContext||window.webkitAudioContext)),Ir}static setContext(e){Ir=e}}class td extends Cn{constructor(e){super(e)}load(e,t,n,i){const a=this,s=new $r(this.manager);function o(c){i&&i(c),a.manager.itemError(e)}s.setResponseType("arraybuffer"),s.setPath(this.path),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(c){try{const l=c.slice(0);jl.getContext().decodeAudioData(l,function(h){t(h)}).catch(o)}catch(l){o(l)}},n,i)}}class nd{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Qo(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=Qo();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function Qo(){return(typeof performance>"u"?Date:performance).now()}const Vn=new P,el=new Pt,id=new P,kn=new P;class rd extends ke{constructor(){super(),this.type="AudioListener",this.context=jl.getContext(),this.gain=this.context.createGain(),this.gain.connect(this.context.destination),this.filter=null,this.timeDelta=0,this._clock=new nd}getInput(){return this.gain}removeFilter(){return this.filter!==null&&(this.gain.disconnect(this.filter),this.filter.disconnect(this.context.destination),this.gain.connect(this.context.destination),this.filter=null),this}getFilter(){return this.filter}setFilter(e){return this.filter!==null?(this.gain.disconnect(this.filter),this.filter.disconnect(this.context.destination)):this.gain.disconnect(this.context.destination),this.filter=e,this.gain.connect(this.filter),this.filter.connect(this.context.destination),this}getMasterVolume(){return this.gain.gain.value}setMasterVolume(e){return this.gain.gain.setTargetAtTime(e,this.context.currentTime,.01),this}updateMatrixWorld(e){super.updateMatrixWorld(e);const t=this.context.listener,n=this.up;if(this.timeDelta=this._clock.getDelta(),this.matrixWorld.decompose(Vn,el,id),kn.set(0,0,-1).applyQuaternion(el),t.positionX){const i=this.context.currentTime+this.timeDelta;t.positionX.linearRampToValueAtTime(Vn.x,i),t.positionY.linearRampToValueAtTime(Vn.y,i),t.positionZ.linearRampToValueAtTime(Vn.z,i),t.forwardX.linearRampToValueAtTime(kn.x,i),t.forwardY.linearRampToValueAtTime(kn.y,i),t.forwardZ.linearRampToValueAtTime(kn.z,i),t.upX.linearRampToValueAtTime(n.x,i),t.upY.linearRampToValueAtTime(n.y,i),t.upZ.linearRampToValueAtTime(n.z,i)}else t.setPosition(Vn.x,Vn.y,Vn.z),t.setOrientation(kn.x,kn.y,kn.z,n.x,n.y,n.z)}}class ad extends ke{constructor(e){super(),this.type="Audio",this.listener=e,this.context=e.context,this.gain=this.context.createGain(),this.gain.connect(e.getInput()),this.autoplay=!1,this.buffer=null,this.detune=0,this.loop=!1,this.loopStart=0,this.loopEnd=0,this.offset=0,this.duration=void 0,this.playbackRate=1,this.isPlaying=!1,this.hasPlaybackControl=!0,this.source=null,this.sourceType="empty",this._startedAt=0,this._progress=0,this._connected=!1,this.filters=[]}getOutput(){return this.gain}setNodeSource(e){return this.hasPlaybackControl=!1,this.sourceType="audioNode",this.source=e,this.connect(),this}setMediaElementSource(e){return this.hasPlaybackControl=!1,this.sourceType="mediaNode",this.source=this.context.createMediaElementSource(e),this.connect(),this}setMediaStreamSource(e){return this.hasPlaybackControl=!1,this.sourceType="mediaStreamNode",this.source=this.context.createMediaStreamSource(e),this.connect(),this}setBuffer(e){return this.buffer=e,this.sourceType="buffer",this.autoplay&&this.play(),this}play(e=0){if(this.isPlaying===!0||this.hasPlaybackControl===!1)return;this._startedAt=this.context.currentTime+e;const t=this.context.createBufferSource();return t.buffer=this.buffer,t.loop=this.loop,t.loopStart=this.loopStart,t.loopEnd=this.loopEnd,t.onended=this.onEnded.bind(this),t.start(this._startedAt,this._progress+this.offset,this.duration),this.isPlaying=!0,this.source=t,this.setDetune(this.detune),this.setPlaybackRate(this.playbackRate),this.connect()}pause(){if(this.hasPlaybackControl!==!1)return this.isPlaying===!0&&(this._progress+=Math.max(this.context.currentTime-this._startedAt,0)*this.playbackRate,this.loop===!0&&(this._progress=this._progress%(this.duration||this.buffer.duration)),this.source.stop(),this.source.onended=null,this.isPlaying=!1),this}stop(){if(this.hasPlaybackControl!==!1)return this._progress=0,this.source!==null&&(this.source.stop(),this.source.onended=null),this.isPlaying=!1,this}connect(){if(this.filters.length>0){this.source.connect(this.filters[0]);for(let e=1,t=this.filters.length;e<t;e++)this.filters[e-1].connect(this.filters[e]);this.filters[this.filters.length-1].connect(this.getOutput())}else this.source.connect(this.getOutput());return this._connected=!0,this}disconnect(){if(this._connected!==!1){if(this.filters.length>0){this.source.disconnect(this.filters[0]);for(let e=1,t=this.filters.length;e<t;e++)this.filters[e-1].disconnect(this.filters[e]);this.filters[this.filters.length-1].disconnect(this.getOutput())}else this.source.disconnect(this.getOutput());return this._connected=!1,this}}getFilters(){return this.filters}setFilters(e){return e||(e=[]),this._connected===!0?(this.disconnect(),this.filters=e.slice(),this.connect()):this.filters=e.slice(),this}setDetune(e){return this.detune=e,this.isPlaying===!0&&this.source.detune!==void 0&&this.source.detune.setTargetAtTime(this.detune,this.context.currentTime,.01),this}getDetune(){return this.detune}getFilter(){return this.getFilters()[0]}setFilter(e){return this.setFilters(e?[e]:[])}setPlaybackRate(e){if(this.hasPlaybackControl!==!1)return this.playbackRate=e,this.isPlaying===!0&&this.source.playbackRate.setTargetAtTime(this.playbackRate,this.context.currentTime,.01),this}getPlaybackRate(){return this.playbackRate}onEnded(){this.isPlaying=!1}getLoop(){return this.hasPlaybackControl!==!1&&this.loop}setLoop(e){if(this.hasPlaybackControl!==!1)return this.loop=e,this.isPlaying===!0&&(this.source.loop=this.loop),this}setLoopStart(e){return this.loopStart=e,this}setLoopEnd(e){return this.loopEnd=e,this}getVolume(){return this.gain.gain.value}setVolume(e){return this.gain.gain.setTargetAtTime(e,this.context.currentTime,.01),this}}const Ss="\\[\\]\\.:\\/",sd=new RegExp("["+Ss+"]","g"),Va="[^"+Ss+"]",od="[^"+Ss.replace("\\.","")+"]",ld=new RegExp("^"+/((?:WC+[\/:])*)/.source.replace("WC",Va)+/(WCOD+)?/.source.replace("WCOD",od)+/(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC",Va)+/\.(WC+)(?:\[(.+)\])?/.source.replace("WC",Va)+"$"),cd=["material","materials","bones","map"];class Be{constructor(e,t,n){this.path=t,this.parsedPath=n||Be.parseTrackName(t),this.node=Be.findNode(e,this.parsedPath.nodeName),this.rootNode=e,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}static create(e,t,n){return e&&e.isAnimationObjectGroup?new Be.Composite(e,t,n):new Be(e,t,n)}static sanitizeNodeName(e){return e.replace(/\s/g,"_").replace(sd,"")}static parseTrackName(e){const t=ld.exec(e);if(t===null)throw new Error("PropertyBinding: Cannot parse trackName: "+e);const n={nodeName:t[2],objectName:t[3],objectIndex:t[4],propertyName:t[5],propertyIndex:t[6]},i=n.nodeName&&n.nodeName.lastIndexOf(".");if(i!==void 0&&i!==-1){const a=n.nodeName.substring(i+1);cd.indexOf(a)!==-1&&(n.nodeName=n.nodeName.substring(0,i),n.objectName=a)}if(n.propertyName===null||n.propertyName.length===0)throw new Error("PropertyBinding: can not parse propertyName from trackName: "+e);return n}static findNode(e,t){if(t===void 0||t===""||t==="."||t===-1||t===e.name||t===e.uuid)return e;if(e.skeleton){const n=e.skeleton.getBoneByName(t);if(n!==void 0)return n}if(e.children){const n=function(a){for(let s=0;s<a.length;s++){const o=a[s];if(o.name===t||o.uuid===t)return o;const c=n(o.children);if(c)return c}return null},i=n(e.children);if(i)return i}return null}_getValue_unavailable(){}_setValue_unavailable(){}_getValue_direct(e,t){e[t]=this.targetObject[this.propertyName]}_getValue_array(e,t){const n=this.resolvedProperty;for(let i=0,a=n.length;i!==a;++i)e[t++]=n[i]}_getValue_arrayElement(e,t){e[t]=this.resolvedProperty[this.propertyIndex]}_getValue_toArray(e,t){this.resolvedProperty.toArray(e,t)}_setValue_direct(e,t){this.targetObject[this.propertyName]=e[t]}_setValue_direct_setNeedsUpdate(e,t){this.targetObject[this.propertyName]=e[t],this.targetObject.needsUpdate=!0}_setValue_direct_setMatrixWorldNeedsUpdate(e,t){this.targetObject[this.propertyName]=e[t],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_array(e,t){const n=this.resolvedProperty;for(let i=0,a=n.length;i!==a;++i)n[i]=e[t++]}_setValue_array_setNeedsUpdate(e,t){const n=this.resolvedProperty;for(let i=0,a=n.length;i!==a;++i)n[i]=e[t++];this.targetObject.needsUpdate=!0}_setValue_array_setMatrixWorldNeedsUpdate(e,t){const n=this.resolvedProperty;for(let i=0,a=n.length;i!==a;++i)n[i]=e[t++];this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_arrayElement(e,t){this.resolvedProperty[this.propertyIndex]=e[t]}_setValue_arrayElement_setNeedsUpdate(e,t){this.resolvedProperty[this.propertyIndex]=e[t],this.targetObject.needsUpdate=!0}_setValue_arrayElement_setMatrixWorldNeedsUpdate(e,t){this.resolvedProperty[this.propertyIndex]=e[t],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_fromArray(e,t){this.resolvedProperty.fromArray(e,t)}_setValue_fromArray_setNeedsUpdate(e,t){this.resolvedProperty.fromArray(e,t),this.targetObject.needsUpdate=!0}_setValue_fromArray_setMatrixWorldNeedsUpdate(e,t){this.resolvedProperty.fromArray(e,t),this.targetObject.matrixWorldNeedsUpdate=!0}_getValue_unbound(e,t){this.bind(),this.getValue(e,t)}_setValue_unbound(e,t){this.bind(),this.setValue(e,t)}bind(){let e=this.node;const t=this.parsedPath,n=t.objectName,i=t.propertyName;let a=t.propertyIndex;if(e||(e=Be.findNode(this.rootNode,t.nodeName),this.node=e),this.getValue=this._getValue_unavailable,this.setValue=this._setValue_unavailable,!e)return;if(n){let l=t.objectIndex;switch(n){case"materials":if(!e.material||!e.material.materials)return;e=e.material.materials;break;case"bones":if(!e.skeleton)return;e=e.skeleton.bones;for(let h=0;h<e.length;h++)if(e[h].name===l){l=h;break}break;case"map":if("map"in e){e=e.map;break}if(!e.material||!e.material.map)return;e=e.material.map;break;default:if(e[n]===void 0)return;e=e[n]}if(l!==void 0){if(e[l]===void 0)return;e=e[l]}}const s=e[i];if(s===void 0){t.nodeName;return}let o=this.Versioning.None;this.targetObject=e,e.needsUpdate!==void 0?o=this.Versioning.NeedsUpdate:e.matrixWorldNeedsUpdate!==void 0&&(o=this.Versioning.MatrixWorldNeedsUpdate);let c=this.BindingType.Direct;if(a!==void 0){if(i==="morphTargetInfluences"){if(!e.geometry||!e.geometry.morphAttributes)return;e.morphTargetDictionary[a]!==void 0&&(a=e.morphTargetDictionary[a])}c=this.BindingType.ArrayElement,this.resolvedProperty=s,this.propertyIndex=a}else s.fromArray!==void 0&&s.toArray!==void 0?(c=this.BindingType.HasFromToArray,this.resolvedProperty=s):Array.isArray(s)?(c=this.BindingType.EntireArray,this.resolvedProperty=s):this.propertyName=i;this.getValue=this.GetterByBindingType[c],this.setValue=this.SetterByBindingTypeAndVersioning[c][o]}unbind(){this.node=null,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}}Be.Composite=class{constructor(r,e,t){const n=t||Be.parseTrackName(e);this._targetGroup=r,this._bindings=r.subscribe_(e,n)}getValue(r,e){this.bind();const t=this._targetGroup.nCachedObjects_,n=this._bindings[t];n!==void 0&&n.getValue(r,e)}setValue(r,e){const t=this._bindings;for(let n=this._targetGroup.nCachedObjects_,i=t.length;n!==i;++n)t[n].setValue(r,e)}bind(){const r=this._bindings;for(let e=this._targetGroup.nCachedObjects_,t=r.length;e!==t;++e)r[e].bind()}unbind(){const r=this._bindings;for(let e=this._targetGroup.nCachedObjects_,t=r.length;e!==t;++e)r[e].unbind()}},Be.prototype.BindingType={Direct:0,EntireArray:1,ArrayElement:2,HasFromToArray:3},Be.prototype.Versioning={None:0,NeedsUpdate:1,MatrixWorldNeedsUpdate:2},Be.prototype.GetterByBindingType=[Be.prototype._getValue_direct,Be.prototype._getValue_array,Be.prototype._getValue_arrayElement,Be.prototype._getValue_toArray],Be.prototype.SetterByBindingTypeAndVersioning=[[Be.prototype._setValue_direct,Be.prototype._setValue_direct_setNeedsUpdate,Be.prototype._setValue_direct_setMatrixWorldNeedsUpdate],[Be.prototype._setValue_array,Be.prototype._setValue_array_setNeedsUpdate,Be.prototype._setValue_array_setMatrixWorldNeedsUpdate],[Be.prototype._setValue_arrayElement,Be.prototype._setValue_arrayElement_setNeedsUpdate,Be.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate],[Be.prototype._setValue_fromArray,Be.prototype._setValue_fromArray_setNeedsUpdate,Be.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate]];const tl=new Te;class hd{constructor(e,t,n=0,i=1/0){this.ray=new Ii(e,t),this.near=n,this.far=i,this.camera=null,this.layers=new us,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,t){this.ray.set(e,t)}setFromCamera(e,t){t.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(t).sub(this.ray.origin).normalize(),this.camera=t):t.isOrthographicCamera&&(this.ray.origin.set(e.x,e.y,(t.near+t.far)/(t.near-t.far)).unproject(t),this.ray.direction.set(0,0,-1).transformDirection(t.matrixWorld),this.camera=t)}setFromXRController(e){return tl.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(tl),this}intersectObject(e,t=!0,n=[]){return rs(e,this,n,t),n.sort(nl),n}intersectObjects(e,t=!0,n=[]){for(let i=0,a=e.length;i<a;i++)rs(e[i],this,n,t);return n.sort(nl),n}}function nl(r,e){return r.distance-e.distance}function rs(r,e,t,n){if(r.layers.test(e.layers)&&r.raycast(e,t),n===!0){const i=r.children;for(let a=0,s=i.length;a<s;a++)rs(i[a],e,t,!0)}}class il{constructor(e=1,t=0,n=0){return this.radius=e,this.phi=t,this.theta=n,this}set(e,t,n){return this.radius=e,this.phi=t,this.theta=n,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,n){return this.radius=Math.sqrt(e*e+t*t+n*n),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,n),this.phi=Math.acos(nt(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}class ud extends Vl{constructor(e=1){const t=[0,0,0,e,0,0,0,0,0,0,e,0,0,0,0,0,0,e],n=new Mt;n.setAttribute("position",new at(t,3)),n.setAttribute("color",new at([1,0,0,1,.6,0,0,1,0,.6,1,0,0,0,1,0,.6,1],3)),super(n,new vs({vertexColors:!0,toneMapped:!1})),this.type="AxesHelper"}setColors(e,t,n){const i=new Ee,a=this.geometry.attributes.color.array;return i.set(e),i.toArray(a,0),i.toArray(a,3),i.set(t),i.toArray(a,6),i.toArray(a,9),i.set(n),i.toArray(a,12),i.toArray(a,15),this.geometry.attributes.color.needsUpdate=!0,this}dispose(){this.geometry.dispose(),this.material.dispose()}}function rl(r,e){if(e===0)return r;if(e===2||e===1){let t=r.getIndex();if(t===null){const s=[],o=r.getAttribute("position");if(o===void 0)return r;for(let c=0;c<o.count;c++)s.push(c);r.setIndex(s),t=r.getIndex()}const n=t.count-2,i=[];if(e===2)for(let s=1;s<=n;s++)i.push(t.getX(0)),i.push(t.getX(s)),i.push(t.getX(s+1));else for(let s=0;s<n;s++)s%2==0?(i.push(t.getX(s)),i.push(t.getX(s+1)),i.push(t.getX(s+2))):(i.push(t.getX(s+2)),i.push(t.getX(s+1)),i.push(t.getX(s)));i.length;const a=r.clone();return a.setIndex(i),a.clearGroups(),a}return r}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ya}})),typeof window<"u"&&(window.__THREE__||(window.__THREE__=Ya));class as extends Cn{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new gd(t)}),this.register(function(t){return new bd(t)}),this.register(function(t){return new Ad(t)}),this.register(function(t){return new wd(t)}),this.register(function(t){return new vd(t)}),this.register(function(t){return new xd(t)}),this.register(function(t){return new yd(t)}),this.register(function(t){return new Md(t)}),this.register(function(t){return new md(t)}),this.register(function(t){return new Sd(t)}),this.register(function(t){return new _d(t)}),this.register(function(t){return new Td(t)}),this.register(function(t){return new Ed(t)}),this.register(function(t){return new pd(t)}),this.register(function(t){return new Rd(t)}),this.register(function(t){return new Cd(t)})}load(e,t,n,i){const a=this;let s;if(this.resourcePath!=="")s=this.resourcePath;else if(this.path!==""){const l=Yi.extractUrlBase(e);s=Yi.resolveURL(l,this.path)}else s=Yi.extractUrlBase(e);this.manager.itemStart(e);const o=function(l){i&&i(l),a.manager.itemError(e),a.manager.itemEnd(e)},c=new $r(this.manager);c.setPath(this.path),c.setResponseType("arraybuffer"),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(e,function(l){try{a.parse(l,s,function(h){t(h),a.manager.itemEnd(e)},o)}catch(h){o(h)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setDDSLoader(){throw new Error('THREE.GLTFLoader: "MSFT_texture_dds" no longer supported. Please update to "KHR_texture_basisu".')}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let a;const s={},o={},c=new TextDecoder;if(typeof e=="string")a=JSON.parse(e);else if(e instanceof ArrayBuffer)if(c.decode(new Uint8Array(e,0,4))===ql){try{s[Ie.KHR_BINARY_GLTF]=new Id(e)}catch(h){return void(i&&i(h))}a=JSON.parse(s[Ie.KHR_BINARY_GLTF].content)}else a=JSON.parse(c.decode(e));else a=e;if(a.asset===void 0||a.asset.version[0]<2)return void(i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.")));const l=new Xd(a,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});l.fileLoader.setRequestHeader(this.requestHeader);for(let h=0;h<this.pluginCallbacks.length;h++){const u=this.pluginCallbacks[h](l);u.name,o[u.name]=u,s[u.name]=!0}if(a.extensionsUsed)for(let h=0;h<a.extensionsUsed.length;++h){const u=a.extensionsUsed[h],d=a.extensionsRequired||[];switch(u){case Ie.KHR_MATERIALS_UNLIT:s[u]=new fd;break;case Ie.KHR_DRACO_MESH_COMPRESSION:s[u]=new Nd(a,this.dracoLoader);break;case Ie.KHR_TEXTURE_TRANSFORM:s[u]=new Ud;break;case Ie.KHR_MESH_QUANTIZATION:s[u]=new Dd;break;default:d.indexOf(u)>=0&&o[u]}}l.setExtensions(s),l.setPlugins(o),l.parse(n,i)}parseAsync(e,t){const n=this;return new Promise(function(i,a){n.parse(e,t,i,a)})}}function dd(){let r={};return{get:function(e){return r[e]},add:function(e,t){r[e]=t},remove:function(e){delete r[e]},removeAll:function(){r={}}}}const Ie={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class pd{constructor(e){this.parser=e,this.name=Ie.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){const a=t[n];a.extensions&&a.extensions[this.name]&&a.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,a.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let i=t.cache.get(n);if(i)return i;const a=t.json,s=((a.extensions&&a.extensions[this.name]||{}).lights||[])[e];let o;const c=new Ee(16777215);s.color!==void 0&&c.setRGB(s.color[0],s.color[1],s.color[2],st);const l=s.range!==void 0?s.range:0;switch(s.type){case"directional":o=new Xl(c),o.target.position.set(0,0,-1),o.add(o.target);break;case"point":o=new Ju(c),o.distance=l;break;case"spot":o=new Ku(c),o.distance=l,s.spot=s.spot||{},s.spot.innerConeAngle=s.spot.innerConeAngle!==void 0?s.spot.innerConeAngle:0,s.spot.outerConeAngle=s.spot.outerConeAngle!==void 0?s.spot.outerConeAngle:Math.PI/4,o.angle=s.spot.outerConeAngle,o.penumbra=1-s.spot.innerConeAngle/s.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+s.type)}return o.position.set(0,0,0),o.decay=2,En(o,s),s.intensity!==void 0&&(o.intensity=s.intensity),o.name=t.createUniqueName(s.name||"light_"+e),i=Promise.resolve(o),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,i=n.json.nodes[e],a=(i.extensions&&i.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(s){return n._getNodeRef(t.cache,a,s)})}}class fd{constructor(){this.name=Ie.KHR_MATERIALS_UNLIT}getMaterialType(){return hn}extendParams(e,t,n){const i=[];e.color=new Ee(1,1,1),e.opacity=1;const a=t.pbrMetallicRoughness;if(a){if(Array.isArray(a.baseColorFactor)){const s=a.baseColorFactor;e.color.setRGB(s[0],s[1],s[2],st),e.opacity=s[3]}a.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",a.baseColorTexture,ft))}return Promise.all(i)}}class md{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const n=this.parser.json.materials[e];if(!n.extensions||!n.extensions[this.name])return Promise.resolve();const i=n.extensions[this.name].emissiveStrength;return i!==void 0&&(t.emissiveIntensity=i),Promise.resolve()}}class gd{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];if(s.clearcoatFactor!==void 0&&(t.clearcoat=s.clearcoatFactor),s.clearcoatTexture!==void 0&&a.push(n.assignTexture(t,"clearcoatMap",s.clearcoatTexture)),s.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=s.clearcoatRoughnessFactor),s.clearcoatRoughnessTexture!==void 0&&a.push(n.assignTexture(t,"clearcoatRoughnessMap",s.clearcoatRoughnessTexture)),s.clearcoatNormalTexture!==void 0&&(a.push(n.assignTexture(t,"clearcoatNormalMap",s.clearcoatNormalTexture)),s.clearcoatNormalTexture.scale!==void 0)){const o=s.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new _e(o,o)}return Promise.all(a)}}class _d{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];return s.iridescenceFactor!==void 0&&(t.iridescence=s.iridescenceFactor),s.iridescenceTexture!==void 0&&a.push(n.assignTexture(t,"iridescenceMap",s.iridescenceTexture)),s.iridescenceIor!==void 0&&(t.iridescenceIOR=s.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),s.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=s.iridescenceThicknessMinimum),s.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=s.iridescenceThicknessMaximum),s.iridescenceThicknessTexture!==void 0&&a.push(n.assignTexture(t,"iridescenceThicknessMap",s.iridescenceThicknessTexture)),Promise.all(a)}}class vd{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_SHEEN}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[];t.sheenColor=new Ee(0,0,0),t.sheenRoughness=0,t.sheen=1;const s=i.extensions[this.name];if(s.sheenColorFactor!==void 0){const o=s.sheenColorFactor;t.sheenColor.setRGB(o[0],o[1],o[2],st)}return s.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=s.sheenRoughnessFactor),s.sheenColorTexture!==void 0&&a.push(n.assignTexture(t,"sheenColorMap",s.sheenColorTexture,ft)),s.sheenRoughnessTexture!==void 0&&a.push(n.assignTexture(t,"sheenRoughnessMap",s.sheenRoughnessTexture)),Promise.all(a)}}class xd{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];return s.transmissionFactor!==void 0&&(t.transmission=s.transmissionFactor),s.transmissionTexture!==void 0&&a.push(n.assignTexture(t,"transmissionMap",s.transmissionTexture)),Promise.all(a)}}class yd{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_VOLUME}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];t.thickness=s.thicknessFactor!==void 0?s.thicknessFactor:0,s.thicknessTexture!==void 0&&a.push(n.assignTexture(t,"thicknessMap",s.thicknessTexture)),t.attenuationDistance=s.attenuationDistance||1/0;const o=s.attenuationColor||[1,1,1];return t.attenuationColor=new Ee().setRGB(o[0],o[1],o[2],st),Promise.all(a)}}class Md{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_IOR}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser.json.materials[e];if(!n.extensions||!n.extensions[this.name])return Promise.resolve();const i=n.extensions[this.name];return t.ior=i.ior!==void 0?i.ior:1.5,Promise.resolve()}}class Sd{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_SPECULAR}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];t.specularIntensity=s.specularFactor!==void 0?s.specularFactor:1,s.specularTexture!==void 0&&a.push(n.assignTexture(t,"specularIntensityMap",s.specularTexture));const o=s.specularColorFactor||[1,1,1];return t.specularColor=new Ee().setRGB(o[0],o[1],o[2],st),s.specularColorTexture!==void 0&&a.push(n.assignTexture(t,"specularColorMap",s.specularColorTexture,ft)),Promise.all(a)}}class Ed{constructor(e){this.parser=e,this.name=Ie.EXT_MATERIALS_BUMP}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];return t.bumpScale=s.bumpFactor!==void 0?s.bumpFactor:1,s.bumpTexture!==void 0&&a.push(n.assignTexture(t,"bumpMap",s.bumpTexture)),Promise.all(a)}}class Td{constructor(e){this.parser=e,this.name=Ie.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const t=this.parser.json.materials[e];return t.extensions&&t.extensions[this.name]?fn:null}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const a=[],s=i.extensions[this.name];return s.anisotropyStrength!==void 0&&(t.anisotropy=s.anisotropyStrength),s.anisotropyRotation!==void 0&&(t.anisotropyRotation=s.anisotropyRotation),s.anisotropyTexture!==void 0&&a.push(n.assignTexture(t,"anisotropyMap",s.anisotropyTexture)),Promise.all(a)}}class bd{constructor(e){this.parser=e,this.name=Ie.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;const a=i.extensions[this.name],s=t.options.ktx2Loader;if(!s){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,a.source,s)}}class Ad{constructor(e){this.parser=e,this.name=Ie.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,a=i.textures[e];if(!a.extensions||!a.extensions[t])return null;const s=a.extensions[t],o=i.images[s.source];let c=n.textureLoader;if(o.uri){const l=n.options.manager.getHandler(o.uri);l!==null&&(c=l)}return this.detectSupport().then(function(l){if(l)return n.loadTextureImage(e,s.source,c);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class wd{constructor(e){this.parser=e,this.name=Ie.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,a=i.textures[e];if(!a.extensions||!a.extensions[t])return null;const s=a.extensions[t],o=i.images[s.source];let c=n.textureLoader;if(o.uri){const l=n.options.manager.getHandler(o.uri);l!==null&&(c=l)}return this.detectSupport().then(function(l){if(l)return n.loadTextureImage(e,s.source,c);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Rd{constructor(e){this.name=Ie.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],a=this.parser.getDependency("buffer",i.buffer),s=this.parser.options.meshoptDecoder;if(!s||!s.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return a.then(function(o){const c=i.byteOffset||0,l=i.byteLength||0,h=i.count,u=i.byteStride,d=new Uint8Array(o,c,l);return s.decodeGltfBufferAsync?s.decodeGltfBufferAsync(h,u,d,i.mode,i.filter).then(function(p){return p.buffer}):s.ready.then(function(){const p=new ArrayBuffer(h*u);return s.decodeGltfBuffer(new Uint8Array(p),h,u,d,i.mode,i.filter),p})})}return null}}class Cd{constructor(e){this.name=Ie.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=t.meshes[n.mesh];for(const c of i.primitives)if(c.mode!==Ct.TRIANGLES&&c.mode!==Ct.TRIANGLE_STRIP&&c.mode!==Ct.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,s=[],o={};for(const c in a)s.push(this.parser.getDependency("accessor",a[c]).then(l=>(o[c]=l,o[c])));return s.length<1?null:(s.push(this.parser.createNodeMesh(e)),Promise.all(s).then(c=>{const l=c.pop(),h=l.isGroup?l.children:[l],u=c[0].count,d=[];for(const p of h){const m=new Te,v=new P,_=new Pt,f=new P(1,1,1),x=new Iu(p.geometry,p.material,u);for(let g=0;g<u;g++)o.TRANSLATION&&v.fromBufferAttribute(o.TRANSLATION,g),o.ROTATION&&_.fromBufferAttribute(o.ROTATION,g),o.SCALE&&f.fromBufferAttribute(o.SCALE,g),x.setMatrixAt(g,m.compose(v,_,f));for(const g in o)if(g==="_COLOR_0"){const y=o[g];x.instanceColor=new ts(y.array,y.itemSize,y.normalized)}else g!=="TRANSLATION"&&g!=="ROTATION"&&g!=="SCALE"&&p.geometry.setAttribute(g,o[g]);ke.prototype.copy.call(x,p),this.parser.assignFinalMaterial(x),d.push(x)}return l.isGroup?(l.clear(),l.add(...d),l):d[0]}))}}const ql="glTF",Pd=1313821514,Ld=5130562;class Id{constructor(e){this.name=Ie.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,12),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==ql)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-12,a=new DataView(e,12);let s=0;for(;s<i;){const o=a.getUint32(s,!0);s+=4;const c=a.getUint32(s,!0);if(s+=4,c===Pd){const l=new Uint8Array(e,12+s,o);this.content=n.decode(l)}else if(c===Ld){const l=12+s;this.body=e.slice(l,l+o)}s+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class Nd{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=Ie.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,i=this.dracoLoader,a=e.extensions[this.name].bufferView,s=e.extensions[this.name].attributes,o={},c={},l={};for(const h in s){const u=ss[h]||h.toLowerCase();o[u]=s[h]}for(const h in e.attributes){const u=ss[h]||h.toLowerCase();if(s[h]!==void 0){const d=n.accessors[e.attributes[h]],p=yi[d.componentType];l[u]=p.name,c[u]=d.normalized===!0}}return t.getDependency("bufferView",a).then(function(h){return new Promise(function(u,d){i.decodeDracoFile(h,function(p){for(const m in p.attributes){const v=p.attributes[m],_=c[m];_!==void 0&&(v.normalized=_)}u(p)},o,l,st,d)})})}}class Ud{constructor(){this.name=Ie.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord!==void 0&&t.texCoord!==e.channel||t.offset!==void 0||t.rotation!==void 0||t.scale!==void 0)&&(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class Dd{constructor(){this.name=Ie.KHR_MESH_QUANTIZATION}}class Yl extends Qi{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,a=e*i*3+i;for(let s=0;s!==i;s++)t[s]=n[a+s];return t}interpolate_(e,t,n,i){const a=this.resultBuffer,s=this.sampleValues,o=this.valueSize,c=2*o,l=3*o,h=i-t,u=(n-t)/h,d=u*u,p=d*u,m=e*l,v=m-l,_=-2*p+3*d,f=p-d,x=1-_,g=f-d+u;for(let y=0;y!==o;y++){const C=s[v+y+o],w=s[v+y+c]*h,T=s[m+y+o],U=s[m+y]*h;a[y]=x*C+g*w+_*T+f*U}return a}}const Od=new Pt;class Fd extends Yl{interpolate_(e,t,n,i){const a=super.interpolate_(e,t,n,i);return Od.fromArray(a).normalize().toArray(a),a}}const Ct={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},yi={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},al={9728:ut,9729:$e,9984:Ka,9985:Or,9986:fi,9987:wn},sl={33071:Vt,33648:Hr,10497:Ei},ka={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},ss={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Mn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Bd={CUBICSPLINE:void 0,LINEAR:bi,STEP:Ki},zd="OPAQUE",Hd="MASK",Vd="BLEND";function Gn(r,e,t){for(const n in t.extensions)r[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function En(r,e){e.extras!==void 0&&typeof e.extras=="object"&&Object.assign(r.userData,e.extras)}function kd(r,e){if(r.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)r.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(r.morphTargetInfluences.length===t.length){r.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)r.morphTargetDictionary[t[n]]=n}}}function Gd(r){let e;const t=r.extensions&&r.extensions[Ie.KHR_DRACO_MESH_COMPRESSION];if(e=t?"draco:"+t.bufferView+":"+t.indices+":"+Ga(t.attributes):r.indices+":"+Ga(r.attributes)+":"+r.mode,r.targets!==void 0)for(let n=0,i=r.targets.length;n<i;n++)e+=":"+Ga(r.targets[n]);return e}function Ga(r){let e="";const t=Object.keys(r).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+r[t[n]]+";";return e}function os(r){switch(r){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}const Wd=new Te;class Xd{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new dd,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=!1,a=-1;typeof navigator<"u"&&(n=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)===!0,i=navigator.userAgent.indexOf("Firefox")>-1,a=i?navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1]:-1),typeof createImageBitmap>"u"||n||i&&a<98?this.textureLoader=new qu(this.options.manager):this.textureLoader=new ed(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new $r(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,i=this.json,a=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(s){return s._markDefs&&s._markDefs()}),Promise.all(this._invokeAll(function(s){return s.beforeRoot&&s.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(s){const o={scene:s[0][i.scene||0],scenes:s[0],animations:s[1],cameras:s[2],asset:i.asset,parser:n,userData:{}};return Gn(a,o,i),En(o,i),Promise.all(n._invokeAll(function(c){return c.afterRoot&&c.afterRoot(o)})).then(function(){e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,a=t.length;i<a;i++){const s=t[i].joints;for(let o=0,c=s.length;o<c;o++)e[s[o]].isBone=!0}for(let i=0,a=e.length;i<a;i++){const s=e[i];s.mesh!==void 0&&(this._addNodeRef(this.meshCache,s.mesh),s.skin!==void 0&&(n[s.mesh].isSkinnedMesh=!0)),s.camera!==void 0&&this._addNodeRef(this.cameraCache,s.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const i=n.clone(),a=(s,o)=>{const c=this.associations.get(s);c!=null&&this.associations.set(o,c);for(const[l,h]of s.children.entries())a(h,o.children[l])};return a(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const i=e(t[n]);if(i)return i}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let i=0;i<t.length;i++){const a=e(t[i]);a&&n.push(a)}return n}getDependency(e,t){const n=e+":"+t;let i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(a){return a.loadNode&&a.loadNode(t)});break;case"mesh":i=this._invokeOne(function(a){return a.loadMesh&&a.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(a){return a.loadBufferView&&a.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(a){return a.loadMaterial&&a.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(a){return a.loadTexture&&a.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(a){return a.loadAnimation&&a.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(a){return a!=this&&a.getDependency&&a.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e)}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(a,s){return n.getDependency(e,s)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Ie.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(a,s){n.load(Yi.resolveURL(t.uri,i.path),a,void 0,function(){s(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const i=t.byteLength||0,a=t.byteOffset||0;return n.slice(a,a+i)})}loadAccessor(e){const t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){const s=ka[i.type],o=yi[i.componentType],c=i.normalized===!0,l=new o(i.count*s);return Promise.resolve(new _t(l,s,c))}const a=[];return i.bufferView!==void 0?a.push(this.getDependency("bufferView",i.bufferView)):a.push(null),i.sparse!==void 0&&(a.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),a.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(a).then(function(s){const o=s[0],c=ka[i.type],l=yi[i.componentType],h=l.BYTES_PER_ELEMENT,u=h*c,d=i.byteOffset||0,p=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,m=i.normalized===!0;let v,_;if(p&&p!==u){const f=Math.floor(d/p),x="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+f+":"+i.count;let g=t.cache.get(x);g||(v=new l(o,f*p,i.count*p/h),g=new wu(v,p/h),t.cache.add(x,g)),_=new ms(g,c,d%p/h,m)}else v=o===null?new l(i.count*c):new l(o,d,i.count*c),_=new _t(v,c,m);if(i.sparse!==void 0){const f=ka.SCALAR,x=yi[i.sparse.indices.componentType],g=i.sparse.indices.byteOffset||0,y=i.sparse.values.byteOffset||0,C=new x(s[1],g,i.sparse.count*f),w=new l(s[2],y,i.sparse.count*c);o!==null&&(_=new _t(_.array.slice(),_.itemSize,_.normalized));for(let T=0,U=C.length;T<U;T++){const L=C[T];if(_.setX(L,w[T*c]),c>=2&&_.setY(L,w[T*c+1]),c>=3&&_.setZ(L,w[T*c+2]),c>=4&&_.setW(L,w[T*c+3]),c>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}}return _})}loadTexture(e){const t=this.json,n=this.options,i=t.textures[e].source,a=t.images[i];let s=this.textureLoader;if(a.uri){const o=n.manager.getHandler(a.uri);o!==null&&(s=o)}return this.loadTextureImage(e,i,s)}loadTextureImage(e,t,n){const i=this,a=this.json,s=a.textures[e],o=a.images[t],c=(o.uri||o.bufferView)+":"+s.sampler;if(this.textureCache[c])return this.textureCache[c];const l=this.loadImageSource(t,n).then(function(h){h.flipY=!1,h.name=s.name||o.name||"",h.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(h.name=o.uri);const u=(a.samplers||{})[s.sampler]||{};return h.magFilter=al[u.magFilter]||$e,h.minFilter=al[u.minFilter]||wn,h.wrapS=sl[u.wrapS]||Ei,h.wrapT=sl[u.wrapT]||Ei,i.associations.set(h,{textures:e}),h}).catch(function(){return null});return this.textureCache[c]=l,l}loadImageSource(e,t){const n=this,i=this.json,a=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(u=>u.clone());const s=i.images[e],o=self.URL||self.webkitURL;let c=s.uri||"",l=!1;if(s.bufferView!==void 0)c=n.getDependency("bufferView",s.bufferView).then(function(u){l=!0;const d=new Blob([u],{type:s.mimeType});return c=o.createObjectURL(d),c});else if(s.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const h=Promise.resolve(c).then(function(u){return new Promise(function(d,p){let m=d;t.isImageBitmapLoader===!0&&(m=function(v){const _=new it(v);_.needsUpdate=!0,d(_)}),t.load(Yi.resolveURL(u,a.path),m,void 0,p)})}).then(function(u){var d;return l===!0&&o.revokeObjectURL(c),u.userData.mimeType=s.mimeType||((d=s.uri).search(/\.jpe?g($|\?)/i)>0||d.search(/^data\:image\/jpeg/)===0?"image/jpeg":d.search(/\.webp($|\?)/i)>0||d.search(/^data\:image\/webp/)===0?"image/webp":"image/png"),u}).catch(function(u){throw u});return this.sourceCache[e]=h,h}assignTexture(e,t,n,i){const a=this;return this.getDependency("texture",n.index).then(function(s){if(!s)return null;if(n.texCoord!==void 0&&n.texCoord>0&&((s=s.clone()).channel=n.texCoord),a.extensions[Ie.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[Ie.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const c=a.associations.get(s);s=a.extensions[Ie.KHR_TEXTURE_TRANSFORM].extendTexture(s,o),a.associations.set(s,c)}}return i!==void 0&&(s.colorSpace=i),e[t]=s,s})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const i=t.attributes.tangent===void 0,a=t.attributes.color!==void 0,s=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let c=this.cache.get(o);c||(c=new kl,Yt.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,c.sizeAttenuation=!1,this.cache.add(o,c)),n=c}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let c=this.cache.get(o);c||(c=new vs,Yt.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,this.cache.add(o,c)),n=c}if(i||a||s){let o="ClonedMaterial:"+n.uuid+":";i&&(o+="derivative-tangents:"),a&&(o+="vertex-colors:"),s&&(o+="flat-shading:");let c=this.cache.get(o);c||(c=n.clone(),a&&(c.vertexColors=!0),s&&(c.flatShading=!0),i&&(c.normalScale&&(c.normalScale.y*=-1),c.clearcoatNormalScale&&(c.clearcoatNormalScale.y*=-1)),this.cache.add(o,c),this.associations.set(c,this.associations.get(n))),n=c}e.material=n}getMaterialType(){return is}loadMaterial(e){const t=this,n=this.json,i=this.extensions,a=n.materials[e];let s;const o={},c=[];if((a.extensions||{})[Ie.KHR_MATERIALS_UNLIT]){const h=i[Ie.KHR_MATERIALS_UNLIT];s=h.getMaterialType(),c.push(h.extendParams(o,a,t))}else{const h=a.pbrMetallicRoughness||{};if(o.color=new Ee(1,1,1),o.opacity=1,Array.isArray(h.baseColorFactor)){const u=h.baseColorFactor;o.color.setRGB(u[0],u[1],u[2],st),o.opacity=u[3]}h.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",h.baseColorTexture,ft)),o.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,o.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",h.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",h.metallicRoughnessTexture))),s=this._invokeOne(function(u){return u.getMaterialType&&u.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(u){return u.extendMaterialParams&&u.extendMaterialParams(e,o)})))}a.doubleSided===!0&&(o.side=2);const l=a.alphaMode||zd;if(l===Vd?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Hd&&(o.alphaTest=a.alphaCutoff!==void 0?a.alphaCutoff:.5)),a.normalTexture!==void 0&&s!==hn&&(c.push(t.assignTexture(o,"normalMap",a.normalTexture)),o.normalScale=new _e(1,1),a.normalTexture.scale!==void 0)){const h=a.normalTexture.scale;o.normalScale.set(h,h)}if(a.occlusionTexture!==void 0&&s!==hn&&(c.push(t.assignTexture(o,"aoMap",a.occlusionTexture)),a.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=a.occlusionTexture.strength)),a.emissiveFactor!==void 0&&s!==hn){const h=a.emissiveFactor;o.emissive=new Ee().setRGB(h[0],h[1],h[2],st)}return a.emissiveTexture!==void 0&&s!==hn&&c.push(t.assignTexture(o,"emissiveMap",a.emissiveTexture,ft)),Promise.all(c).then(function(){const h=new s(o);return a.name&&(h.name=a.name),En(h,a),t.associations.set(h,{materials:e}),a.extensions&&Gn(i,h,a),h})}createUniqueName(e){const t=Be.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,i=this.primitiveCache;function a(o){return n[Ie.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(c){return ol(c,o,t)})}const s=[];for(let o=0,c=e.length;o<c;o++){const l=e[o],h=Gd(l),u=i[h];if(u)s.push(u.promise);else{let d;d=l.extensions&&l.extensions[Ie.KHR_DRACO_MESH_COMPRESSION]?a(l):ol(new Mt,l,t),i[h]={primitive:l,promise:d},s.push(d)}}return Promise.all(s)}loadMesh(e){const t=this,n=this.json,i=this.extensions,a=n.meshes[e],s=a.primitives,o=[];for(let l=0,h=s.length;l<h;l++){const u=s[l].material===void 0?((c=this.cache).DefaultMaterial===void 0&&(c.DefaultMaterial=new is({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:dn})),c.DefaultMaterial):this.getDependency("material",s[l].material);o.push(u)}var c;return o.push(t.loadGeometries(s)),Promise.all(o).then(function(l){const h=l.slice(0,l.length-1),u=l[l.length-1],d=[];for(let m=0,v=u.length;m<v;m++){const _=u[m],f=s[m];let x;const g=h[m];if(f.mode===Ct.TRIANGLES||f.mode===Ct.TRIANGLE_STRIP||f.mode===Ct.TRIANGLE_FAN||f.mode===void 0)x=a.isSkinnedMesh===!0?new Cu(_,g):new gt(_,g),x.isSkinnedMesh===!0&&x.normalizeSkinWeights(),f.mode===Ct.TRIANGLE_STRIP?x.geometry=rl(x.geometry,1):f.mode===Ct.TRIANGLE_FAN&&(x.geometry=rl(x.geometry,2));else if(f.mode===Ct.LINES)x=new Vl(_,g);else if(f.mode===Ct.LINE_STRIP)x=new Jr(_,g);else if(f.mode===Ct.LINE_LOOP)x=new Nu(_,g);else{if(f.mode!==Ct.POINTS)throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+f.mode);x=new Uu(_,g)}Object.keys(x.geometry.morphAttributes).length>0&&kd(x,a),x.name=t.createUniqueName(a.name||"mesh_"+e),En(x,a),f.extensions&&Gn(i,x,f),t.assignFinalMaterial(x),d.push(x)}for(let m=0,v=d.length;m<v;m++)t.associations.set(d[m],{meshes:e,primitives:m});if(d.length===1)return a.extensions&&Gn(i,d[0],a),d[0];const p=new un;a.extensions&&Gn(i,p,a),t.associations.set(p,{meshes:e});for(let m=0,v=d.length;m<v;m++)p.add(d[m]);return p})}loadCamera(e){let t;const n=this.json.cameras[e],i=n[n.type];if(i)return n.type==="perspective"?t=new mt(jr.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new ps(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),En(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let i=0,a=t.joints.length;i<a;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const a=i.pop(),s=i,o=[],c=[];for(let l=0,h=s.length;l<h;l++){const u=s[l];if(u){o.push(u);const d=new Te;a!==null&&d.fromArray(a.array,16*l),c.push(d)}}return new _s(o,c)})}loadAnimation(e){const t=this.json,n=this,i=t.animations[e],a=i.name?i.name:"animation_"+e,s=[],o=[],c=[],l=[],h=[];for(let u=0,d=i.channels.length;u<d;u++){const p=i.channels[u],m=i.samplers[p.sampler],v=p.target,_=v.node,f=i.parameters!==void 0?i.parameters[m.input]:m.input,x=i.parameters!==void 0?i.parameters[m.output]:m.output;v.node!==void 0&&(s.push(this.getDependency("node",_)),o.push(this.getDependency("accessor",f)),c.push(this.getDependency("accessor",x)),l.push(m),h.push(v))}return Promise.all([Promise.all(s),Promise.all(o),Promise.all(c),Promise.all(l),Promise.all(h)]).then(function(u){const d=u[0],p=u[1],m=u[2],v=u[3],_=u[4],f=[];for(let x=0,g=d.length;x<g;x++){const y=d[x],C=p[x],w=m[x],T=v[x],U=_[x];if(y===void 0)continue;y.updateMatrix&&y.updateMatrix();const L=n._createAnimationTracks(y,C,w,T,U);if(L)for(let B=0;B<L.length;B++)f.push(L[B])}return new Hu(a,void 0,f)})}createNodeMesh(e){const t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(a){const s=n._getNodeRef(n.meshCache,i.mesh,a);return i.weights!==void 0&&s.traverse(function(o){if(o.isMesh)for(let c=0,l=i.weights.length;c<l;c++)o.morphTargetInfluences[c]=i.weights[c]}),s})}loadNode(e){const t=this,n=this.json.nodes[e],i=t._loadNodeShallow(e),a=[],s=n.children||[];for(let c=0,l=s.length;c<l;c++)a.push(t.getDependency("node",s[c]));const o=n.skin===void 0?Promise.resolve(null):t.getDependency("skin",n.skin);return Promise.all([i,Promise.all(a),o]).then(function(c){const l=c[0],h=c[1],u=c[2];u!==null&&l.traverse(function(d){d.isSkinnedMesh&&d.bind(u,Wd)});for(let d=0,p=h.length;d<p;d++)l.add(h[d]);return l})}_loadNodeShallow(e){const t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const a=t.nodes[e],s=a.name?i.createUniqueName(a.name):"",o=[],c=i._invokeOne(function(l){return l.createNodeMesh&&l.createNodeMesh(e)});return c&&o.push(c),a.camera!==void 0&&o.push(i.getDependency("camera",a.camera).then(function(l){return i._getNodeRef(i.cameraCache,a.camera,l)})),i._invokeAll(function(l){return l.createNodeAttachment&&l.createNodeAttachment(e)}).forEach(function(l){o.push(l)}),this.nodeCache[e]=Promise.all(o).then(function(l){let h;if(h=a.isBone===!0?new Hl:l.length>1?new un:l.length===1?l[0]:new ke,h!==l[0])for(let u=0,d=l.length;u<d;u++)h.add(l[u]);if(a.name&&(h.userData.name=a.name,h.name=s),En(h,a),a.extensions&&Gn(n,h,a),a.matrix!==void 0){const u=new Te;u.fromArray(a.matrix),h.applyMatrix4(u)}else a.translation!==void 0&&h.position.fromArray(a.translation),a.rotation!==void 0&&h.quaternion.fromArray(a.rotation),a.scale!==void 0&&h.scale.fromArray(a.scale);return i.associations.has(h)||i.associations.set(h,{}),i.associations.get(h).nodes=e,h}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],i=this,a=new un;n.name&&(a.name=i.createUniqueName(n.name)),En(a,n),n.extensions&&Gn(t,a,n);const s=n.nodes||[],o=[];for(let c=0,l=s.length;c<l;c++)o.push(i.getDependency("node",s[c]));return Promise.all(o).then(function(c){for(let l=0,h=c.length;l<h;l++)a.add(c[l]);return i.associations=(l=>{const h=new Map;for(const[u,d]of i.associations)(u instanceof Yt||u instanceof it)&&h.set(u,d);return l.traverse(u=>{const d=i.associations.get(u);d!=null&&h.set(u,d)}),h})(a),a})}_createAnimationTracks(e,t,n,i,a){const s=[],o=e.name?e.name:e.uuid,c=[];let l;switch(Mn[a.path]===Mn.weights?e.traverse(function(d){d.morphTargetInfluences&&c.push(d.name?d.name:d.uuid)}):c.push(o),Mn[a.path]){case Mn.weights:l=Ci;break;case Mn.rotation:l=Yn;break;case Mn.position:case Mn.scale:l=Pi;break;default:n.itemSize===1?l=Ci:l=Pi}const h=i.interpolation!==void 0?Bd[i.interpolation]:bi,u=this._getArrayFromAccessor(n);for(let d=0,p=c.length;d<p;d++){const m=new l(c[d]+"."+Mn[a.path],t.array,u,h);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(m),s.push(m)}return s}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=os(t.constructor),i=new Float32Array(t.length);for(let a=0,s=t.length;a<s;a++)i[a]=t[a]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(t){return new(this instanceof Yn?Fd:Yl)(this.times,this.values,this.getValueSize()/3,t)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function ol(r,e,t){const n=e.attributes,i=[];function a(s,o){return t.getDependency("accessor",s).then(function(c){r.setAttribute(o,c)})}for(const s in n){const o=ss[s]||s.toLowerCase();o in r.attributes||i.push(a(n[s],o))}if(e.indices!==void 0&&!r.index){const s=t.getDependency("accessor",e.indices).then(function(o){r.setIndex(o)});i.push(s)}return He.workingColorSpace,En(r,e),function(s,o,c){const l=o.attributes,h=new pn;if(l.POSITION===void 0)return;{const p=c.json.accessors[l.POSITION],m=p.min,v=p.max;if(m===void 0||v===void 0)return;if(h.set(new P(m[0],m[1],m[2]),new P(v[0],v[1],v[2])),p.normalized){const _=os(yi[p.componentType]);h.min.multiplyScalar(_),h.max.multiplyScalar(_)}}const u=o.targets;if(u!==void 0){const p=new P,m=new P;for(let v=0,_=u.length;v<_;v++){const f=u[v];if(f.POSITION!==void 0){const x=c.json.accessors[f.POSITION],g=x.min,y=x.max;if(g!==void 0&&y!==void 0){if(m.setX(Math.max(Math.abs(g[0]),Math.abs(y[0]))),m.setY(Math.max(Math.abs(g[1]),Math.abs(y[1]))),m.setZ(Math.max(Math.abs(g[2]),Math.abs(y[2]))),x.normalized){const C=os(yi[x.componentType]);m.multiplyScalar(C)}p.max(m)}}}h.expandByVector(p)}s.boundingBox=h;const d=new Jt;h.getCenter(d.center),d.radius=h.min.distanceTo(h.max)/2,s.boundingSphere=d}(r,e,t),Promise.all(i).then(function(){return e.targets!==void 0?function(s,o,c){let l=!1,h=!1,u=!1;for(let v=0,_=o.length;v<_;v++){const f=o[v];if(f.POSITION!==void 0&&(l=!0),f.NORMAL!==void 0&&(h=!0),f.COLOR_0!==void 0&&(u=!0),l&&h&&u)break}if(!l&&!h&&!u)return Promise.resolve(s);const d=[],p=[],m=[];for(let v=0,_=o.length;v<_;v++){const f=o[v];if(l){const x=f.POSITION!==void 0?c.getDependency("accessor",f.POSITION):s.attributes.position;d.push(x)}if(h){const x=f.NORMAL!==void 0?c.getDependency("accessor",f.NORMAL):s.attributes.normal;p.push(x)}if(u){const x=f.COLOR_0!==void 0?c.getDependency("accessor",f.COLOR_0):s.attributes.color;m.push(x)}}return Promise.all([Promise.all(d),Promise.all(p),Promise.all(m)]).then(function(v){const _=v[0],f=v[1],x=v[2];return l&&(s.morphAttributes.position=_),h&&(s.morphAttributes.normal=f),u&&(s.morphAttributes.color=x),s.morphTargetsRelative=!0,s})}(r,e.targets,t):r})}class jd extends ju{constructor(e){super(e),this.type=cn}parse(e){const t=function(m,v){switch(m){case 1:throw new Error("THREE.RGBELoader: Read Error: "+(v||""));case 2:throw new Error("THREE.RGBELoader: Write Error: "+(v||""));case 3:throw new Error("THREE.RGBELoader: Bad File Format: "+(v||""));default:throw new Error("THREE.RGBELoader: Memory Error: "+(v||""))}},n=function(m,v,_){v=v||1024;let f=m.pos,x=-1,g=0,y="",C=String.fromCharCode.apply(null,new Uint16Array(m.subarray(f,f+128)));for(;0>(x=C.indexOf(`
`))&&g<v&&f<m.byteLength;)y+=C,g+=C.length,f+=128,C+=String.fromCharCode.apply(null,new Uint16Array(m.subarray(f,f+128)));return-1<x&&(_!==!1&&(m.pos+=g+x+1),y+C.slice(0,x))},i=function(m,v,_,f){const x=m[v+3],g=Math.pow(2,x-128)/255;_[f+0]=m[v+0]*g,_[f+1]=m[v+1]*g,_[f+2]=m[v+2]*g,_[f+3]=1},a=function(m,v,_,f){const x=m[v+3],g=Math.pow(2,x-128)/255;_[f+0]=dr.toHalfFloat(Math.min(m[v+0]*g,65504)),_[f+1]=dr.toHalfFloat(Math.min(m[v+1]*g,65504)),_[f+2]=dr.toHalfFloat(Math.min(m[v+2]*g,65504)),_[f+3]=dr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;const o=function(m){const v=/^\s*GAMMA\s*=\s*(\d+(\.\d+)?)\s*$/,_=/^\s*EXPOSURE\s*=\s*(\d+(\.\d+)?)\s*$/,f=/^\s*FORMAT=(\S+)\s*$/,x=/^\s*\-Y\s+(\d+)\s+\+X\s+(\d+)\s*$/,g={valid:0,string:"",comments:"",programtype:"RGBE",format:"",gamma:1,exposure:1,width:0,height:0};let y,C;for((m.pos>=m.byteLength||!(y=n(m)))&&t(1,"no header found"),(C=y.match(/^#\?(\S+)/))||t(3,"bad initial token"),g.valid|=1,g.programtype=C[1],g.string+=y+`
...
`;return 2&g.valid||t(3,"missing format specifier"),4&g.valid||t(3,"missing image size specifier"),g}(s),c=o.width,l=o.height,h=function(m,v,_){const f=v;if(f<8||f>32767||m[0]!==2||m[1]!==2||128&m[2])return new Uint8Array(m);f!==(m[2]<<8|m[3])&&t(3,"wrong scanline width");const x=new Uint8Array(4*v*_);x.length||t(4,"unable to allocate buffer space");let g=0,y=0;const C=4*f,w=new Uint8Array(4),T=new Uint8Array(C);let U=_;for(;U>0&&y<m.byteLength;){y+4>m.byteLength&&t(1),w[0]=m[y++],w[1]=m[y++],w[2]=m[y++],w[3]=m[y++],w[0]==2&&w[1]==2&&(w[2]<<8|w[3])==f||t(3,"bad rgbe scanline format");let L,B=0;for(;B<C&&y<m.byteLength;){L=m[y++];const A=L>128;if(A&&(L-=128),(L===0||B+L>C)&&t(3,"bad scanline data"),A){const k=m[y++];for(let Z=0;Z<L;Z++)T[B++]=k}else T.set(m.subarray(y,y+L),B),B+=L,y+=L}const re=f;for(let A=0;A<re;A++){let k=0;x[g]=T[A+k],k+=f,x[g+1]=T[A+k],k+=f,x[g+2]=T[A+k],k+=f,x[g+3]=T[A+k],g+=4}U--}return x}(s.subarray(s.pos),c,l);let u,d,p;switch(this.type){case Tt:p=h.length/4;const m=new Float32Array(4*p);for(let _=0;_<p;_++)i(h,4*_,m,4*_);u=m,d=Tt;break;case cn:p=h.length/4;const v=new Uint16Array(4*p);for(let _=0;_<p;_++)a(h,4*_,v,4*_);u=v,d=cn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:c,height:l,data:u,header:o.string,gamma:o.gamma,exposure:o.exposure,type:d}}setDataType(e){return this.type=e,this}load(e,t,n,i){return super.load(e,function(a,s){switch(a.type){case Tt:case cn:a.colorSpace=st,a.minFilter=$e,a.magFilter=$e,a.generateMipmaps=!1,a.flipY=!0}t&&t(a,s)},n,i)}}class Li{static createButton(e,t={}){const n=document.createElement("button");function i(){n.style.display="",n.style.cursor="auto",n.style.left="calc(50% - 75px)",n.style.width="150px",n.onmouseenter=null,n.onmouseleave=null,n.onclick=null}function a(s){s.style.position="absolute",s.style.bottom="20px",s.style.padding="12px 6px",s.style.border="1px solid #fff",s.style.borderRadius="4px",s.style.background="rgba(0,0,0,0.1)",s.style.color="#fff",s.style.font="normal 13px sans-serif",s.style.textAlign="center",s.style.opacity="0.5",s.style.outline="none",s.style.zIndex="999"}if("xr"in navigator)return n.id="VRButton",n.style.display="none",a(n),navigator.xr.isSessionSupported("immersive-vr").then(function(s){s?function(){let o=null;async function c(u){u.addEventListener("end",l),await e.xr.setSession(u),n.textContent="EXIT VR",o=u}function l(){o.removeEventListener("end",l),n.textContent="ENTER VR",o=null}n.style.display="",n.style.cursor="pointer",n.style.left="calc(50% - 50px)",n.style.width="100px",n.textContent="ENTER VR";const h={...t,optionalFeatures:["local-floor","bounded-floor","layers",...t.optionalFeatures||[]]};n.onmouseenter=function(){n.style.opacity="1.0"},n.onmouseleave=function(){n.style.opacity="0.5"},n.onclick=function(){o===null?navigator.xr.requestSession("immersive-vr",h).then(c):(o.end(),navigator.xr.offerSession!==void 0&&navigator.xr.offerSession("immersive-vr",h).then(c).catch(u=>{}))},navigator.xr.offerSession!==void 0&&navigator.xr.offerSession("immersive-vr",h).then(c).catch(u=>{})}():(i(),n.textContent="VR NOT SUPPORTED"),s&&Li.xrSessionIsGranted&&n.click()}).catch(function(s){i(),n.textContent="VR NOT ALLOWED"}),n;{const s=document.createElement("a");return window.isSecureContext===!1?(s.href=document.location.href.replace(/^http:/,"https:"),s.innerHTML="WEBXR NEEDS HTTPS"):(s.href="https://immersiveweb.dev/",s.innerHTML="WEBXR NOT AVAILABLE"),s.style.left="calc(50% - 90px)",s.style.width="180px",s.style.textDecoration="none",a(s),s}}static registerSessionGrantedListener(){if(typeof navigator<"u"&&"xr"in navigator){if(/WebXRViewer\//i.test(navigator.userAgent))return;navigator.xr.addEventListener("sessiongranted",()=>{Li.xrSessionIsGranted=!0})}}}Li.xrSessionIsGranted=!1,Li.registerSessionGrantedListener();const qe={Handedness:Object.freeze({NONE:"none",LEFT:"left",RIGHT:"right"}),ComponentState:Object.freeze({DEFAULT:"default",TOUCHED:"touched",PRESSED:"pressed"}),ComponentProperty:Object.freeze({BUTTON:"button",X_AXIS:"xAxis",Y_AXIS:"yAxis",STATE:"state"}),ComponentType:Object.freeze({TRIGGER:"trigger",SQUEEZE:"squeeze",TOUCHPAD:"touchpad",THUMBSTICK:"thumbstick",BUTTON:"button"}),ButtonTouchThreshold:.05,AxisTouchThreshold:.1,VisualResponseProperty:Object.freeze({TRANSFORM:"transform",VISIBILITY:"visibility"})};async function ll(r){const e=await fetch(r);if(e.ok)return e.json();throw new Error(e.statusText)}async function qd(r,e,t=null,n=!0){if(!r)throw new Error("No xrInputSource supplied");if(!e)throw new Error("No basePath supplied");const i=await async function(c){if(!c)throw new Error("No basePath supplied");return await ll(`${c}/profilesList.json`)}(e);let a;if(r.profiles.some(c=>{const l=i[c];return l&&(a={profileId:c,profilePath:`${e}/${l.path}`,deprecated:!!l.deprecated}),!!a}),!a){if(!t)throw new Error("No matching profile name found");const c=i[t];if(!c)throw new Error(`No matching profile name found and default profile "${t}" missing.`);a={profileId:t,profilePath:`${e}/${c.path}`,deprecated:!!c.deprecated}}const s=await ll(a.profilePath);let o;if(n){let c;if(c=r.handedness==="any"?s.layouts[Object.keys(s.layouts)[0]]:s.layouts[r.handedness],!c)throw new Error(`No matching handedness, ${r.handedness}, in profile ${a.profileId}`);c.assetPath&&(o=a.profilePath.replace("profile.json",c.assetPath))}return{profile:s,assetPath:o}}const Yd={xAxis:0,yAxis:0,button:0,state:qe.ComponentState.DEFAULT};class Kd{constructor(e){this.componentProperty=e.componentProperty,this.states=e.states,this.valueNodeName=e.valueNodeName,this.valueNodeProperty=e.valueNodeProperty,this.valueNodeProperty===qe.VisualResponseProperty.TRANSFORM&&(this.minNodeName=e.minNodeName,this.maxNodeName=e.maxNodeName),this.value=0,this.updateFromComponent(Yd)}updateFromComponent({xAxis:e,yAxis:t,button:n,state:i}){const{normalizedXAxis:a,normalizedYAxis:s}=function(o=0,c=0){let l=o,h=c;if(Math.sqrt(o*o+c*c)>1){const u=Math.atan2(c,o);l=Math.cos(u),h=Math.sin(u)}return{normalizedXAxis:.5*l+.5,normalizedYAxis:.5*h+.5}}(e,t);switch(this.componentProperty){case qe.ComponentProperty.X_AXIS:this.value=this.states.includes(i)?a:.5;break;case qe.ComponentProperty.Y_AXIS:this.value=this.states.includes(i)?s:.5;break;case qe.ComponentProperty.BUTTON:this.value=this.states.includes(i)?n:0;break;case qe.ComponentProperty.STATE:this.valueNodeProperty===qe.VisualResponseProperty.VISIBILITY?this.value=this.states.includes(i):this.value=this.states.includes(i)?1:0;break;default:throw new Error(`Unexpected visualResponse componentProperty ${this.componentProperty}`)}}}class Zd{constructor(e,t){if(!(e&&t&&t.visualResponses&&t.gamepadIndices&&Object.keys(t.gamepadIndices).length!==0))throw new Error("Invalid arguments supplied");this.id=e,this.type=t.type,this.rootNodeName=t.rootNodeName,this.touchPointNodeName=t.touchPointNodeName,this.visualResponses={},Object.keys(t.visualResponses).forEach(n=>{const i=new Kd(t.visualResponses[n]);this.visualResponses[n]=i}),this.gamepadIndices=Object.assign({},t.gamepadIndices),this.values={state:qe.ComponentState.DEFAULT,button:this.gamepadIndices.button!==void 0?0:void 0,xAxis:this.gamepadIndices.xAxis!==void 0?0:void 0,yAxis:this.gamepadIndices.yAxis!==void 0?0:void 0}}get data(){return{id:this.id,...this.values}}updateFromGamepad(e){if(this.values.state=qe.ComponentState.DEFAULT,this.gamepadIndices.button!==void 0&&e.buttons.length>this.gamepadIndices.button){const t=e.buttons[this.gamepadIndices.button];this.values.button=t.value,this.values.button=this.values.button<0?0:this.values.button,this.values.button=this.values.button>1?1:this.values.button,t.pressed||this.values.button===1?this.values.state=qe.ComponentState.PRESSED:(t.touched||this.values.button>qe.ButtonTouchThreshold)&&(this.values.state=qe.ComponentState.TOUCHED)}this.gamepadIndices.xAxis!==void 0&&e.axes.length>this.gamepadIndices.xAxis&&(this.values.xAxis=e.axes[this.gamepadIndices.xAxis],this.values.xAxis=this.values.xAxis<-1?-1:this.values.xAxis,this.values.xAxis=this.values.xAxis>1?1:this.values.xAxis,this.values.state===qe.ComponentState.DEFAULT&&Math.abs(this.values.xAxis)>qe.AxisTouchThreshold&&(this.values.state=qe.ComponentState.TOUCHED)),this.gamepadIndices.yAxis!==void 0&&e.axes.length>this.gamepadIndices.yAxis&&(this.values.yAxis=e.axes[this.gamepadIndices.yAxis],this.values.yAxis=this.values.yAxis<-1?-1:this.values.yAxis,this.values.yAxis=this.values.yAxis>1?1:this.values.yAxis,this.values.state===qe.ComponentState.DEFAULT&&Math.abs(this.values.yAxis)>qe.AxisTouchThreshold&&(this.values.state=qe.ComponentState.TOUCHED)),Object.values(this.visualResponses).forEach(t=>{t.updateFromComponent(this.values)})}}class Jd{constructor(e,t,n){if(!e)throw new Error("No xrInputSource supplied");if(!t)throw new Error("No profile supplied");this.xrInputSource=e,this.assetUrl=n,this.id=t.profileId,this.layoutDescription=t.layouts[e.handedness],this.components={},Object.keys(this.layoutDescription.components).forEach(i=>{const a=this.layoutDescription.components[i];this.components[i]=new Zd(i,a)}),this.updateFromGamepad()}get gripSpace(){return this.xrInputSource.gripSpace}get targetRaySpace(){return this.xrInputSource.targetRaySpace}get data(){const e=[];return Object.values(this.components).forEach(t=>{e.push(t.data)}),e}updateFromGamepad(){Object.values(this.components).forEach(e=>{e.updateFromGamepad(this.xrInputSource.gamepad)})}}class $d extends ke{constructor(){super(),this.motionController=null,this.envMap=null}setEnvironmentMap(e){return this.envMap==e||(this.envMap=e,this.traverse(t=>{t.isMesh&&(t.material.envMap=this.envMap,t.material.needsUpdate=!0)})),this}updateMatrixWorld(e){super.updateMatrixWorld(e),this.motionController&&(this.motionController.updateFromGamepad(),Object.values(this.motionController.components).forEach(t=>{Object.values(t.visualResponses).forEach(n=>{const{valueNode:i,minNode:a,maxNode:s,value:o,valueNodeProperty:c}=n;i&&(c===qe.VisualResponseProperty.VISIBILITY?i.visible=o:c===qe.VisualResponseProperty.TRANSFORM&&(i.quaternion.slerpQuaternions(a.quaternion,s.quaternion,o),i.position.lerpVectors(a.position,s.position,o)))})}))}}function cl(r,e){(function(t,n){Object.values(t.components).forEach(i=>{const{type:a,touchPointNodeName:s,visualResponses:o}=i;if(a===qe.ComponentType.TOUCHPAD&&(i.touchPointNode=n.getObjectByName(s),i.touchPointNode)){const c=new ys(.001),l=new hn({color:255}),h=new gt(c,l);i.touchPointNode.add(h)}Object.values(o).forEach(c=>{const{valueNodeName:l,minNodeName:h,maxNodeName:u,valueNodeProperty:d}=c;d===qe.VisualResponseProperty.TRANSFORM&&(c.minNode=n.getObjectByName(h),c.maxNode=n.getObjectByName(u),!c.minNode||!c.maxNode)||(c.valueNode=n.getObjectByName(l),c.valueNode)})})})(r.motionController,e),r.envMap&&e.traverse(t=>{t.isMesh&&(t.material.envMap=r.envMap,t.material.needsUpdate=!0)}),r.add(e)}class Qd{constructor(e=null,t=null){this.gltfLoader=e,this.path="https://cdn.jsdelivr.net/npm/@webxr-input-profiles/assets@1.0/dist/profiles",this._assetCache={},this.onLoad=t,this.gltfLoader||(this.gltfLoader=new as)}setPath(e){return this.path=e,this}createControllerModel(e){const t=new $d;let n=null;return e.addEventListener("connected",i=>{const a=i.data;a.targetRayMode==="tracked-pointer"&&a.gamepad&&qd(a,this.path,"generic-trigger").then(({profile:s,assetPath:o})=>{t.motionController=new Jd(a,s,o);const c=this._assetCache[t.motionController.assetUrl];if(c)n=c.scene.clone(),cl(t,n),this.onLoad&&this.onLoad(n);else{if(!this.gltfLoader)throw new Error("GLTFLoader not set.");this.gltfLoader.setPath(""),this.gltfLoader.load(t.motionController.assetUrl,l=>{this._assetCache[t.motionController.assetUrl]=l,n=l.scene.clone(),cl(t,n),this.onLoad&&this.onLoad(n)},null,()=>{throw new Error(`Asset ${t.motionController.assetUrl} missing or malformed.`)})}}).catch(s=>{})}),e.addEventListener("disconnected",()=>{t.motionController=null,t.remove(n),n=null}),t}}const hl={type:"change"},Wa={type:"start"},ul={type:"end"},Nr=new Ii,dl=new Sn,ep=Math.cos(70*jr.DEG2RAD);class tp extends Zn{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new P,this.cursor=new P,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:zs,MIDDLE:Hs,RIGHT:Vs},this.touches={ONE:ks,TWO:Gs},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(R){R.addEventListener("keydown",E),this._domElementKeyEvents=R},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",E),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(hl),n.update(),a=i.NONE},this.update=function(){const R=new P,I=new Pt().setFromUnitVectors(e.up,new P(0,1,0)),G=I.clone().invert(),ie=new P,ce=new Pt,xe=new P,Se=2*Math.PI;return function(We=null){const fe=n.object.position;R.copy(fe).sub(n.target),R.applyQuaternion(I),o.setFromVector3(R),n.autoRotate&&a===i.NONE&&re(function(Ce){return Ce!==null?2*Math.PI/60*n.autoRotateSpeed*Ce:2*Math.PI/60/60*n.autoRotateSpeed}(We)),n.enableDamping?(o.theta+=c.theta*n.dampingFactor,o.phi+=c.phi*n.dampingFactor):(o.theta+=c.theta,o.phi+=c.phi);let ye=n.minAzimuthAngle,Fe=n.maxAzimuthAngle;isFinite(ye)&&isFinite(Fe)&&(ye<-Math.PI?ye+=Se:ye>Math.PI&&(ye-=Se),Fe<-Math.PI?Fe+=Se:Fe>Math.PI&&(Fe-=Se),o.theta=ye<=Fe?Math.max(ye,Math.min(Fe,o.theta)):o.theta>(ye+Fe)/2?Math.max(ye,o.theta):Math.min(Fe,o.theta)),o.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,o.phi)),o.makeSafe(),n.enableDamping===!0?n.target.addScaledVector(h,n.dampingFactor):n.target.add(h),n.target.sub(n.cursor),n.target.clampLength(n.minTargetRadius,n.maxTargetRadius),n.target.add(n.cursor);let ge=!1;if(n.zoomToCursor&&w||n.object.isOrthographicCamera)o.radius=q(o.radius);else{const Ce=o.radius;o.radius=q(o.radius*l),ge=Ce!=o.radius}if(R.setFromSpherical(o),R.applyQuaternion(G),fe.copy(n.target).add(R),n.object.lookAt(n.target),n.enableDamping===!0?(c.theta*=1-n.dampingFactor,c.phi*=1-n.dampingFactor,h.multiplyScalar(1-n.dampingFactor)):(c.set(0,0,0),h.set(0,0,0)),n.zoomToCursor&&w){let Ce=null;if(n.object.isPerspectiveCamera){const Ne=R.length();Ce=q(Ne*l);const rt=Ne-Ce;n.object.position.addScaledVector(y,rt),n.object.updateMatrixWorld(),ge=!!rt}else if(n.object.isOrthographicCamera){const Ne=new P(C.x,C.y,0);Ne.unproject(n.object);const rt=n.object.zoom;n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/l)),n.object.updateProjectionMatrix(),ge=rt!==n.object.zoom;const bt=new P(C.x,C.y,0);bt.unproject(n.object),n.object.position.sub(bt).add(Ne),n.object.updateMatrixWorld(),Ce=R.length()}else n.zoomToCursor=!1;Ce!==null&&(this.screenSpacePanning?n.target.set(0,0,-1).transformDirection(n.object.matrix).multiplyScalar(Ce).add(n.object.position):(Nr.origin.copy(n.object.position),Nr.direction.set(0,0,-1).transformDirection(n.object.matrix),Math.abs(n.object.up.dot(Nr.direction))<ep?e.lookAt(n.target):(dl.setFromNormalAndCoplanarPoint(n.object.up,n.target),Nr.intersectPlane(dl,n.target))))}else if(n.object.isOrthographicCamera){const Ce=n.object.zoom;n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/l)),Ce!==n.object.zoom&&(n.object.updateProjectionMatrix(),ge=!0)}return l=1,w=!1,!!(ge||ie.distanceToSquared(n.object.position)>s||8*(1-ce.dot(n.object.quaternion))>s||xe.distanceToSquared(n.target)>s)&&(n.dispatchEvent(hl),ie.copy(n.object.position),ce.copy(n.object.quaternion),xe.copy(n.target),!0)}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",D),n.domElement.removeEventListener("pointerdown",O),n.domElement.removeEventListener("pointercancel",H),n.domElement.removeEventListener("wheel",ae),n.domElement.removeEventListener("pointermove",N),n.domElement.removeEventListener("pointerup",H),n.domElement.getRootNode().removeEventListener("keydown",ne,{capture:!0}),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",E),n._domElementKeyEvents=null)};const n=this,i={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let a=i.NONE;const s=1e-6,o=new il,c=new il;let l=1;const h=new P,u=new _e,d=new _e,p=new _e,m=new _e,v=new _e,_=new _e,f=new _e,x=new _e,g=new _e,y=new P,C=new _e;let w=!1;const T=[],U={};let L=!1;function B(R){const I=Math.abs(.01*R);return Math.pow(.95,n.zoomSpeed*I)}function re(R){c.theta-=R}function A(R){c.phi-=R}const k=function(){const R=new P;return function(I,G){R.setFromMatrixColumn(G,0),R.multiplyScalar(-I),h.add(R)}}(),Z=function(){const R=new P;return function(I,G){n.screenSpacePanning===!0?R.setFromMatrixColumn(G,1):(R.setFromMatrixColumn(G,0),R.crossVectors(n.object.up,R)),R.multiplyScalar(I),h.add(R)}}(),se=function(){const R=new P;return function(I,G){const ie=n.domElement;if(n.object.isPerspectiveCamera){const ce=n.object.position;R.copy(ce).sub(n.target);let xe=R.length();xe*=Math.tan(n.object.fov/2*Math.PI/180),k(2*I*xe/ie.clientHeight,n.object.matrix),Z(2*G*xe/ie.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(k(I*(n.object.right-n.object.left)/n.object.zoom/ie.clientWidth,n.object.matrix),Z(G*(n.object.top-n.object.bottom)/n.object.zoom/ie.clientHeight,n.object.matrix)):n.enablePan=!1}}();function pe(R){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?l/=R:n.enableZoom=!1}function K(R){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?l*=R:n.enableZoom=!1}function j(R,I){if(!n.zoomToCursor)return;w=!0;const G=n.domElement.getBoundingClientRect(),ie=R-G.left,ce=I-G.top,xe=G.width,Se=G.height;C.x=ie/xe*2-1,C.y=-ce/Se*2+1,y.set(C.x,C.y,1).unproject(n.object).sub(n.object.position).normalize()}function q(R){return Math.max(n.minDistance,Math.min(n.maxDistance,R))}function ue(R){u.set(R.clientX,R.clientY)}function X(R){m.set(R.clientX,R.clientY)}function J(R){if(T.length===1)u.set(R.pageX,R.pageY);else{const I=ee(R),G=.5*(R.pageX+I.x),ie=.5*(R.pageY+I.y);u.set(G,ie)}}function me(R){if(T.length===1)m.set(R.pageX,R.pageY);else{const I=ee(R),G=.5*(R.pageX+I.x),ie=.5*(R.pageY+I.y);m.set(G,ie)}}function le(R){const I=ee(R),G=R.pageX-I.x,ie=R.pageY-I.y,ce=Math.sqrt(G*G+ie*ie);f.set(0,ce)}function b(R){if(T.length==1)d.set(R.pageX,R.pageY);else{const G=ee(R),ie=.5*(R.pageX+G.x),ce=.5*(R.pageY+G.y);d.set(ie,ce)}p.subVectors(d,u).multiplyScalar(n.rotateSpeed);const I=n.domElement;re(2*Math.PI*p.x/I.clientHeight),A(2*Math.PI*p.y/I.clientHeight),u.copy(d)}function M(R){if(T.length===1)v.set(R.pageX,R.pageY);else{const I=ee(R),G=.5*(R.pageX+I.x),ie=.5*(R.pageY+I.y);v.set(G,ie)}_.subVectors(v,m).multiplyScalar(n.panSpeed),se(_.x,_.y),m.copy(v)}function F(R){const I=ee(R),G=R.pageX-I.x,ie=R.pageY-I.y,ce=Math.sqrt(G*G+ie*ie);x.set(0,ce),g.set(0,Math.pow(x.y/f.y,n.zoomSpeed)),pe(g.y),f.copy(x),j(.5*(R.pageX+I.x),.5*(R.pageY+I.y))}function O(R){n.enabled!==!1&&(T.length===0&&(n.domElement.setPointerCapture(R.pointerId),n.domElement.addEventListener("pointermove",N),n.domElement.addEventListener("pointerup",H)),function(I){for(let G=0;G<T.length;G++)if(T[G]==I.pointerId)return!0;return!1}(R)||(function(I){T.push(I.pointerId)}(R),R.pointerType==="touch"?te(R):function(I){let G;switch(I.button){case 0:G=n.mouseButtons.LEFT;break;case 1:G=n.mouseButtons.MIDDLE;break;case 2:G=n.mouseButtons.RIGHT;break;default:G=-1}switch(G){case Hs:if(n.enableZoom===!1)return;(function(ie){j(ie.clientX,ie.clientX),f.set(ie.clientX,ie.clientY)})(I),a=i.DOLLY;break;case zs:if(I.ctrlKey||I.metaKey||I.shiftKey){if(n.enablePan===!1)return;X(I),a=i.PAN}else{if(n.enableRotate===!1)return;ue(I),a=i.ROTATE}break;case Vs:if(I.ctrlKey||I.metaKey||I.shiftKey){if(n.enableRotate===!1)return;ue(I),a=i.ROTATE}else{if(n.enablePan===!1)return;X(I),a=i.PAN}break;default:a=i.NONE}a!==i.NONE&&n.dispatchEvent(Wa)}(R)))}function N(R){n.enabled!==!1&&(R.pointerType==="touch"?function(I){switch(oe(I),a){case i.TOUCH_ROTATE:if(n.enableRotate===!1)return;b(I),n.update();break;case i.TOUCH_PAN:if(n.enablePan===!1)return;M(I),n.update();break;case i.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;(function(G){n.enableZoom&&F(G),n.enablePan&&M(G)})(I),n.update();break;case i.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;(function(G){n.enableZoom&&F(G),n.enableRotate&&b(G)})(I),n.update();break;default:a=i.NONE}}(R):function(I){switch(a){case i.ROTATE:if(n.enableRotate===!1)return;(function(G){d.set(G.clientX,G.clientY),p.subVectors(d,u).multiplyScalar(n.rotateSpeed);const ie=n.domElement;re(2*Math.PI*p.x/ie.clientHeight),A(2*Math.PI*p.y/ie.clientHeight),u.copy(d),n.update()})(I);break;case i.DOLLY:if(n.enableZoom===!1)return;(function(G){x.set(G.clientX,G.clientY),g.subVectors(x,f),g.y>0?pe(B(g.y)):g.y<0&&K(B(g.y)),f.copy(x),n.update()})(I);break;case i.PAN:if(n.enablePan===!1)return;(function(G){v.set(G.clientX,G.clientY),_.subVectors(v,m).multiplyScalar(n.panSpeed),se(_.x,_.y),m.copy(v),n.update()})(I)}}(R))}function H(R){switch(function(I){delete U[I.pointerId];for(let G=0;G<T.length;G++)if(T[G]==I.pointerId)return void T.splice(G,1)}(R),T.length){case 0:n.domElement.releasePointerCapture(R.pointerId),n.domElement.removeEventListener("pointermove",N),n.domElement.removeEventListener("pointerup",H),n.dispatchEvent(ul),a=i.NONE;break;case 1:const I=T[0],G=U[I];te({pointerId:I,pageX:G.x,pageY:G.y})}}function ae(R){n.enabled!==!1&&n.enableZoom!==!1&&a===i.NONE&&(R.preventDefault(),n.dispatchEvent(Wa),function(I){j(I.clientX,I.clientY),I.deltaY<0?K(B(I.deltaY)):I.deltaY>0&&pe(B(I.deltaY)),n.update()}(function(I){const G=I.deltaMode,ie={clientX:I.clientX,clientY:I.clientY,deltaY:I.deltaY};switch(G){case 1:ie.deltaY*=16;break;case 2:ie.deltaY*=100}return I.ctrlKey&&!L&&(ie.deltaY*=10),ie}(R)),n.dispatchEvent(ul))}function ne(R){R.key==="Control"&&(L=!0,n.domElement.getRootNode().addEventListener("keyup",Q,{passive:!0,capture:!0}))}function Q(R){R.key==="Control"&&(L=!1,n.domElement.getRootNode().removeEventListener("keyup",Q,{passive:!0,capture:!0}))}function E(R){n.enabled!==!1&&n.enablePan!==!1&&function(I){let G=!1;switch(I.code){case n.keys.UP:I.ctrlKey||I.metaKey||I.shiftKey?A(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):se(0,n.keyPanSpeed),G=!0;break;case n.keys.BOTTOM:I.ctrlKey||I.metaKey||I.shiftKey?A(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):se(0,-n.keyPanSpeed),G=!0;break;case n.keys.LEFT:I.ctrlKey||I.metaKey||I.shiftKey?re(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):se(n.keyPanSpeed,0),G=!0;break;case n.keys.RIGHT:I.ctrlKey||I.metaKey||I.shiftKey?re(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):se(-n.keyPanSpeed,0),G=!0}G&&(I.preventDefault(),n.update())}(R)}function te(R){switch(oe(R),T.length){case 1:switch(n.touches.ONE){case ks:if(n.enableRotate===!1)return;J(R),a=i.TOUCH_ROTATE;break;case sc:if(n.enablePan===!1)return;me(R),a=i.TOUCH_PAN;break;default:a=i.NONE}break;case 2:switch(n.touches.TWO){case Gs:if(n.enableZoom===!1&&n.enablePan===!1)return;(function(I){n.enableZoom&&le(I),n.enablePan&&me(I)})(R),a=i.TOUCH_DOLLY_PAN;break;case oc:if(n.enableZoom===!1&&n.enableRotate===!1)return;(function(I){n.enableZoom&&le(I),n.enableRotate&&J(I)})(R),a=i.TOUCH_DOLLY_ROTATE;break;default:a=i.NONE}break;default:a=i.NONE}a!==i.NONE&&n.dispatchEvent(Wa)}function D(R){n.enabled!==!1&&R.preventDefault()}function oe(R){let I=U[R.pointerId];I===void 0&&(I=new _e,U[R.pointerId]=I),I.set(R.pageX,R.pageY)}function ee(R){const I=R.pointerId===T[0]?T[1]:T[0];return U[I]}n.domElement.addEventListener("contextmenu",D),n.domElement.addEventListener("pointerdown",O),n.domElement.addEventListener("pointercancel",H),n.domElement.addEventListener("wheel",ae,{passive:!1}),n.domElement.getRootNode().addEventListener("keydown",ne,{passive:!0,capture:!0}),this.update()}}let Br;Br="/3DModelingAndMRApps/webBuild5/";let Ur,Kl,Xt,Ji=new un;Ji.name="Interaction-Group";let Bt,zt,Wi,Xa,ln,Xi=new un;Xi.name="Teleport-Group";const ls=[],Dr=new Te;let ja,xt,Ye,Ke,qa;function pl(r){const e=r.target,t=Zl(e);if(t.length>0){const n=t[0].object;n.material.emissive.b=1,e.attach(n),e.userData.selected=n}e.userData.targetRayMode=r.data.targetRayMode}function fl(){this.userData.isSqueezing=!0}function ml(){if(this.userData.isSqueezing=!1,Xt){const r={x:-Xt.x,y:-Xt.y,z:-Xt.z,w:1},e=new Pt,t=new XRRigidTransform(r,e),n=Kl.getOffsetReferenceSpace(t);Ke.xr.setReferenceSpace(n)}}function gl(r){const e=r.target;if(e.userData.selected!==void 0){const t=e.userData.selected;t.material.emissive.b=0,Ji.attach(t),e.userData.selected=void 0}}function Zl(r){return r.updateMatrixWorld(),ln.setFromXRController(r),ln.intersectObjects(Ji.children,!0)}function _l(r){if(r.userData.targetRayMode==="screen"||r.userData.selected!==void 0)return;const e=r.getObjectByName("line"),t=Zl(r);if(t.length>0){const n=t[0],i=n.object;i.material.emissive.r=1,ls.push(i),e.scale.z=n.distance}else e.scale.z=5}(function(){ja=document.createElement("div"),document.body.appendChild(ja),Ye=new Au,new jd().setPath(Br).load("hdr/Scenery.hdr",function(a){a.mapping=zr,Ye.background=a,Ye.environment=a,Ke.toneMappingExposure=10;const s=new as().setPath(Br);s.load("mazda.gltf",async function(o){const c=o.scene;c.position.set(17,0,-1),await Ke.compileAsync(c,xt,Ye),Ye.add(c)}),Xi.add(modelmazda),s.load("tow_boat/scene.gltf",async function(o){const c=o.scene;c.position.set(-20,-10,-1),await Ke.compileAsync(c,xt,Ye),Ye.add(c)}),s.load("street_lamp/street_lamp.gltf",async function(o){const c=o.scene;c.position.set(0,0,-1),await Ke.compileAsync(c,xt,Ye),Ji.add(c)}),s.load("mylandscape/landscape.gltf",async function(o){const c=o.scene;c.position.set(0,0,0),await Ke.compileAsync(c,xt,Ye),Ye.add(c)})}),Ye.add(Xi),xt=new mt(75,window.innerWidth/window.innerHeight,.1,1e3);const r=new rd;xt.add(r);const e=new ad(r);new td().load("sounds/song.mp3",function(a){e.setBuffer(a),e.setLoop(!0),e.setVolume(.5),e.play()}),Ke=new zl({antialias:!0}),Ke.setSize(window.innerWidth,window.innerHeight),ja.appendChild(Ke.domElement);const t=new Xl(16777215,1);Ye.add(t);const n=new ud(5);Ye.add(n);const i=new Qu(4210752);Ye.add(i),xt.position.set(2,2,2),xt.lookAt(n.position),xt.lookAt(new P(0,0,0)),qa=new tp(xt,Ke.domElement),xt.position.set(7,3,6),qa.update(),Ye.add(Ji),Ke.setAnimationLoop(function(){(function(){for(;ls.length;)ls.pop().material.emissive.r=0})(),_l(Bt),_l(zt),function(){if(Xt=void 0,Bt.userData.isSqueezing===!0){Dr.identity().extractRotation(Bt.matrixWorld),ln.ray.origin.setFromMatrixPosition(Bt.matrixWorld),ln.ray.direction.set(0,0,-1).applyMatrix4(Dr);const a=ln.intersectObjects(Xi.children,!0);a.length>0&&(Xt=a[0].point)}else if(zt.userData.isSqueezing===!0){Dr.identity().extractRotation(zt.matrixWorld),ln.ray.origin.setFromMatrixPosition(zt.matrixWorld),ln.ray.direction.set(0,0,-1).applyMatrix4(Dr);const a=ln.intersectObjects(Xi.children,!0);a.length>0&&(Xt=a[0].point)}Xt&&Ur.position.copy(Xt),Ur.visible=Xt!==void 0}(),qa.update(),Ke.render(Ye,xt)})})(),function(){document.body.appendChild(Li.createButton(Ke)),Ke.xr.enabled=!0,Ke.xr.addEventListener("sessionstart",()=>Kl=Ke.xr.getReferenceSpace()),Bt=Ke.xr.getController(0),Bt.addEventListener("selectstart",pl),Bt.addEventListener("selectend",gl),Ye.add(Bt),zt=Ke.xr.getController(1),zt.addEventListener("selectstart",pl),zt.addEventListener("selectend",gl),Ye.add(zt);const r=new Qd;Wi=Ke.xr.getControllerGrip(0),Wi.add(r.createControllerModel(Wi)),Ye.add(Wi),Xa=Ke.xr.getControllerGrip(1),Ye.add(Xa),new as().setPath(Br).load("low_poly_blue_handgun_pistol/scene.gltf",function(n){n.scene.scale.set(.1003,.1003,.1003);let i=n.scene;i.rotation.y=jr.degToRad(-90),i.rotation.x=jr.degToRad(-30),i.position.set(0,-.11,0),Wi.add(i);let a=i.clone();Xa.add(a)});const e=new Mt().setFromPoints([new P(0,0,0),new P(0,0,-1)]),t=new Jr(e);t.name="line",t.scale.z=5,Bt.add(t.clone()),zt.add(t.clone()),ln=new hd,Bt.addEventListener("squeezestart",fl),Bt.addEventListener("squeezeend",ml),zt.addEventListener("squeezestart",fl),zt.addEventListener("squeezeend",ml)}(),Ur=new gt(new xs(.25,32).rotateX(-Math.PI/2),new hn({color:2894892})),Ye.add(Ur),window.addEventListener("resize",function(){xt.aspect=window.innerWidth/window.innerHeight,xt.updateProjectionMatrix(),Ke.setSize(window.innerWidth,window.innerHeight)},!1);
